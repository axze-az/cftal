...
\end{lstlisting}
where $_T$ is the type and $_N$ of the elements of the vector.
...
\end{lstlisting}
The most arithmetic operations are defined on all vectors. Logical
operations on vectors return either a bit mask
