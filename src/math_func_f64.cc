...
namespace cftal {
    namespace math {
        namespace impl {
            ...
            class payne_hanek_pio2 {};

            template <>
            class payne_hanek_pio2<double> {
            public:
            ...
            public:
                ...
                static
                int
                rem(double xr[2], double xh, double xl);
            };
...
inline
double
cftal::math::impl::__rint(double x)
{
...
inline
double
cftal::math::impl::__r4int(double x)
{
...
{
#if 1
    return payne_hanek_pio2<double>::rem(xr, x);
#else
...
{
#if 1
    return payne_hanek_pio2<double>::rem(xr, x, xl);
#else
    uint64_t lx=as<uint64_t>(x);
    uint64_t lax= lx & not_sign_f64_msk::v.u64();
    double ax= as<double>(lax);
...
const double cftal::math::impl::two_over_pi_b24_dbl[948]={
    0xa2f983, 0x6e4e44, 0x1529fc, 0x2757d1, 0xf534dd, 0xc0db62,
    0x95993c, 0x439041, 0xfe5163, 0xabdebb, 0xc561b7, 0x246e3a,
    0x424dd2, 0xe00649, 0x2eea09, 0xd1921c, 0xfe1deb, 0x1cb129,
    0xa73ee8, 0x8235f5, 0x2ebb44, 0x84e99c, 0x7026b4, 0x5f7e41,
