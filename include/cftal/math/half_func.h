             ...
             arg_t<vf_type> kf)
{
   // [-0.3465735912322998046875, 0.3465735912322998046875] : | p - f | <= 2^-22.984375
    ...
    // x^0 : +0x8.00001p-3f
    const float exp_f16_c0=+1.0000001192e+00f;
    // x^1 : +0xf.ffffcp-4f
    const float exp_f16_c1=+9.9999976158e-01f;
    // x^2 : +0xf.ffe57p-5f
    const float exp_f16_c2=+4.9998733401e-01f;
    // x^3 : +0xa.aac63p-6f
    const float exp_f16_c3=+1.6667322814e-01f;
    // x^4 : +0xa.bbadap-8f
    const float exp_f16_c4=+4.1926242411e-02f;
    // x^5 : +0x8.83bb8p-10f
    const float exp_f16_c5=+8.3150193095e-03f;
    static const float c[]={
        exp_f16_c5, exp_f16_c4, exp_f16_c3,
        exp_f16_c2, exp_f16_c1, exp_f16_c0
    };
    vf_type y=horner2(xrh, vf_type(xrh*xrh), c);
...
cftal::math::half_func<float, _T>::half_exp2_k(arg_t<vf_type> xc)
{
   ...
   // [-0.5, 0.5] : | p - f | <= 2^-22.9921875
    ...
    static const float c[]={
        exp2_f16_c5, exp2_f16_c4, exp2_f16_c3,
        exp2_f16_c2, exp2_f16_c1, exp2_f16_c0
    };
    vf_type y=horner2(xrh, xrh2, c);
    y*= __scale_exp_k(kf);
    return y;
#else
    using ctbl = impl::d_real_constants<d_real<float>, float>;
