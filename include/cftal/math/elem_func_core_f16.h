...

{
    ...
    hx = m + offs.s32();
    idx=(m >> (23-pow_log_data<f16_t>::LOG_SHIFT));
    xr = _T::as_float(hx);
    return k;
}
...
__log_poly_k_poly(arg_t<vf_type> r, arg_t<vf_type> r2)
{
    ...
    // x^1 : +0x8p-3f
    constexpr
    const f16_t log_c1=+1.0000000000e+00f;
    // x^2 : -0x8p-4f
    constexpr
    const f16_t log_c2=-5.0000000000e-01f;
    // x^3 : +0xa.aaaa3p-5f
    constexpr
    const f16_t log_c3=+3.3333310485e-01f;
    // x^4 : -0x8.00002p-5f
    constexpr
    const f16_t log_c4=-2.5000005960e-01f;
    // x^5 : +0xc.cd2a4p-6f
    constexpr
    const f16_t log_c5=+2.0002228022e-01f;
    // x^6 : -0xa.aaebep-6f
    constexpr
    const f16_t log_c6=-1.6668221354e-01f;
    // x^7 : +0x9.1974bp-6f
    constexpr
    const f16_t log_c7=+1.4217869937e-01f;
    // x^8 : -0xf.dfab7p-7f
    constexpr
    const f16_t log_c8=-1.2401335686e-01f;
    // x^9 : +0xf.39c7cp-7f
    constexpr
    const f16_t log_c9=+1.1895081401e-01f;
    // x^10 : -0xe.fa013p-7f
    constexpr
    const f16_t log_c10=-1.1700453609e-01f;
    // x^11 : +0x8.a773bp-7f
    constexpr
    const f16_t log_c11=+6.7610226572e-02f;
             ...
             arg_t<vf_type> kf)
{
   // [-1.5625e-2, 1.5625e-2] : | p - f | <= 2^-46.703125
    ...
    // x^1 : +0x8p-3f
    constexpr
    const f16_t log_hp_c1=+1.0000000000e+00f;
    // x^2 : -0x8p-4f
    constexpr
    const f16_t log_hp_c2=-5.0000000000e-01f;
    // x^3 : +0xa.aaaabp-5f
    constexpr
    const f16_t log_hp_c3=+3.3333334327e-01f;
    // x^4 : -0x8p-5f
    constexpr
    const f16_t log_hp_c4=-2.5000000000e-01f;
    // x^5 : +0xc.cc8d7p-6f
    constexpr
    const f16_t log_hp_c5=+1.9998489320e-01f;
    // x^6 : -0xa.ab18ep-6f
    constexpr
    const f16_t log_hp_c6=-1.6669294238e-01f;
    ...
    if (_P == result_prec::high) {
        ...
        // x^3 : +0xa.abp-5f
        constexpr
        const f16_t log_c3=+3.3337402344e-01f;
        // x^4 : -0x8.0048bp-5f
        constexpr
        const f16_t log_c4=-2.5003466010e-01f;
...
__log_tbl_k12(arg_t<vf_type> xc)
{
    ...
    // x^4 : -0x8.004abp-5f
    constexpr
    const f16_t log_hp_c4=-2.5003561378e-01f;
    // x^5 : +0xc.cc8a7p-6f
    constexpr
    const f16_t log_hp_c5=+1.9998417795e-01f;
    static_assert(log_hp_c1 == 1.0f);
