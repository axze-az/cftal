 ...
 */
    ...
    // x^2 : -0xa.aaaabp-6f
    constexpr
    const f16_t sin_c2=-1.6666667163e-01f;
    // x^4 : +0x8.888b2p-10f
    constexpr
    const f16_t sin_c4=+8.3333719522e-03f;
    // x^6 : -0xd.02433p-16f
    constexpr
    const f16_t sin_c6=-1.9849911041e-04f;
    // x^8 : +0xb.bf108p-22f
    constexpr
    const f16_t sin_c8=+2.8005470085e-06f;
    vf_type z = xh*xh;
    // vf_type w = z*z;
 ...
 */
    ...
    // x^4 : +0xa.aaaabp-8f
    constexpr
    const f16_t cos_c4=+4.1666667908e-02f;
    // x^6 : -0xb.60beap-13f
    constexpr
    const f16_t cos_c6=-1.3889048714e-03f;
    // x^8 : +0xd.07ad8p-19f
    constexpr
    const f16_t cos_c8=+2.4852735805e-05f;
    // x^10 : -0xa.c7898p-25f
    constexpr
    const f16_t cos_c10=-3.2125240068e-07f;
    vf_type z  = xh*xh;
    // vf_type w  = z*z;
...
__tan_k(arg_t<vf_type> xrh, arg_t<vf_type> xrl, arg_t<vi_type> q)
{
    ...
    // x^1 : +0x8p-3f
    constexpr
    const f16_t tan_c1=+1.0000000000e+00f;
    // x^3 : +0xa.aaabp-5f
    constexpr
    const f16_t tan_c3=+3.3333349228e-01f;
    // x^5 : +0x8.886dp-6f
    constexpr
    const f16_t tan_c5=+1.3332676888e-01f;
    // x^7 : +0xd.d6c9cp-8f
    constexpr
    const f16_t tan_c7=+5.4058656096e-02f;
    // x^9 : +0xa.e63c5p-9f
    constexpr
    const f16_t tan_c9=+2.1287808195e-02f;
    // x^11 : +0xb.15241p-10f
    constexpr
    const f16_t tan_c11=+1.0822833516e-02f;
    // x^13 : +0xd.b2701p-17f
    constexpr
    const f16_t tan_c13=+1.0449998808e-04f;
    // x^15 : +0x8.f2db7p-11f
    constexpr
    const f16_t tan_c15=+4.3694633059e-03f;
    vf_type xrh2;
