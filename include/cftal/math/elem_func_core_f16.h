...
__atan_0_1_k(arg_t<vf_type> xh, arg_t<vf_type> xl)
{
    ...
    if (!_T::all_of_vmf(sel)) {
        ...
        // x^0 l: +0xc.6cp-16f
        constexpr
        const f16_t atan_i1_c0l=+1.8954277039e-04f;
        // x^1 : +0xb.3p-4_f16
        constexpr
...
asinh_k(arg_t<vf_type> xc)
{
    ...
    if (_T::any_of_vmf(sel = (x> asinh_i1_left) & (x<=asinh_i1_right))) {
        ...
        // x^0 l: +0xe.9ep-15f
        constexpr
        const f16_t asinh_i1_c0l=+4.4608116150e-04f;
        // x^1 : +0x8.ap-4_f16
        constexpr
...
acosh_k(arg_t<vf_type> xc)
{
    ...
    if (_T::any_of_vmf(sel= (x > acosh_i1_left) & (x<=acosh_i1_right))) {
        ...
        // x^0 l: -0xa.bcp-15f
        constexpr
        const f16_t acosh_i1_c0l=-3.2758712769e-04f;
        // x^1 : +0xd.2ep-5_f16
        constexpr
...
atanh_k(arg_t<vf_type> xc)
{
    ...
    if (_T::any_of_vmf(sel = (x>atanh_i1_left) & (x<=0.75))) {
        ...
        // x^0 l: +0xa.38p-18f
        constexpr
        const f16_t atanh_i1_c0l=+3.8981437683e-05f;
        // x^1 : +0xe.0cp-3_f16
        constexpr
