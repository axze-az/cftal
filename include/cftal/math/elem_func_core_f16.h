...
rcbrt_k(arg_t<vf_type> xc)
{
    ...
    mm0 = mm0 * scale;
#endif
    // [0.125, 1] : | p - f | <= 2^-6.15625
    // coefficients for rcbrt generated by sollya
    // x^0 : +0xa.b4p-2_f16
    constexpr
    const f16_t rcbrt_c0=+2.67578e+00_f16;
    // x^1 : -0xe.1ep-1_f16
    constexpr
    const f16_t rcbrt_c1=-7.05859e+00_f16;
    // x^2 : +0xd.eap+0_f16
    constexpr
    const f16_t rcbrt_c2=+1.39141e+01_f16;
    // x^3 : -0xd.58p+0_f16
    constexpr
    const f16_t rcbrt_c3=-1.33438e+01_f16;
    // x^4 : +0x9.a4p-1_f16
    constexpr
    const f16_t rcbrt_c4=+4.82031e+00_f16;
    constexpr static const f16_t ci[]={
        rcbrt_c4, rcbrt_c3, rcbrt_c2, rcbrt_c1, rcbrt_c0
    };
