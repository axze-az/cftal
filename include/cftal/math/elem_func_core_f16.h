...
sinh_cosh_k(arg_t<vf_type> xc)
{
    ...
    // x^ : +0x8p-3f
    constexpr
    const f16_t sinh_i0_right=+1.0000000000e+00f;
    if (_F == hyperbolic_func::c_sinh) {
        ...
        if (__unlikely(_T::any_of_vmf(x_small))) {
            ...
            // x^3 : +0xa.aaaabp-6f
            constexpr
            const f16_t sinh_c3=+1.6666667163e-01f;
            // x^5 : +0x8.88875p-10f
            constexpr
            const f16_t sinh_c5=+8.3333151415e-03f;
            // x^7 : +0xd.00e11p-16f
            constexpr
            const f16_t sinh_c7=+1.9841665926e-04f;
            // x^9 : +0xb.b3b8fp-22f
            constexpr
            const f16_t sinh_c9=+2.7899839097e-06f;
    ...
    // x^ : +0x8p-3f
    constexpr
    const f16_t cosh_i0_right=+1.0000000000e+00f;
    if (_F == hyperbolic_func::c_cosh) {
        ...
        if (__unlikely(_T::any_of_vmf(x_small))) {
            ...
            // x^0 : +0x8p-3f
            constexpr
            const f16_t cosh_c0=+1.0000000000e+00f;
            // x^2 : +0x8p-4f
            constexpr
            const f16_t cosh_c2=+5.0000000000e-01f;
            // x^4 : +0xa.aaaabp-8f
            constexpr
            const f16_t cosh_c4=+4.1666667908e-02f;
            // x^6 : +0xb.60b38p-13f
            constexpr
            const f16_t cosh_c6=+1.3888841495e-03f;
            // x^8 : +0xd.01653p-19f
            constexpr
            const f16_t cosh_c8=+2.4805927751e-05f;
            // x^10 : +0x9.49cf6p-25f
            constexpr
            const f16_t cosh_c10=+2.7681352321e-07f;
...
tanh_k(arg_t<vf_type> xc)
{
    ...
    // x^ : +0xb.17218p-9f
    constexpr
    const f16_t tanh_i0_right=+2.1660849452e-02f;
    ...
    if (__unlikely(_T::any_of_vmf(x_tiny))) {
        ...
        // x^1 : +0x8p-3f
        constexpr
        const f16_t tanh_c1=+1.0000000000e+00f;
        // x^3 : -0xa.aa3d6p-5f
        constexpr
        const f16_t tanh_c3=-3.3328121901e-01f;
