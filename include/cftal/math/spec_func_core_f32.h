...
__lgamma_1_2_k(arg_t<vf_type> xh, arg_t<vf_type> xl)
{
   ...
   // [1, 2] : | p - f | <= 2^-36.359375
    // coefficients for lngamma generated by sollya
    // x^0 h: +0xb.a5c31p-3f
    const float lngamma_i0_c0h=+1.4559384584e+00f;
    // x^0 l: -0xf.b5926p-29f
    const float lngamma_i0_c0l=-2.9260785794e-08f;
    // x^1 h: -0xc.4e45ap-2f
    const float lngamma_i0_c1h=-3.0764374733e+00f;
    // x^1 l: -0xc.ab39cp-29f
    const float lngamma_i0_c1l=-2.3597571897e-08f;
    // x^2 h: +0xc.fa271p-1f
    const float lngamma_i0_c2h=+6.4885792732e+00f;
    // x^2 l: +0xd.93ae4p-28f
    const float lngamma_i0_c2l=+5.0577810384e-08f;
    // x^3 : -0xa.58b73p+0f
    const float lngamma_i0_c3=-1.0346545219e+01f;
    // x^4 : +0xc.48b12p+0f
    const float lngamma_i0_c4=+1.2283952713e+01f;
    // x^5 : -0xa.f1e3cp+0f
    const float lngamma_i0_c5=-1.0944881439e+01f;
    // x^6 : +0xe.b3375p-1f
    const float lngamma_i0_c6=+7.3500313759e+00f;
    // x^7 : -0xe.d2f54p-2f
    const float lngamma_i0_c7=-3.7060136795e+00f;
    // x^8 : +0xb.1023fp-3f
    const float lngamma_i0_c8=+1.3828810453e+00f;
    // x^9 : -0xb.dd2ecp-5f
    const float lngamma_i0_c9=-3.7074983120e-01f;
    // x^10 : +0x8.a67e2p-7f
    const float lngamma_i0_c10=+6.7580953240e-02f;
    // x^11 : -0xf.5e179p-11f
    const float lngamma_i0_c11=-7.5036850758e-03f;
    // x^12 : +0xc.8e4fap-15f
    const float lngamma_i0_c12=+3.8317573490e-04f;
#endif
