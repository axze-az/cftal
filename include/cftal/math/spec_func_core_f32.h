...
__lgamma_1_2_k(arg_t<vhf_type> x)
{
    ...
    // x^0 : +0xc.65fa4720077p-3
    const double lngamma_i0_c0=+1.5497937733315936270628e+00;
    // x^1 : -0x8.012072566fc88p-1
    const double lngamma_i0_c1=-4.0022006731523029898767e+00;
    // x^2 : +0xa.b9220eb163efp+0
    const double lngamma_i0_c2=+1.0723175924595064856248e+01;
    // x^3 : -0xb.21b4030eb1ec8p+1
    const double lngamma_i0_c3=-2.2263306028533268232650e+01;
    // x^4 : +0x8.d718946b6dc88p+2
    const double lngamma_i0_c4=+3.5360875229750611481450e+01;
    // x^5 : -0xa.e1a2d106efa88p+2
    const double lngamma_i0_c5=-4.3525562531255339138170e+01;
    // x^6 : +0xa.8034c9421458p+2
    const double lngamma_i0_c6=+4.2003221811800699470041e+01;
    // x^7 : -0xf.febafcbf6aebp+1
    const double lngamma_i0_c7=-3.1990081399408005324858e+01;
    // x^8 : +0x9.a03a8bbc6bb5p+1
    const double lngamma_i0_c8=+1.9251786677362737520980e+01;
    // x^9 : -0x9.1cfe98149263p+0
    const double lngamma_i0_c9=-9.1132597971176316775654e+00;
    // x^10 : +0xd.6ba191f45eb4p-2
    const double lngamma_i0_c10=+3.3551085286523409934034e+00;
    // x^11 : -0xf.0f946bf248b1p-4
    const double lngamma_i0_c11=-9.4130365530558557374263e-01;
    // x^12 : +0xc.7290fa252ce3p-6
    const double lngamma_i0_c12=+1.9449257305377737337082e-01;
    // x^13 : -0xe.499235d6983b8p-9
    const double lngamma_i0_c13=-2.7905053207448262536650e-02;
    // x^14 : +0xa.2c3622275914p-12
    const double lngamma_i0_c14=+2.4835695825997823604769e-03;
    // x^15 : -0xd.89ad87128e278p-17
    const double lngamma_i0_c15=-1.0328524834789350390126e-04;
