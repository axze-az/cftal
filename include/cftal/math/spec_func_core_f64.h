...
__lgamma_1_2_k(arg_t<vf_type> xh, arg_t<vf_type> xl)
{
    ...
    // x^0 l: +0xd.068d70b1ca11p-58
    const double lngamma_i0_c0l=+4.5191613320855297795868e-17;
    // x^1 h: -0xf.c70f7849fe26p-1
    const double lngamma_i0_c1h=-7.8887899008105470954888e+00;
    // x^1 l: +0x8.bcf73eab579p-57
    const double lngamma_i0_c1l=+6.0633079503603160487591e-17;
    // x^2 h: +0x9.bc69656668658p+2
    const double lngamma_i0_c2h=+3.8943932867057434066282e+01;
    // x^2 l: +0x9.71724c86f5d08p-52
    const double lngamma_i0_c2l=+2.0968005805708236626389e-15;
