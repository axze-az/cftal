...
__lgamma_1_2_k(arg_t<vf_type> xh, arg_t<vf_type> xl)
{
    ...
    // [1, 2] : | p - f | <= 2^-71.6875
    // coefficients for lngamma generated by sollya
    // x^0 h: +0xe.5a4aff80aad78p-3
    const double lngamma_i0_c0h=+1.7940883599415931026755e+00;
    // x^0 l: -0x9.0a6eda331c47p-57
    const double lngamma_i0_c0l=-6.2732832626571345373437e-17;
    // x^1 h: -0xf.1f2d6d219236p-1
    const double lngamma_i0_c1h=-7.5608934501152411655767e+00;
    // x^1 l: -0x9.f1250c5fcec7p-55
    const double lngamma_i0_c1l=-2.7594514347856268916527e-16;
    // x^2 h: +0x8.fb3ec99030698p+2
    const double lngamma_i0_c2h=+3.5925707236108472386604e+01;
    // x^2 l: +0x9.d293ec69f1ed8p-52
    const double lngamma_i0_c2l=+2.1810485935870547332604e-15;
    // x^3 : -0x8.9fd51fc114308p+4
    const double lngamma_i0_c3=-1.3798953223630363140728e+02;
    // x^4 : +0xd.362a41159a3dp+5
    const double lngamma_i0_c4=+4.2277063195111225013534e+02;
    // x^5 : -0x8.351f575edd838p+7
    const double lngamma_i0_c5=-1.0505612134595301085938e+03;
    // x^6 : +0x8.6a2b7afe8f14p+8
    const double lngamma_i0_c6=+2.1541698454951583698858e+03;
    // x^7 : -0xe.70ab916e327a8p+8
    const double lngamma_i0_c7=-3.6966701878426779330766e+03;
    // x^8 : +0xa.7bc92a4a3633p+9
    const double lngamma_i0_c8=+5.3675716030850071547320e+03;
    // x^9 : -0xc.fcc9d724a8c2p+9
    const double lngamma_i0_c9=-6.6495768781494152790401e+03;
    // x^10 : +0xd.cfd56722eba78p+9
    const double lngamma_i0_c10=+7.0716672099733978029690e+03;
    // x^11 : -0xc.a9dd58ea89d9p+9
    const double lngamma_i0_c11=-6.4837292760060390719445e+03;
    // x^12 : +0xa.09731c1abc81p+9
    const double lngamma_i0_c12=+5.1388992951794079999672e+03;
    // x^13 : -0xd.c53d25850e5bp+8
    const double lngamma_i0_c13=-3.5252388537559554606560e+03;
    // x^14 : +0x8.2caa7713a9e28p+8
    const double lngamma_i0_c14=+2.0926658794679410675599e+03;
    // x^15 : -0x8.6281ffd061038p+7
    const double lngamma_i0_c15=-1.0732539048307824032236e+03;
    // x^16 : +0xe.d06a9b9e2f02p+5
    const double lngamma_i0_c16=+4.7405205463009792765661e+02;
    // x^17 : -0xb.372bd3480ecb8p+4
    const double lngamma_i0_c17=-1.7944819954059195765694e+02;
    // x^18 : +0xe.73c51001ffee8p+2
    const double lngamma_i0_c18=+5.7808902742340912084273e+01;
    // x^19 : -0xf.b221217e15f98p+0
    const double lngamma_i0_c19=-1.5695818036348986979078e+01;
    // x^20 : +0xe.2d725f6596afp-2
    const double lngamma_i0_c20=+3.5443816095118299003275e+00;
    // x^21 : -0xa.74fa88b37b578p-4
    const double lngamma_i0_c21=-6.5355924033038614862079e-01;
    // x^22 : +0xc.4566feebe8498p-7
    const double lngamma_i0_c22=+9.5867990945239164868319e-02;
    // x^23 : -0xb.048d47f46378p-10
    const double lngamma_i0_c23=-1.0759551541102280181050e-02;
    // x^24 : +0xe.3764a0499ca98p-14
    const double lngamma_i0_c24=+8.6769892473074550828110e-04;
    // x^25 : -0xb.bc2208037169p-18
    const double lngamma_i0_c25=-4.4765069108836826592725e-05;
    // x^26 : +0x9.4f13cb1fcbaap-23
    const double lngamma_i0_c26=+1.1097068517372677616301e-06;
#endif
