...
namespace cftal {
    namespace math {
        ...
        // specialization of func_core for float and different
        // traits
...
#if 0
    // [0.125, 1] : | p - f | <= 2^-13.140625
    // coefficients for cbrt generated by sollya
    // x^0 : +0x8.7b2bap-5f
    const vf_type cbrt_c0=+2.6503545046e-01f;
    // x^1 : +0xa.a370dp-2f
    const vf_type cbrt_c1=+2.6596100330e+00f;
    // x^2 : -0x8.6c0c8p+0f
    const vf_type cbrt_c2=-8.4220657349e+00f;
    // x^3 : +0xa.b0961p+1f
    const vf_type cbrt_c3=+2.1379579544e+01f;
    // x^4 : -0x8.cd487p+2f
    const vf_type cbrt_c4=-3.5207546234e+01f;
    // x^5 : +0x8.cb549p+2f
    const vf_type cbrt_c5=+3.5177036285e+01f;
    // x^6 : -0x9.a6275p+1f
    const vf_type cbrt_c6=-1.9298074722e+01f;
    // x^7 : +0x8.e4a06p-1f
    const vf_type cbrt_c7=+4.4465360641e+00f;
#if 1
    vf_type mm02= mm0*mm0;
    vf_type oc= impl::poly(mm02,
                           cbrt_c7,
                           cbrt_c5,
                           cbrt_c3,
                           cbrt_c1);
    vf_type ec= impl::poly(mm02,
                           cbrt_c6,
                           cbrt_c4,
                           cbrt_c2,
                           cbrt_c0);
    vf_type mm = oc *mm0 + ec;
#else
