...
#if ((__x86_64__==0) && (__i386__>0)) || \
    (((__x86_64__>0) || (__i386__>0)) && (__AVX2__==0)) || \
    (__tune_haswell__>0) || (__tune_broadwell__>0) || \
    (__tune_skylake__>0) || (__tune_core_avx2__>0) || \
    (__tune_bdver4__>0) || (__tune_znver1__>0)
...
__log_tbl_k12(arg_t<vf_type> xc)
{
    ...
    // exact because |log_hp_c2| is a power of 2:
