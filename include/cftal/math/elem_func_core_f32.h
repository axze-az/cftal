...
__log1p_poly_hp(arg_t<vf_type> r,
                arg_t<vf_type> r2)
{
    // [-0.292893230915069580078125, 0.41421353816986083984375] : | p - f | <= 2^-37.078125
    // coefficients for log generated by sollya
    // x^1 : +0x8p-3f
    constexpr
    ...
    // x^3 : +0xa.aaaabp-5f
    constexpr
    const float log_c3=+3.3333334327e-01f;
    // x^4 : -0xf.fffffp-6f
    constexpr
    const float log_c4=-2.4999998510e-01f;
    // x^5 : +0xc.ccc79p-6f
    constexpr
    const float log_c5=+1.9999875128e-01f;
    // x^6 : -0xa.aaad3p-6f
    constexpr
    const float log_c6=-1.6666726768e-01f;
    // x^7 : +0x9.2575cp-6f
    constexpr
    const float log_c7=+1.4291137457e-01f;
    // x^8 : -0x8.005cdp-6f
    constexpr
    const float log_c8=-1.2502212822e-01f;
    // x^9 : +0xe.1656ep-7f
    constexpr
    const float log_c9=+1.1005674303e-01f;
    // x^10 : -0xc.a3d04p-7f
    constexpr
    const float log_c10=-9.8749190569e-02f;
    // x^11 : +0xc.ca9b8p-7f
    constexpr
    const float log_c11=+9.9933087826e-02f;
    // x^12 : -0xc.e8a7p-7f
    constexpr
    const float log_c12=-1.0084998608e-01f;
    // x^13 : +0xe.6236dp-8f
    constexpr
    const float log_c13=+5.6186128408e-02f;
    ...
    p= horner(r, p, log_c4);
    horner_comp_quick(p, pl, r, p, log_c3, log_c2);
