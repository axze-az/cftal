...
rsqrt_k(arg_t<vf_type> x)
{
    ...
    // x^0 : +0xc.a319dp-2f
    const float rsqrt_i0_c0=+3.1592781544e+00f;
    // x^1 : -0xb.b02fcp-1f
    const float rsqrt_i0_c1=-5.8441143036e+00f;
    // x^2 : +0x9.73b69p-1f
    const float rsqrt_i0_c2=+4.7260022163e+00f;
    // [0.5, 1] : | p - f | <= 2^-7.79296875
    // coefficients for rsqrt generated by sollya
    // x^0 : +0x8.ef8fep-2f
    const float rsqrt_i1_c0=+2.2339472771e+00f;
    // x^1 : -0x8.43cbdp-2f
    const float rsqrt_i1_c1=-2.0662071705e+00f;
    // x^2 : +0xd.5dfe4p-4f
    const float rsqrt_i1_c2=+8.3544754982e-01f;
    ...
    // coefficients for rsqrt generated by sollya
    // x^0 : +0xd.fdfb5p-2f
    const float rsqrt_c0=+3.4980289936e+00f;
    // x^1 : -0x8.fc0d3p+0f
    const float rsqrt_c1=-8.9845762253e+00f;
    // x^2 : +0xe.a85b9p+0f
    const float rsqrt_c2=+1.4657647133e+01f;
    // x^3 : -0xb.f930cp+0f
    const float rsqrt_c3=-1.1973400116e+01f;
    // x^4 : +0xf.37b95p-2f
    const float rsqrt_c4=+3.8044178486e+00f;
