...
old_sinh_k(arg_t<vf_type> xc)
{
    ...
    // coefficients for sinh generated by sollya
    // x^0 : +0xcp-1f
    const float sinh_c0=+6.0000000000e+00f;
    // x^2 : -0x9.9999p-5f
    const float sinh_c2=-2.9999971390e-01f;
    // x^4 : +0x8.0b43dp-10f
    const float sinh_c4=+7.8554721549e-03f;
    // x^6 : -0x8.a845cp-16f
    const float sinh_c6=-1.3210013276e-04f;
    vf_type x2=x*x;
    vf_type q=horner(x2,
                     sinh_c6,
                     sinh_c4,
    ...
    vf_type e= em+1;
    const float e_v_2_m_1 = +5.8500006794930e-02f;
    const float e_m_v_2 = +2.3618327081203e-01f;
...
old_cosh_k(arg_t<vf_type> xc)
{
    ...
    */
    ...
    // coefficients for cosh generated by sollya
    // x^0 : +0x8p-4f
    const float cosh_c0=+5.0000000000e-01f;
    // x^2 : +0xa.aaaacp-8f
    const float cosh_c2=+4.1666671634e-02f;
    // x^4 : +0xb.6092p-13f
    const float cosh_c4=+1.3888217509e-03f;
    // x^6 : +0xd.22546p-19f
    const float cosh_c6=+2.5051307603e-05f;
    vf_type xx= x*x;
...
old_tanh_k(arg_t<vf_type> xc)
{
    ...
    // x^2 : +0x9.9999ap-3f
    const float tanh_c2=+1.2000000477e+00f;
    // x^4 : -0xb.b3f95p-11f
    const float tanh_c4=-5.7143666781e-03f;
    // x^6 : +0x8.32abfp-15f
    const float tanh_c6=+2.5018115412e-04f;
...
__pow_log_k(arg_t<vf_type> sh, arg_t<vf_type> sl, arg_t<vf_type> kf)
{
    ...
    if (_P == result_prec::high) {
        // [0, 0.17157287895679473876953125] : | p - f | <= 2^-50.546875
        ...
        // x^3 l: -0xa.ac947p-29f
        const float pow_log_hp_c3l=-1.9882135049e-08f;
        // x^5 : +0xc.ccccdp-5f
        const float pow_log_hp_c5=+4.0000000596e-01f;
        // x^7 : +0x9.24907p-5f
        const float pow_log_hp_c7=+2.8571340442e-01f;
        // x^9 : +0xe.39df4p-6f
        const float pow_log_hp_c9=+2.2228223085e-01f;
        // x^11 : +0xb.82258p-6f
 ...
 */
    ...
    // coefficients for tan generated by sollya
    // x^2 : +0xa.aaaabp-5f
    const float tan_c2=+3.3333334327e-01f;
    // x^4 : +0x8.88863p-6f
    const float tan_c4=+1.3333277404e-01f;
    // x^6 : +0xd.d1a0fp-8f
    const float tan_c6=+5.3979929537e-02f;
    // x^8 : +0xb.224d7p-9f
    const float tan_c8=+2.1746082231e-02f;
    // x^10 : +0x9.d6476p-10f
    const float tan_c10=+9.6064712852e-03f;
    // x^12 : +0xf.316f4p-14f
    const float tan_c12=+9.2731346376e-04f;
    // x^14 : +0xe.89edp-11f
    const float tan_c14=+7.0990100503e-03f;
    // x^16 : -0xc.37d89p-11f
    const float tan_c16=-5.9658926912e-03f;
    // x^18 : +0xe.7d6fcp-12f
    const float tan_c18=+3.5375943407e-03f;
    // make xrh positive
    ...
    using ctbl = impl::d_real_constants<d_real<float>, float>;
    const float large_arg=0.6731984257692414;
