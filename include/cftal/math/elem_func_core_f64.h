...
__frexp_k(vf_type& m, arg_t<vf_type> x)
{
    ...
    vi2_type e=_T::sel(_T::vmf_to_vmi2(is_denom), vi2_type(-54), vi2_type(0));
    vi2_type lx, hx;
...
#if 1
    // [0.25, 0.5] : | p - f | <= 2^-7.29296875
    // coefficients for rsqrt generated by sollya
    // x^0 : +0xc.a319d23ef91b8p-2
    const double rsqrt_i0_c0=+3.1592781878410067797347e+00;
    // x^1 : -0xb.b02fc9fb7f2p-1
    const double rsqrt_i0_c1=-5.8441146010878242122999e+00;
    // x^2 : +0x9.73b6a1c3e9218p-1
    const double rsqrt_i0_c2=+4.7260027457855953159083e+00;
    // [0.5, 1] : | p - f | <= 2^-7.79296875
    // coefficients for rsqrt generated by sollya
    // x^0 : +0x8.ef8fcf702571p-2
    const double rsqrt_i1_c0=+2.2339470302771227139260e+00;
    // x^1 : -0x8.43cba52ad793p-2
    const double rsqrt_i1_c1=-2.0662065322302565206769e+00;
    // x^2 : +0xd.5dfdd3f75b288p-4
    const double rsqrt_i1_c2=+8.3544714736280856204331e-01;
