...
acosh_k(arg_t<vf_type> xc)
{
    ...
    const double acosh_i1_right=+3.0000000000000000000000e+00;
    ...
    if (any_of(sel= (x > acosh_i1_left) & (x<=acosh_i1_right))) {
        ...
        // x^0 h: +0xc.519e2e90e1dep-3
        const double acosh_i1_c0h=+1.5398524892773215455577e+00;
        // x^0 l: -0xd.1eecf24e0c2cp-58
        const double acosh_i1_c0l=-4.5521930033524414892774e-17;
        // x^1 : +0xe.62385c5e04668p-5
        const double acosh_i1_c1=+4.4948976555327818660501e-01;
        // x^2 : -0xe.2d44f5de3181p-7
        const double acosh_i1_c2=-1.1075651173849723751808e-01;
        // x^3 : +0xa.1922450dc5a2p-8
        const double acosh_i1_c3=+3.9446012362324839317651e-02;
        // x^4 : -0x8.9f446d4fa9ac8p-9
        const double acosh_i1_c4=-1.6840113013887634402233e-02;
        // x^5 : +0x8.3997684d8addp-10
        const double acosh_i1_c5=+8.0321938907087393755280e-03;
        // x^6 : -0x8.71973f27ac9c8p-11
        const double acosh_i1_c6=-4.1229072712297082717314e-03;
        // x^7 : +0x9.1f0b5b7381518p-12
        const double acosh_i1_c7=+2.2268718377918702254481e-03;
        // x^8 : -0xa.38dcbb5c9f53p-13
        const double acosh_i1_c8=-1.2478171510287654720484e-03;
        // x^9 : +0xb.c6711f2160d2p-14
        const double acosh_i1_c9=+7.1869895011471675652648e-04;
        // x^10 : -0xd.daf7502a4fbb8p-15
        const double acosh_i1_c10=-4.2283130490482857604881e-04;
        // x^11 : +0x8.4a529352c97a8p-15
        const double acosh_i1_c11=+2.5300056463199656385868e-04;
        // x^12 : -0xa.0ecae31ef23d8p-16
        const double acosh_i1_c12=-1.5346959400711402180494e-04;
        // x^13 : +0xc.5641cb888e45p-17
        const double acosh_i1_c13=+9.4123393652544500931692e-05;
        // x^14 : -0xf.495d942f78638p-18
        const double acosh_i1_c14=-5.8313690757456864810059e-05;
        // x^15 : +0x9.9b3698bb6efa8p-18
        const double acosh_i1_c15=+3.6645133316633779886704e-05;
        // x^16 : -0xc.1a6d25640e6f8p-19
        const double acosh_i1_c16=-2.3085075257636761871796e-05;
        // x^17 : +0xe.77e13f3bdd6p-20
        const double acosh_i1_c17=+1.3798027750558882441323e-05;
        // x^18 : -0x8.d57bde1d8b7e8p-20
        const double acosh_i1_c18=-8.4246838761947493405416e-06;
        // x^19 : +0xe.da4d33e33be28p-21
        const double acosh_i1_c19=+7.0823385808476052433983e-06;
        // x^20 : -0xb.fe0a02fac8988p-21
        const double acosh_i1_c20=-5.7183934524011689154812e-06;
        // x^21 : +0x9.0608f8bc5081p-22
        const double acosh_i1_c21=+2.1513877859377344083807e-06;
        // x^ : +0x9.c1b28p-2
        const double acosh_i1_x0=+2.4391574859619140625000e+00;
        static const double c[]={
            acosh_i1_c21, acosh_i1_c20, acosh_i1_c19, acosh_i1_c18,
