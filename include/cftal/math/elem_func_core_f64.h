...
acosh_k(arg_t<vf_type> xc)
{
    ...
    auto a=__pow_log_k2<log_func::c_log_e,result_prec::high>(ah, al);
    vf_type oh, ol;
    oh = _T::sel_val_or_zero(x_is_large, ctbl::m_ln2[0]);
    ol = _T::sel_val_or_zero(x_is_large, ctbl::m_ln2[1]);
    // x >> 1: ln(x) > ln(2), otherwise oh == ol == 0.0
...
atanh_k(arg_t<vf_type> xc)
{
    ...
    if (any_of(sel= x <= atanh_i1_left)) {
        ...
        const double atanh_c3=+3.3333333333334014270122e-01;
        // x^5 : +0xc.cccccccc39348p-6
        const double atanh_c5=+1.9999999999790255000853e-01;
        // x^7 : +0x9.24924962f0dep-6
        const double atanh_c7=+1.4285714308404162675714e-01;
        // x^9 : +0xe.38e373a6aca78p-7
        const double atanh_c9=+1.1111109873795509128680e-01;
        // x^11 : +0xb.a2ec0fe83051p-7
        const double atanh_c11=+9.0909488455852144328517e-02;
        // x^13 : +0x9.d858ddb60fc6p-7
        const double atanh_c13=+7.6914890534793112220058e-02;
        // x^15 : +0x8.8c3fb5817391p-7
        const double atanh_c15=+6.6780055642905483681560e-02;
        // x^17 : +0xe.c802ab502635p-8
        const double atanh_c17=+5.7739416908724930377339e-02;
        // x^19 : +0xf.5228cd129305p-8
        const double atanh_c19=+5.9847402636091187599909e-02;
        // x^21 : +0xe.d4af81df342dp-10
        const double atanh_c21=+1.4483206083060352203917e-02;
        // x^23 : +0x9.49868c86ab28p-6
        const double atanh_c23=+1.4511264537093149229463e-01;
        // x^25 : -0x9.cd0913e9787b8p-6
        const double atanh_c25=-1.5313937134295205200196e-01;
        // x^27 : +0xe.651829d69c7f8p-6
        const double atanh_c27=+2.2492031179212543245960e-01;
        static const double c[]={
            atanh_c27, atanh_c25,
    ...
    if (any_of(sel = (x>atanh_i1_left) & (x<=M_SQRT2/2))) {
        // [0.5, 0.70710678398609161376953125] : | p - f | <= 2^-63.15625
        // coefficients for atanh_i1 generated by sollya
        // x^0 h: +0xb.72082e4fd2fp-4
        const double atanh_i1_c0h=+7.1533983316947669095498e-01;
        // x^0 l: +0xf.3071c180dbf4p-58
        const double atanh_i1_c0l=+5.2698247768541680926795e-17;
        // x^1 : +0xc.d7643c1b5a6e8p-3
        const double atanh_i1_c1=+1.6051716514442013750141e+00;
        // x^2 : +0xc.a80c526dba0b8p-3
        const double atanh_i1_c2=+1.5820547523246710763800e+00;
        // x^3 : +0xb.c0654900142bp-2
        const double atanh_i1_c3=+2.9378863722131809410598e+00;
        // x^4 : +0xb.39e825b60b028p-1
        const double atanh_i1_c4=+5.6130992684097735789805e+00;
        // x^5 : +0xb.ae5d006e8a01p+0
        const double atanh_i1_c5=+1.1681106593119697123484e+01;
        // x^6 : +0xc.98eefea0fa7d8p+1
        const double atanh_i1_c6=+2.5194793537714740949696e+01;
        // x^7 : +0xd.fd9222f5b2728p+2
        const double atanh_i1_c7=+5.5962044467867407604444e+01;
        // x^8 : +0xf.db59662034dap+3
        const double atanh_i1_c8=+1.2685466295519182722273e+02;
        // x^9 : +0x9.211b3f141dc3p+5
        const double atanh_i1_c9=+2.9213830390659165914258e+02;
        // x^10 : +0xa.a4b2b08887a2p+6
        const double atanh_i1_c10=+6.8117450154617154112202e+02;
        // x^11 : +0xc.88afd43fbb6bp+7
        const double atanh_i1_c11=+1.6043434162060052585730e+03;
        // x^12 : +0xe.e22c3760fc9f8p+8
        const double atanh_i1_c12=+3.8101727200142627225432e+03;
        // x^13 : +0x8.e59cc5839df68p+10
        const double atanh_i1_c13=+9.1104495553057295182953e+03;
        // x^14 : +0xa.b23bcac36d158p+11
        const double atanh_i1_c14=+2.1905868501389555603964e+04;
        // x^15 : +0xc.f8637a43f30dp+12
        const double atanh_i1_c15=+5.3126217349957863916643e+04;
        // x^16 : +0xf.e807e4bd0526p+13
        const double atanh_i1_c16=+1.3030498668865225045010e+05;
        // x^17 : +0x9.6714ba483805p+15
        const double atanh_i1_c17=+3.0810636383223591838032e+05;
        // x^18 : +0xa.3664bc476e508p+16
        const double atanh_i1_c18=+6.6928473546494927722961e+05;
        // x^19 : +0xe.daa92724311e8p+17
        const double atanh_i1_c19=+1.9469623057919882703573e+06;
        // x^20 : +0xe.c8ad4054cefap+19
        const double atanh_i1_c20=+7.7510180103526003658772e+06;
        // x^21 : +0xf.07b597c39a18p+20
        const double atanh_i1_c21=+1.5760217485254377126694e+07;
        // x^ : +0x9.d300cp-4
        const double atanh_i1_x0=+6.1401438713073730468750e-01;
        static const double c[]={
            atanh_i1_c21, atanh_i1_c20, atanh_i1_c19, atanh_i1_c18,
            atanh_i1_c17, atanh_i1_c16, atanh_i1_c15, atanh_i1_c14,
            atanh_i1_c13, atanh_i1_c12,
            atanh_i1_c11, atanh_i1_c10, atanh_i1_c9,
            atanh_i1_c8, atanh_i1_c7, atanh_i1_c6, atanh_i1_c5,
            atanh_i1_c4, atanh_i1_c3, atanh_i1_c2, atanh_i1_c1
        };
        vf_type x_i1 = x - atanh_i1_x0;
        vf_type y_i1 = horner2(x_i1, vf_type(x_i1*x_i1), c);
        vf_type ye;
        horner_comp(y_i1, ye, x_i1, y_i1, atanh_i1_c0h);
        y_i1 += vf_type(ye+atanh_i1_c0l);
        y = _T::sel(sel, y_i1, y);
    }
    if (any_of(sel = x> M_SQRT2/2)) {
