...
#else
    vf_type mm0;
    auto e0= __frexp_k(mm0, x);
    // required to allow copying of the mask below
    vi2_type e= copy_odd_to_even(e0);
    vi2_type e1= e & 1;
    vmi2_type msk = e1 == 1;
    // divide exponent by 2 with round down
    vi2_type e2 = e>>1;
    // increment exponent where the division left a remainder
    vi2_type e2c= e2 + e1; // _T::sel(msk, e2+1, e2);
    vmf_type f_msk = _T::vmi2_to_vmf(msk);
    // half all values where the devision left a remainder
    mm0 = _T::sel(f_msk, mm0*0.5, mm0);
#if 1
    // [0.25, 0.4921875] : | p - f | <= 2^-20.9296875
    // coefficients for rsqrt generated by sollya
    // x^0 : +0xa.9e6f1de8f5938p-1
    const double rsqrt_i0_c0=+5.3094415041803477706139e+00;
    // x^1 : -0x8.c9e98cfdb04ep+2
    const double rsqrt_i0_c1=-3.5154879806273328313182e+01;
    // x^2 : +0xb.215a3da5dfddp+4
    const double rsqrt_i0_c2=+1.7808453144831383951896e+02;
    // x^3 : -0x9.3f0bc5bef0b48p+6
    const double rsqrt_i0_c3=-5.9176149652809283452370e+02;
    // x^4 : +0x9.f4998cb776468p+7
    const double rsqrt_i0_c4=+1.2742999017078284396121e+03;
    // x^5 : -0xd.6c50272da56dp+7
    const double rsqrt_i0_c5=-1.7181565489067493217590e+03;
    // x^6 : +0xa.5127bca0d969p+7
    const double rsqrt_i0_c6=+1.3205776109948533303395e+03;
    // x^7 : -0xd.d1032b557a73p+5
    const double rsqrt_i0_c7=-4.4212654749660430297808e+02;
    // [0.4921875, 1] : | p - f | <= 2^-20.90625
    // coefficients for rsqrt generated by sollya
    // x^0 : +0xf.04bdb92e4cd5p-2
    const double rsqrt_i1_c0=+3.7546299871930459701730e+00;
    // x^1 : -0xc.6cae885b25f4p+0
    const double rsqrt_i1_c1=-1.2424538156750671191730e+01;
    // x^2 : +0xf.b71c252d0963p+1
    const double rsqrt_i1_c2=+3.1430546423903045649695e+01;
    // x^3 : -0xd.075ce6ad6419p+2
    const double rsqrt_i1_c3=-5.2115045232131151919930e+01;
    // x^4 : +0xd.fd2d9d2bfd4bp+2
    const double rsqrt_i1_c4=+5.5955909054716514106076e+01;
    // x^5 : -0x9.65c25da42ee6p+2
    const double rsqrt_i1_c5=-3.7589988146147874203962e+01;
    // x^6 : +0xe.6275381362db8p+0
    const double rsqrt_i1_c6=+1.4384601120694112452725e+01;
    // x^7 : -0x9.959f47084b0fp-2
    const double rsqrt_i1_c7=-2.3961154078304067738259e+00;
    // x^ : +0xf.cp-5
...
#else
    // avoid subnormals
    vmf_type k_small= k < -1021.0;
    // and overflows
    vmf_type k_large = k > 1023.0;
    vf_type kt = _T::sel(k_small, k + 128.0, k);
    vf_type scale = _T::sel(k_small, 0x1p-128, 0x1p0);
    kt = _T::sel(k_large, 1023.0, kt);
    scale = _T::sel(k_large, 2.0, scale);
    vi_type ki= _T::cvt_f_to_i(kt);
    vi2_type ki2 = _T::vi_to_vi2(ki);
    vf_type rh= _T::insert_exp(_T::bias()+ki2);
...
old_sinh_k(arg_t<vf_type> xc)
{
    ...
    const double sinh_c0=+6.0000000000000008881784e+00;
    // x^2 : -0x9.999999999ca38p-5
    const double sinh_c2=-3.0000000000008636424909e-01;
    // x^4 : +0x8.0bb3ee782901p-10
    const double sinh_c4=+7.8571428585201309735542e-03;
    // x^6 : -0x8.d797bffecaeep-16
    const double sinh_c6=-1.3492064317259424687662e-04;
    // x^8 : +0xc.2b79366720ef8p-23
    const double sinh_c8=+1.4507553942369093147308e-06;
    // x^10 : -0xa.f5fa2c4d6d8ap-32
    const double sinh_c10=-2.5520214317128015392265e-09;
    // x^12 : -0x9.15c1eb16ed0b8p-35
    const double sinh_c12=-2.6440801473562751133314e-10;
    ...
    const double e_v_2_m_1 = +5.8500008306337336616565e-02;
    const double e_m_v_2 = +2.3618327637050734457702e-01;
...
old_cosh_k(arg_t<vf_type> xc)
{
    ...
    */
    ...
    // coefficients for cosh generated by sollya
    // x^0 : +0x8p-4
    const double cosh_c0=+5.0000000000000000000000e-01;
    // x^2 : +0xa.aaaaaaaaaaaa8p-8
    const double cosh_c2=+4.1666666666666664353702e-02;
    // x^4 : +0xb.60b60b60b745p-13
    const double cosh_c4=+1.3888888888890249008468e-03;
    // x^6 : +0xd.00d00cfbf9fb8p-19
    const double cosh_c6=+2.4801587299439595317918e-05;
    // x^8 : +0x9.3f27e3ec2ce78p-25
    const double cosh_c8=+2.7557320678283791649579e-07;
    // x^10 : +0x8.f75ee555b55d8p-32
    const double cosh_c10=+2.0876274783143503579269e-09;
    // x^12 : +0xc.b279999c86d88p-40
    const double cosh_c12=+1.1548006995718819778011e-11;
    vf_type xx= x*x;
...
old_tanh_k(arg_t<vf_type> xc)
{
    ...
    vf_type ep1l, ep1h=d_ops::quick_two_sum(e, vf_type(1.0), ep1l);
    dvf_type ep1(ep1h, ep1l);
    vf_type tanh_x_gt_ln_3_2 = (vf_type(1.0) - vf_type(2.0)/ep1).h();
    // [0, 0.5625] : | p - f | <= 2^-52.046875
    // coefficients for tanh generated by sollya
    // x^2 : +0x9.999999999998p-3
    const double tanh_c2=+1.1999999999999992894573e+00;
    // x^4 : -0xb.b3ee7218f3888p-11
    const double tanh_c4=-5.7142857141288120118028e-03;
    // x^6 : +0x8.5270a8fe7802p-15
    const double tanh_c6=+2.5396824820567175974573e-04;
    // x^8 : -0xc.cbe06da93229p-20
    const double tanh_c8=-1.2203591589975623790199e-05;
    // x^10 : +0xa.09a3738053508p-24
    const double tanh_c10=+5.9829058152612645097467e-07;
    // x^12 : -0xf.260464a2fce1p-29
    const double tanh_c12=-2.8216288487555987828251e-08;
...
#if 0
    // [0, 4.28932197391986846923828125e-2] : | p - f | <= 2^-92
    // coefficients for pow_log_hp generated by sollya
    // x^1 h: +0x8p-2
    const double pow_log_hp_i0_c1h=+2.0000000000000000000000e+00;
    // x^1 l: +0x8p-105
    const double pow_log_hp_i0_c1l=+1.9721522630525295135293e-31;
    // x^3 h: +0xa.aaaaaaaaaaaa8p-4
    const double pow_log_hp_i0_c3h=+6.6666666666666662965923e-01;
    // x^3 l: +0xa.aaaaaa954ce6p-58
    const double pow_log_hp_i0_c3l=+3.7007434136912339414350e-17;
    // x^5 h: +0xc.cccccccccccdp-5
    const double pow_log_hp_i0_c5h=+4.0000000000000002220446e-01;
    // x^5 l: -0xc.ccc35ca02c75p-59
    const double pow_log_hp_i0_c5l=-2.2204210665933704722348e-17;
    // x^7 h: +0x9.249249249249p-5
    const double pow_log_hp_i0_c7h=+2.8571428571428569842539e-01;
    // x^7 l: +0x8.56fb3671f8788p-59
    const double pow_log_hp_i0_c7l=+1.4467196019706930219839e-17;
    // x^9 h: +0xe.38e38e38e3d48p-6
    const double pow_log_hp_i0_c9h=+2.2222222222222612342257e-01;
    // x^9 l: -0xa.55d47adabd718p-60
    const double pow_log_hp_i0_c9l=-8.9644207300146420325909e-18;
    // x^11 h: +0xb.a2e8ba2cddc8p-6
    const double pow_log_hp_i0_c11h=+1.8181818181207320961335e-01;
    // x^11 l: +0xf.d2065b7e568fp-61
    const double pow_log_hp_i0_c11l=+6.8610089424809922641689e-18;
    // x^13 h: +0x9.d89d8fe47736p-6
    const double pow_log_hp_i0_c13h=+1.5384615947720037265611e-01;
    // x^13 l: -0xc.ff6c1a56241ep-61
    const double pow_log_hp_i0_c13l=-5.6368725958616345346922e-18;
    // x^15 h: +0x8.887bd9047512p-6
    const double pow_log_hp_i0_c15h=+1.3333030884844376817711e-01;
    // x^15 l: -0xb.59c2ec6f1d2b8p-60
    const double pow_log_hp_i0_c15l=-9.8451026390696521887707e-18;
    // x^17 h: +0xf.2bbe63ddae7cp-7
    const double pow_log_hp_i0_c17h=+1.1852245212809353613892e-01;
    // x^17 l: +0xd.b267007861eap-61
    const double pow_log_hp_i0_c17l=+5.9400766351274214645347e-18;
    // [4.28932197391986846923828125e-2, 8.5786439478397369384765625e-2] : | p - f | <= 2^-90.875
    // coefficients for pow_log_hp generated by sollya
    // x^1 h: +0x8p-2
    const double pow_log_hp_i1_c1h=+2.0000000000000000000000e+00;
    // x^1 l: +0xb.cc2f6ap-78
    const double pow_log_hp_i1_c1l=+3.9034978953262886568318e-23;
    // x^3 h: +0xa.aaaaaaaaaaaa8p-4
    const double pow_log_hp_i1_c3h=+6.6666666666666662965923e-01;
    // x^3 l: +0xa.a39ff856b8b48p-58
    const double pow_log_hp_i1_c3l=+3.6912000191139748287762e-17;
    // x^5 h: +0xc.cccccccccccd8p-5
    const double pow_log_hp_i1_c5h=+4.0000000000000007771561e-01;
    // x^5 l: +0xd.1a45eb001a7a8p-59
    const double pow_log_hp_i1_c5l=+2.2729438753992173259785e-17;
    // x^7 h: +0x9.24924924902fp-5
    const double pow_log_hp_i1_c7h=+2.8571428571422596842666e-01;
    // x^7 l: -0x9.15dc13d68fcbp-59
    const double pow_log_hp_i1_c7l=-1.5760638221657091401184e-17;
    // x^9 h: +0xe.38e38e3efb908p-6
    const double pow_log_hp_i1_c9h=+2.2222222224439128202000e-01;
    // x^9 l: -0xa.318372ef80b3p-61
    const double pow_log_hp_i1_c9l=-4.4206877750694226660462e-18;
    // x^11 h: +0xb.a2e8b4774d65p-6
    const double pow_log_hp_i1_c11h=+1.8181817649493431376939e-01;
    // x^11 l: -0xf.b93985cdfd018p-60
    const double pow_log_hp_i1_c11l=-1.3637991757050732404534e-17;
    // x^13 h: +0x9.d8a1034ad1d08p-6
    const double pow_log_hp_i1_c13h=+1.5384698220739514984423e-01;
    // x^13 l: +0xb.90c453761d998p-60
    const double pow_log_hp_i1_c13l=+1.0031468448744570127750e-17;
    // x^15 h: +0x8.87365e86f57p-6
    const double pow_log_hp_i1_c15h=+1.3325270873232053503443e-01;
    // x^15 l: +0xc.0909e2d23fa18p-60
    const double pow_log_hp_i1_c15l=+1.0438964882355715488187e-17;
    // x^17 h: +0xf.a0ed1dcf54c2p-7
    const double pow_log_hp_i1_c17h=+1.2209857898293391409439e-01;
    // x^17 l: -0xb.808fa661ee7p-64
    const double pow_log_hp_i1_c17l=-6.2353507361775658614922e-19;
    // [8.5786439478397369384765625e-2, 0.1286796629428863525390625] : | p - f | <= 2^-90.34375
    // coefficients for pow_log_hp generated by sollya
    // x^1 h: +0x8p-2
    const double pow_log_hp_i2_c1h=+2.0000000000000000000000e+00;
    // x^1 l: +0xf.10587eb673p-65
    const double pow_log_hp_i2_c1l=+4.0830648123892041400021e-19;
    // x^3 h: +0xa.aaaaaaaaaaa9p-4
    const double pow_log_hp_i2_c3h=+6.6666666666666629659233e-01;
    // x^3 l: +0xa.d47bbf5af9c6p-58
    const double pow_log_hp_i2_c3l=+3.7574156413768562504480e-17;
    // x^5 h: +0xc.ccccccccd0fdp-5
    const double pow_log_hp_i2_c5h=+4.0000000000011903811270e-01;
    // x^5 l: +0xf.9d7f6661cf56p-60
    const double pow_log_hp_i2_c5l=+1.3544048884735419812600e-17;
    // x^7 h: +0x9.2492492130db8p-5
    const double pow_log_hp_i2_c7h=+2.8571428568968876282597e-01;
    // x^7 l: -0xa.4b95f9e3f13ap-61
    const double pow_log_hp_i2_c7l=-4.4648560908357569884554e-18;
    // x^9 h: +0xe.38e391b1193bp-6
    const double pow_log_hp_i2_c9h=+2.2222222545351016931292e-01;
    // x^9 l: +0x8.b9fd233cdb1cp-63
    const double pow_log_hp_i2_c9l=+9.4613106671779569605423e-19;
    // x^11 h: +0xb.a2e78db581b5p-6
    const double pow_log_hp_i2_c11h=+1.8181790198107289358020e-01;
    // x^11 l: -0x9.0fd4d4e552p-68
    const double pow_log_hp_i2_c11l=-3.0702712585244743924189e-20;
    // x^13 h: +0x9.d8e081d3e6aa8p-6
    const double pow_log_hp_i2_c13h=+1.5386212042322236492886e-01;
    // x^13 l: -0x9.6f34ea6b2326p-61
    const double pow_log_hp_i2_c13l=-4.0915193019494245632463e-18;
    // x^15 h: +0x8.7f10e6045017p-6
    const double pow_log_hp_i2_c15h=+1.3275549376089784692212e-01;
    // x^15 l: +0xd.27330ad3686ep-62
    const double pow_log_hp_i2_c15l=+2.8521288181705335592571e-18;
    // x^17 h: +0x8.4bb46f596a4ep-6
    const double pow_log_hp_i2_c17h=+1.2962065576508485786889e-01;
    // x^17 l: +0x8.1a7883ea03fbp-60
    const double pow_log_hp_i2_c17l=+7.0285803369981064065015e-18;
    // [0.1286796629428863525390625, 0.17157287895679473876953125] : | p - f | <= 2^-89.8125
    // coefficients for pow_log_hp generated by sollya
    // x^1 h: +0x8p-2
    const double pow_log_hp_i3_c1h=+2.0000000000000000000000e+00;
    // x^1 l: +0xd.c35e0c685c858p-56
    const double pow_log_hp_i3_c1l=+1.9100212822095934190504e-16;
    // x^3 h: +0xa.aaaaaaaaa94dp-4
    const double pow_log_hp_i3_c3h=+6.6666666666658902506981e-01;
    // x^3 l: -0xc.1d2caa2f9af7p-58
    const double pow_log_hp_i3_c3l=-4.2028751245205628926972e-17;
    // x^5 h: +0xc.ccccccceb803p-5
    const double pow_log_hp_i3_c5h=+4.0000000001396107673912e-01;
    // x^5 l: +0x8.a6da59198538p-61
    const double pow_log_hp_i3_c5l=+3.7521067966033134733337e-18;
    // x^7 h: +0x9.2492485c9fef8p-5
    const double pow_log_hp_i3_c7h=+2.8571428425948214302466e-01;
    // x^7 l: -0x9.3d25b2697c8cp-62
    const double pow_log_hp_i3_c7l=-2.0033576489088646363246e-18;
    // x^9 h: +0xe.38e3f631a7768p-6
    const double pow_log_hp_i3_c9h=+2.2222231905345016245157e-01;
    // x^9 l: -0xf.a0240dd671bf8p-60
    const double pow_log_hp_i3_c9l=-1.3553004327492570887222e-17;
    // x^11 h: +0xb.a2d6d560fe8p-6
    const double pow_log_hp_i3_c11h=+1.8181391561299875547775e-01;
    // x^11 l: -0xa.bf774a43f278p-60
    const double pow_log_hp_i3_c11l=-9.3223293429047713175174e-18;
    // x^13 h: +0x9.daa6a40d81e38p-6
    const double pow_log_hp_i3_c13h=+1.5397039433267264985084e-01;
    // x^13 l: -0xf.2105d725792bp-61
    const double pow_log_hp_i3_c13l=-6.5611558580598907220676e-18;
    // x^15 h: +0x8.62e0a6fa9b6e8p-6
    const double pow_log_hp_i3_c15h=+1.3103500658546965440543e-01;
    // x^15 l: -0xe.743b0fce00e7p-60
    const double pow_log_hp_i3_c15l=-1.2536869294945799866242e-17;
    // x^17 h: +0x9.14e4da4496038p-6
    const double pow_log_hp_i3_c17h=+1.4190026583887080380286e-01;
    // x^17 l: -0xe.a10f7f68d9a5p-60
    const double pow_log_hp_i3_c17l=-1.2688758660136867948085e-17;
    // x^ : +0xa.fb0ccc06219b8p-8
    const double c_i1_l=+4.2893218813452475834946e-02;
    // x^ : +0xa.fb0ccc06219b8p-7
    const double c_i2_l=+8.5786437626904951669893e-02;
    // x^ : +0x8.3c49990499348p-6
    const double c_i3_l=+1.2867965644035742056595e-01;

        // setup
        vf_type ash=abs(sh);
        vf_type fiv01=select(ash < vf_type(c_i1_l), vf_type(0.0), vf_type(1.0));
        vf_type fiv23=select(ash < vf_type(c_i3_l), vf_type(2.0), vf_type(3.0));
        vf_type fiv=select(ash < vf_type(c_i2_l), fiv01, fiv23);
        vi_type iv=cvt<vi_type>(fiv);

        auto coeff_lookup=make_fixed_lookup_table<4, double>(iv);

        static const double c15hl_c1hl[][4]= {{
                pow_log_hp_i0_c17h, pow_log_hp_i1_c17h,
                pow_log_hp_i2_c17h, pow_log_hp_i3_c17h
            }, {
                pow_log_hp_i0_c17l, pow_log_hp_i1_c17l,
                pow_log_hp_i2_c17l, pow_log_hp_i3_c17l
            }, {
                pow_log_hp_i0_c15h, pow_log_hp_i1_c15h,
                pow_log_hp_i2_c15h, pow_log_hp_i3_c15h
            }, {
                pow_log_hp_i0_c15l, pow_log_hp_i1_c15l,
                pow_log_hp_i2_c15l, pow_log_hp_i3_c15l
            }, {
                pow_log_hp_i0_c13h, pow_log_hp_i1_c13h,
                pow_log_hp_i2_c13h, pow_log_hp_i3_c13h
            }, {
                pow_log_hp_i0_c13l, pow_log_hp_i1_c13l,
                pow_log_hp_i2_c13l, pow_log_hp_i3_c13l
            }, {
                pow_log_hp_i0_c11h, pow_log_hp_i1_c11h,
                pow_log_hp_i2_c11h, pow_log_hp_i3_c11h
            }, {
                pow_log_hp_i0_c11l, pow_log_hp_i1_c11l,
                pow_log_hp_i2_c11l, pow_log_hp_i3_c11l
            }, {
                pow_log_hp_i0_c9h, pow_log_hp_i1_c9h,
                pow_log_hp_i2_c9h, pow_log_hp_i3_c9h
            }, {
                pow_log_hp_i0_c9l, pow_log_hp_i1_c9l,
                pow_log_hp_i2_c9l, pow_log_hp_i3_c9l
            }, {
                pow_log_hp_i0_c7h, pow_log_hp_i1_c7h,
                pow_log_hp_i2_c7h, pow_log_hp_i3_c7h
            }, {
                pow_log_hp_i0_c7l, pow_log_hp_i1_c7l,
                pow_log_hp_i2_c7l, pow_log_hp_i3_c7l
            }, {
                pow_log_hp_i0_c5h, pow_log_hp_i1_c5h,
                pow_log_hp_i2_c5h, pow_log_hp_i3_c5h
            }, {
                pow_log_hp_i0_c5l, pow_log_hp_i1_c5l,
                pow_log_hp_i2_c5l, pow_log_hp_i3_c5l
            }, {
                pow_log_hp_i0_c3h, pow_log_hp_i1_c3h,
                pow_log_hp_i2_c3h, pow_log_hp_i3_c3h
            }, {
                pow_log_hp_i0_c3l, pow_log_hp_i1_c3l,
                pow_log_hp_i2_c3l, pow_log_hp_i3_c3l
            }, {
                pow_log_hp_i0_c1h, pow_log_hp_i1_c1h,
                pow_log_hp_i2_c1h, pow_log_hp_i3_c1h
            }, {
                pow_log_hp_i0_c1l, pow_log_hp_i1_c1l,
                pow_log_hp_i2_c1l, pow_log_hp_i3_c1l
            }
        };
        vf_type ch, cl;
        ph = coeff_lookup.from(c15hl_c1hl[0*2+0]);
        pl = coeff_lookup.from(c15hl_c1hl[0*2+1]);
#pragma GCC unroll 9
#pragma clang loop unroll(disable)
        for (std::size_t i=1; i<9; ++i) {
            ch = coeff_lookup.from(c15hl_c1hl[i*2+0]);
            cl = coeff_lookup.from(c15hl_c1hl[i*2+1]);
...
__pow_log_k2(arg_t<vf_type> xh, arg_t<vf_type> xl)
{
    ...
    kf = _T::sel(c, kf-1.0, kf);
    dvf_type ym;
    d_ops::add122cond(ym.h(), ym.l(), -1.0, xrh, xrl);
    dvf_type yp;
    d_ops::add122cond(yp.h(), yp.l(), +1.0, xrh, xrl);
    dvf_type ds= d_ops::sloppy_div(ym, yp);
    return __pow_log_k<_F, _P>(ds.h(), ds.l(), kf);
}
...
#else
    vf_type pe=horner(x4,
                      sin_c15,
                      sin_c11,
                      sin_c7);
    vf_type po=horner(x4,
                      sin_c17,
                      sin_c13,
                      sin_c9);
#endif
 ...
 */
    ...
    const double sin_sun_c2=-1.6666666666666629659233e-01;
    // x^4 : +0x8.888888887bbp-10
    const double sin_sun_c4=+8.3333333333219239413836e-03;
    // x^6 : -0xd.00d00cdf95c08p-16
    const double sin_sun_c6=-1.9841269829464980235974e-04;
    // x^8 : +0xb.8ef1aafd29de8p-22
    const double sin_sun_c8=+2.7557313585037963205341e-06;
    // x^10 : -0xd.72f2a806099d8p-29
    const double sin_sun_c10=-2.5050742816066697486245e-08;
    // x^12 : +0xa.ec731414736ep-36
    const double sin_sun_c12=+1.5895975168091068291831e-10;
    vf_type z = xh*xh;
    vf_type w = z*z;
    vf_type r = sin_sun_c4 + z*(sin_sun_c6 + z*sin_sun_c8) +
        z*w*(sin_sun_c10 + z*sin_sun_c12);
    vf_type v = z*xh;
    return xh - ((z*(0.5*xl - v*r) - xl) - v*sin_sun_c2);
#endif
}
 ...
 */
    ...
    // coefficients for cos generated by sollya
    // x^4 : +0xa.aaaaaaaaaaaa8p-8
    const double cos_sun_c4=+4.1666666666666664353702e-02;
    // x^6 : -0xb.60b60b60b465p-13
    const double cos_sun_c6=-1.3888888888887057117272e-03;
    // x^8 : +0xd.00d00cf9c1c8p-19
    const double cos_sun_c8=+2.4801587298453923405989e-05;
    // x^10 : -0x9.3f27d0171f358p-25
    const double cos_sun_c10=-2.7557317155370235416966e-07;
    // x^12 : +0x8.f75abe99bf3p-32
    const double cos_sun_c12=+2.0876127299142779832603e-09;
    // x^14 : -0xc.839c2b128b218p-40
    const double cos_sun_c14=-1.1381509183057428987942e-11;
    vf_type z  = xh*xh;
    vf_type w  = z*z;
    vf_type r  = z*(cos_sun_c4+z*(cos_sun_c6+z*cos_sun_c8)) +
        w*w*(cos_sun_c10+z*(cos_sun_c12+z*cos_sun_c14));
    vf_type hz = 0.5*z;
    w  = 1.0-hz;
...
__tan_k(arg_t<vf_type> xrh, arg_t<vf_type> xrl, arg_t<vi2_type> q)
{
    ...
    vf_type ee=horner(xrh8,
                      ...
                      tan_c23,
                      tan_c15);
    vf_type eo=horner(xrh8,
                      tan_c27,
                      tan_c19,
                      tan_c11);
    vf_type oe=horner(xrh8,
                      tan_c29,
                      tan_c21,
                      tan_c13);
    vf_type oo=horner(xrh8,
                      tan_c25,
                      tan_c17,
                      tan_c9);
#endif
 ...
 */
    ...
    const double tan_c2=+3.3333333333333403647458e-01;
    // x^4 : +0x8.888888887ff8p-6
    const double tan_c4=+1.3333333333321162328389e-01;
    // x^6 : +0xd.d0dd0dd8f576p-8
    const double tan_c6=+5.3968253975616636841650e-02;
    // x^8 : +0xb.327a42296588p-9
    const double tan_c8=+2.1869488312130036522518e-02;
    // x^10 : +0x9.1371efe0de738p-10
    const double tan_c10=+8.8632395420220177334469e-03;
    // x^12 : +0xe.b6922b69db5ap-12
    const double tan_c12=+3.5920819997191325706476e-03;
    // x^14 : +0xb.edd9ef641aa88p-13
    const double tan_c14=+1.4561897797905241306454e-03;
    // x^16 : +0x9.a2ce102c6538p-14
    const double tan_c16=+5.8813212735338120384920e-04;
    // x^18 : +0x8.111418046d13p-15
    const double tan_c18=+2.4617653983530424829235e-04;
    // x^20 : +0xa.53a6a90d99118p-17
    const double tan_c20=+7.8786939890559045947087e-05;
    // x^22 : +0x9.403fb8f2a8ff8p-17
    const double tan_c22=+7.0579317683901174654802e-05;
    // x^24 : -0x9.62efe0aba1318p-19
    const double tan_c24=-1.7903275951360724942444e-05;
    // x^26 : +0xd.767c03ce18978p-19
    const double tan_c26=+2.5678310044561697059315e-05;
    ...
    using ctbl = impl::d_real_constants<d_real<double>, double>;
    const double large_arg=0.6731984257692414;
