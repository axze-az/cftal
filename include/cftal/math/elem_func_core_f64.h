...
tanh_k(arg_t<vf_type> xc)
{
    ...
    // vf_type tanh_x_gt_ln_3_2 = 1.0 - 2.0/(em+1);
    // produce a faithfully rounded tanh:
    vf_type emp1l, emp1h=d_ops::quick_two_sum(em, vf_type(1.0), emp1l);
    dvf_type emp1(emp1h, emp1l);
    vf_type tanh_x_gt_ln_3_2 = (vf_type(1.0) - vf_type(2.0)/emp1).h();
