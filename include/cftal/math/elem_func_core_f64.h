...
namespace cftal {
    namespace math {
        ...
        struct elem_func_core<double, _T> {
            ...
            // calculates (expm1(x) - x)/x^2
            static
            vf_type
            __exp_tbl_poly(arg_t<vf_type> x,
                           arg_t<vf_type> x2);
...
typename cftal::math::elem_func_core<double, _T>::vf_type
cftal::math::elem_func_core<double, _T>::
__exp_tbl_poly(arg_t<vf_type> x, arg_t<vf_type> x2)
{
            ...
            vf_type* expl)
{
    ...
    vf_type x2=xrh*xrh;
    vf_type p=__exp_tbl_poly(xrh, x2);
    vf_type y;
