        ...
        arg_t<vf_type> kf, arg_t<vi2_type> k2)
{
    ...
    y += 1;
#else
    // [-0.3465735912322998046875, 0.3465735912322998046875] : | p - f | <= 2^-67.625
    ...
    // x^4 : +0xa.aaaaaaaaaaa98p-8
    const double exp_c4=+4.1666666666666650475914e-02;
    // x^5 : +0x8.888888888969p-10
    const double exp_c5=+8.3333333333341121085258e-03;
    // x^6 : +0xb.60b60b60c258p-13
    const double exp_c6=+1.3888888888902543861104e-03;
    // x^7 : +0xd.00d00cfa1ba9p-16
    const double exp_c7=+1.9841269838887870763725e-04;
    // x^8 : +0xd.00d00ca2db65p-19
    const double exp_c8=+2.4801587259862594109314e-05;
    // x^9 : +0xb.8ef1ea8c55908p-22
    const double exp_c9=+2.7557322617352129148782e-06;
    // x^10 : +0x9.3f292906e63cp-25
    const double exp_c10=+2.7557378428424534491203e-07;
    // x^11 : +0xd.72d1f346204ep-29
    const double exp_c11=+2.5049813254122191887007e-08;
    // x^12 : +0x8.f31021be88728p-32
    const double exp_c12=+2.0837096734764515299544e-09;
    // x^13 : +0xb.73a696084b1e8p-36
    const double exp_c13=+1.6664505021780579290098e-10;
    // x^14 : +0xb.e39b82722ddd8p-39
    const double exp_c14=+2.1626131706385269108036e-11;
    vf_type xx=xrh*xrh;
