...
__pow_log_k2(arg_t<vf_type> xc)
{
    ...
    vf_type y= horner(zh,
                      ...
                      log_c4);
    vf_type ye;
    horner_comp_quick(y, ye, zh, y, log_c2h);
    // d_ops::mul122(y, ye, zh, y, ye);
    // d_ops::add212(y, ye, y, ye, log_c2h);
    d_ops::mul122(y, ye, zh/*, zl*/, y, ye);
    using ctbl=impl::d_real_constants<d_real<double>, double>;
    vf_type kf = _T::cvt_i_to_f(_T::vi2_odd_to_vi(k));
    ...
    dvf_type dhfsq_y= dhfsq + dvf_type(y,ye);
    log_x += ds*dhfsq_y;
    log_x += (df -dhfsq);
    return log_x;
#else
