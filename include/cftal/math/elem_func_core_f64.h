...
#if 1
    // [0.25, 0.5] : | p - f | <= 2^-20.671875
    // coefficients for rsqrt generated by sollya
    // x^0 : +0xa.93dae0510d988p-1
    const double rsqrt_i0_c0=+5.2887792681638510217113e+00;
    // x^1 : -0x8.af16bae403808p+2
    const double rsqrt_i0_c1=-3.4735762331647499934206e+01;
    // x^2 : +0xa.e796b4bc9fc88p+4
    const double rsqrt_i0_c2=+1.7447429345780668086263e+02;
    // x^3 : -0x8.fa91e703e3a2p+6
    const double rsqrt_i0_c3=-5.7464248281552181651932e+02;
    // x^4 : +0x9.94135f878b75p+7
    const double rsqrt_i0_c4=+1.2260378382070289262629e+03;
    // x^5 : -0xc.ca82c54a2002p+7
    const double rsqrt_i0_c5=-1.6372554114498207127326e+03;
    // x^6 : +0x9.bbcfc7352b3p+7
    const double rsqrt_i0_c6=+1.2459058167090624920093e+03;
    // x^7 : -0xc.e6c4ad805d2c8p+5
    const double rsqrt_i0_c7=-4.1284603405269950826550e+02;
    // [0.5, 1] : | p - f | <= 2^-21.171875
    // coefficients for rsqrt generated by sollya
    // x^0 : +0xe.f57c3906a4a68p-2
    const double rsqrt_i1_c0=+3.7397316847138086792768e+00;
    // x^1 : -0xc.47ec1ce7f903p+0
    const double rsqrt_i1_c1=-1.2280946547159157233864e+01;
    // x^2 : +0xf.6be7105db3d9p+1
    const double rsqrt_i1_c2=+3.0842989011529148513091e+01;
    // x^3 : -0xc.b2ab3490ac168p+2
    const double rsqrt_i1_c3=-5.0791699544221366124930e+01;
    // x^4 : +0xd.8bc238b0935cp+2
    const double rsqrt_i1_c4=+5.4183729336201793103100e+01;
    // x^5 : -0x9.0b6dc65afd88p+2
    const double rsqrt_i1_c5=-3.6178575123651285139204e+01;
    // x^6 : +0xd.c3f42caedb058p+0
    const double rsqrt_i1_c6=+1.3765444557847350992574e+01;
    // x^7 : -0x9.1f68eb6912a18p-2
