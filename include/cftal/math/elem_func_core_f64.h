...
{
    // return __pow_log_k<log_func::c_log_e>(xc).h();
...
__pow_log_k(arg_t<vf_type> sh, arg_t<vf_type> sl, arg_t<vf_type> kf)
{
    ...
    const double pow_log_c3h=+6.6666666666666662965923e-01;
    // x^3 l: +0xa.aaab32cf2c8fp-58
    const double pow_log_c3l=+3.7007462307803146546515e-17;
    // x^5 h: +0xc.cccccccccccdp-5
    const double pow_log_c5h=+4.0000000000000002220446e-01;
    // x^5 l: -0xc.d5332786ce15p-59
    const double pow_log_c5l=-2.2261379899555494748737e-17;
    // x^7 : +0x9.2492492492498p-5
    const double pow_log_c7=+2.8571428571428575393654e-01;
    // x^9 : +0xe.38e38e38e2978p-6
    const double pow_log_c9=+2.2222222222220852638763e-01;
    // x^11 : +0xb.a2e8ba2f4c478p-6
    const double pow_log_c11=+1.8181818182091943891798e-01;
    // x^13 : +0x9.d89d897a52f8p-6
    const double pow_log_c13=+1.5384615350312413895040e-01;
    // x^15 : +0x8.8888a6af4ed2p-6
    const double pow_log_c15=+1.3333336141407159392003e-01;
    // x^17 : +0xf.0f0245e25efep-7
    const double pow_log_c17=+1.1764553463284949108569e-01;
    // x^19 : +0xd.7b0afd07597bp-7
    const double pow_log_c19=+1.0531747202794491946598e-01;
    // x^21 : +0xc.08df9f2aa0e78p-7
    const double pow_log_c21=+9.4020798414255354891189e-02;
    ...
    d_ops::mul22(ph, pl, s2, s2l, ph, pl);
    d_ops::add22(ph, pl, pow_log_c5h, pow_log_c5l, ph, pl);
    d_ops::mul22(ph, pl, s2, s2l, ph, pl);
    d_ops::add22(ph, pl, pow_log_c3h, pow_log_c3l, ph, pl);
#else
...
{
    vf_type abs_x= abs(x);
    dvf_type ldx= __pow_log_k<log_func::c_log_2>(abs_x);
    dvf_type yldx = y*ldx;
