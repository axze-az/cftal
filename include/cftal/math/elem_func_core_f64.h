                 ...
                 vi2_type* pk)
{
    ...
    kf=_T::cvt_i_to_f(_T::vi2_odd_to_vi(k));
    if (pk != nullptr)
        *pk = k;
...
__log_tbl_k(arg_t<vf_type> xc)
{
    ...
    // [-6.44944608211517333984375e-2, 6.44944608211517333984375e-2] : | p - f | <= 2^-74.59375
    ...
    constexpr
    const double log_c4=-2.4999999999999997224442e-01;
    // x^5 : +0xc.ccccccccd0c58p-6
    constexpr
    const double log_c5=+2.0000000000005643818746e-01;
    // x^6 : -0xa.aaaaaaaab037p-6
    constexpr
    const double log_c6=-1.6666666666674551100513e-01;
    // x^7 : +0x9.2492491370438p-6
    constexpr
    const double log_c7=+1.4285714279481373512048e-01;
    // x^8 : -0xf.ffffffd30fe48p-7
    constexpr
    const double log_c8=-1.2499999991825840039983e-01;
    // x^9 : +0xe.38e3d54effbap-7
    constexpr
    const double log_c9=+1.1111114421328044388204e-01;
    // x^10 : -0xc.cccd2443428ep-7
    constexpr
    const double log_c10=-1.0000004072800944276977e-01;
    // x^11 : +0xb.a29c4aa25b47p-7
    constexpr
    const double log_c11=+9.0899979059680030557544e-02;
    // x^12 : -0xa.aa5314e76f5p-7
    constexpr
    const double log_c12=-8.3322892386485936100371e-02;
    // x^13 : +0xa.0183b3c7d5808p-7
    constexpr
    const double log_c13=+7.8171217711922494353338e-02;
    // x^14 : -0x9.4f8f1e88b7ecp-7
    constexpr
    const double log_c14=-7.2740449818808783355450e-02;
                ...
                arg_t<vf_type> kf)
{
    ...
    vf_type p=horner4(r, r2, vf_type(r2*r2), ci);
    vf_type ph, pl;
    horner_comp_quick(ph, pl, r, p,  log_c3, log_c2);
    d_ops::mul22(ph, pl, r, rl, ph, pl);
    d_ops::add122(ph, pl, log_c1, ph, pl);
    vf_type lh, ll;
