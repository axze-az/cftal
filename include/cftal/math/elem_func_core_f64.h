...
rsqrt_k(arg_t<vf_type> x)
{
    ...
    // x^0 : +0xd.fdfba679ae27p-2
    const double rsqrt_c0=+3.4980302821891546827260e+00;
    // x^1 : -0x8.fc0dd82dd7c8p+0
    const double rsqrt_c1=-8.9845862495347148524161e+00;
    // x^2 : +0xe.a85d57fed63fp+0
    const double rsqrt_c2=+1.4657674312320747134208e+01;
    // x^3 : -0xb.f932c3f456ac8p+0
    const double rsqrt_c3=-1.1973430869248362640178e+01;
    // x^4 : +0xf.37bc8fc5ac97p-2
    const double rsqrt_c4=+3.8044302429581398072855e+00;
