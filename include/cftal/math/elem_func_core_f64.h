        ...
        arg_t<vf_type> kf, arg_t<vi2_type> k2)
{
    ...
    y += 1;
#else
    // [-0.3465735912322998046875, 0.3465735912322998046875] : | p - f | <= 2^-67.8125
    ...
    // x^4 : +0xa.aaaaaaaaaaab8p-8
    const double exp_c4=+4.1666666666666678231490e-02;
    // x^5 : +0x8.888888888984p-10
    const double exp_c5=+8.3333333333342057835935e-03;
    // x^6 : +0xb.60b60b60abc28p-13
    const double exp_c6=+1.3888888888877470601663e-03;
    // x^7 : +0xd.00d00cf8af018p-16
    const double exp_c7=+1.9841269838381811268201e-04;
    // x^8 : +0xd.00d00d58795e8p-19
    const double exp_c8=+2.4801587340516783355667e-05;
    // x^9 : +0xb.8ef1f15792af8p-22
    const double exp_c9=+2.7557323582823584305612e-06;
    // x^10 : +0x9.3f268a8da1d78p-25
    const double exp_c10=+2.7557259328370299982682e-07;
    // x^11 : +0xd.72b6750f27dap-29
    const double exp_c11=+2.5049031855317797810700e-08;
    // x^12 : +0x8.fc1e426027578p-32
    const double exp_c12=+2.0919453166345956554564e-09;
    // x^13 : +0xb.9bd8ff33d98c8p-36
    const double exp_c13=+1.6892998042304156198972e-10;
    vf_type xx=xrh*xrh;
