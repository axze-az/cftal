...
old_tanh_k(arg_t<vf_type> xc)
{
    ...
    const vf_type tanh_c2=+1.1999999999999992894573e+00;
    // x^4 : -0xb.b3ee7218f3888p-11
    const vf_type tanh_c4=-5.7142857141288120118028e-03;
    // x^6 : +0x8.5270a8fe7802p-15
    const vf_type tanh_c6=+2.5396824820567175974573e-04;
    // x^8 : -0xc.cbe06da93229p-20
    const vf_type tanh_c8=-1.2203591589975623790199e-05;
    // x^10 : +0xa.09a3738053508p-24
    const vf_type tanh_c10=+5.9829058152612645097467e-07;
    // x^12 : -0xf.260464a2fce1p-29
    const vf_type tanh_c12=-2.8216288487555987828251e-08;
...
__sin_k(arg_t<vf_type> xh, arg_t<vf_type> xl)
{
    ...
    // x^3 : -0xa.aaaaaaaaaaaa8p-6
    const vf_type sin_c3=-1.6666666666666665741481e-01;
    // x^5 : +0x8.8888888888338p-10
    const vf_type sin_c5=+8.3333333333330383146942e-03;
    // x^7 : -0xd.00d00cffd6618p-16
    const vf_type sin_c7=-1.9841269840923354632854e-04;
    // x^9 : +0xb.8ef1d13ee1e78p-22
    const vf_type sin_c9=+2.7557319021644065914860e-06;
    // x^11 : -0xd.732069828cf5p-29
    const vf_type sin_c11=-2.5052043274294370345991e-08;
    // x^13 : +0xb.0711ea8fea688p-36
    const vf_type sin_c13=+1.6047294965259665336204e-10;
    // x^15 : -0xb.7e01089ac32fp-44
    const vf_type sin_c15=-6.5325612420449819354698e-13;
    // x^17 : -0xb.64eac061cb4bp-48
    const vf_type sin_c17=-4.0480355151479898933826e-14;
 ...
 */
    ...
    const vf_type sin_sun_c2=-1.6666666666666629659233e-01;
    // x^4 : +0x8.888888887bbp-10
    const vf_type sin_sun_c4=+8.3333333333219239413836e-03;
    // x^6 : -0xd.00d00cdf95c08p-16
    const vf_type sin_sun_c6=-1.9841269829464980235974e-04;
    // x^8 : +0xb.8ef1aafd29de8p-22
    const vf_type sin_sun_c8=+2.7557313585037963205341e-06;
    // x^10 : -0xd.72f2a806099d8p-29
    const vf_type sin_sun_c10=-2.5050742816066697486245e-08;
    // x^12 : +0xa.ec731414736ep-36
    const vf_type sin_sun_c12=+1.5895975168091068291831e-10;
    vf_type z = xh*xh;
    vf_type w = z*z;
...
__cos_k(arg_t<vf_type> xh, arg_t<vf_type> xl)
{
    ...
    const vf_type cos_c6=-1.3888888888888447064457e-03;
    // x^8 : +0xd.00d00d0013098p-19
    const vf_type cos_c8=+2.4801587301259415111907e-05;
    // x^10 : -0x9.3f27db0aab07p-25
    const vf_type cos_c10=-2.7557319100721175104631e-07;
    // x^12 : +0x8.f76bc25c94448p-32
    const vf_type cos_c12=+2.0876731782420635499728e-09;
    // x^14 : -0xc.9bf5764d12da8p-40
    const vf_type cos_c14=-1.1468013512615928202661e-11;
    // x^16 : +0xd.135bf90ffe23p-48
    const vf_type cos_c16=+4.6453941653669631599764e-14;
 ...
 */
    ...
    // coefficients for cos generated by sollya
    // x^4 : +0xa.aaaaaaaaaaaa8p-8
    const vf_type cos_sun_c4=+4.1666666666666664353702e-02;
    // x^6 : -0xb.60b60b60b465p-13
    const vf_type cos_sun_c6=-1.3888888888887057117272e-03;
    // x^8 : +0xd.00d00cf9c1c8p-19
    const vf_type cos_sun_c8=+2.4801587298453923405989e-05;
    // x^10 : -0x9.3f27d0171f358p-25
    const vf_type cos_sun_c10=-2.7557317155370235416966e-07;
    // x^12 : +0x8.f75abe99bf3p-32
    const vf_type cos_sun_c12=+2.0876127299142779832603e-09;
    // x^14 : -0xc.839c2b128b218p-40
    const vf_type cos_sun_c14=-1.1381509183057428987942e-11;
    vf_type z  = xh*xh;
    vf_type w  = z*z;
