...
namespace cftal {
    namespace math {
        ...
        struct elem_func_core<double, _T> {
            ...
            // calculates %e^(xrh+xrl)*(2^ki/N)*2^k
            static
            vf_type
            ...
            arg_t<vi_type> ki, arg_t<vi_type> idx)
{
    ...
    vf_type tl=lk.from(tbl._exp_fxi_l_tbl);
                 ...
                 arg_t<vf_type> x)
{
    ...
    if (_N == 32) {
        ...
        // x^ : +0xb.17217f7dp-9
        const double _ln2_h_N=+2.1660849392446834826842e-02;
        // x^ : +0xe.7bcd5e4f1d9dp-48
        const double _ln2_l_N=+5.1456092446553382152435e-14;

        vf_type kf = rint(vf_type(x * _N_ln2));
