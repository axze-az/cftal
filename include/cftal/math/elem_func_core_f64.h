...
rsqrt_k(arg_t<vf_type> x)
{
...
#if 1
    // [0.25, 0.3535533845424652099609375] : | p - f | <= 2^-10.26953125
    // coefficients for rsqrt generated by sollya
    // x^0 : +0xd.c2f2d9a12ca7p-2
    const double rsqrt_i0_c0=+3.4403795246718464895253e+00;
    // x^1 : -0xf.5b52acbafe038p-1
    const double rsqrt_i0_c1=-7.6783651331197750877777e+00;
    // x^2 : +0xf.4f136060106fp-1
    const double rsqrt_i0_c2=+7.6544447057023869973591e+00;
    // x^ : +0x8p-5
    // const double rsqrt_i0_left=+2.5000000000000000000000e-01;
    // [0.3535533845424652099609375, 0.5] : | p - f | <= 2^-10.51953125
    // coefficients for rsqrt generated by sollya
    // x^0 : +0xb.926f54169696p-2
    const double rsqrt_i1_c0=+2.8930028094088324763788e+00;
    // x^1 : -0x9.21941fd40a738p-1
    const double rsqrt_i1_c1=-4.5655832239474198885887e+00;
    // x^2 : +0xc.df89650e94f8p-2
    const double rsqrt_i1_c2=+3.2182975568914500286155e+00;
    // x^ : +0xb.504f333f9de68p-5
    const double rsqrt_i1_left=+3.5355339059327378636866e-01;
    // [0.5, 0.707106769084930419921875] : | p - f | <= 2^-10.76953125
    // coefficients for rsqrt generated by sollya
    // x^0 : +0x9.bb19d282249e8p-2
    const double rsqrt_i2_c0=+2.4327156917508134803541e+00;
    // x^1 : -0xa.dbdd7838911cp-2
    const double rsqrt_i2_c1=-2.7147120270276694498079e+00;
    // x^2 : +0xa.d3347a9c83abp-3
    const double rsqrt_i2_c2=+1.3531274394049055409539e+00;
    // x^ : +0x8p-4
    const double rsqrt_i2_left=+5.0000000000000000000000e-01;
    // [0.707106769084930419921875, 1] : | p - f | <= 2^-11.01953125
    // coefficients for rsqrt generated by sollya
    // x^0 : +0x8.2ec1fe8a6d4d8p-2
    const double rsqrt_i3_c0=+2.0456619045247186328140e+00;
    // x^1 : -0xc.e9d5db173e09p-3
    const double rsqrt_i3_c1=-1.6141774288623804700649e+00;
    // x^2 : +0x9.1a4bdd656776p-4
    const double rsqrt_i3_c2=+5.6892000658851094030410e-01;
    // x^ : +0xb.504f333f9de68p-4
    const double rsqrt_i3_left=+7.0710678118654757273731e-01;
    ...
    vf_type mm_i3= horner(mm0,
                          ...
                          rsqrt_i3_c1,
                          rsqrt_i3_c0);
    vf_type mm_i01 = _T::sel(mm0 <= rsqrt_i1_left, mm_i0, mm_i1);
    vf_type mm_i23 = _T::sel(mm0 <= rsqrt_i3_left, mm_i2, mm_i3);
    vf_type mm = _T::sel(mm0 <= rsqrt_i2_left, mm_i01, mm_i23);
