...
atan_k(arg_t<vf_type> xc)
{
    ...
    // x^8
    const vf_type atan_c8=0x1.fda102p-5f;  // 0x3d7ed081
    // x^6
    const vf_type atan_c6=-0x1.b50f5p-4f;  // 0xbdda87a8
    // x^4
    const vf_type atan_c4=0x1.23facap-3f;  // 0x3e11fd65
    // x^2
    const vf_type atan_c2=-0x1.99960ep-3f;  // 0xbe4ccb07
    // x^0
    const vf_type atan_c0=0x1.555554p-2f;  // 0x3eaaaaaa
    vf_type t2=t*t;
...
acos_k(arg_t<vf_type> xc)
{
    ...
    vmf_type abs_x_lt_1_2 = abs(x) < 0.5f;
