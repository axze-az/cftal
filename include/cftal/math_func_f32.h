...
exp_k(arg_t<vf_type> xc, bool exp_m1)
{
    ...
    // x^2 : +0x8p-4f
    const vf_type exp_c2=+5.0000000000e-01f;
    // x^3 : +0xa.aaaa9p-6f
    const vf_type exp_c3=+1.6666664183e-01f;
    // x^4 : +0xa.aaa73p-8f
    const vf_type exp_c4=+4.1666459292e-02f;
    // x^5 : +0x8.88ae5p-10f
    const vf_type exp_c5=+8.3338962868e-03f;
    // x^6 : +0xb.6a77ep-13f
    const vf_type exp_c6=+1.3935414609e-03f;
    // x^7 : +0xc.d3317p-16f
    const vf_type exp_c7=+1.9569355936e-04f;
    y= impl::poly(xr,
                  exp_c7,
                  exp_c6,
                  exp_c5,
...
exp10_k(arg_t<vf_type> x)
{
    ...
    vi_type k= _T::cvt_f_to_i(kf);
    // [-0.15051500499248504638671875, 0.15051500499248504638671875] : | p - f | <= 2^-30.09375
    ...
    // x^2 : +0xa.9a926p-2f
    const vf_type exp10_c2=+2.6509490013e+00f;
    // x^3 : +0x8.23808p-2f
    const vf_type exp10_c3=+2.0346698761e+00f;
    // x^4 : +0x9.5ebb8p-3f
    const vf_type exp10_c4=+1.1712560654e+00f;
    // x^5 : +0x8.a4102p-4f
    const vf_type exp10_c5=+5.4005444050e-01f;
    // x^6 : +0xd.478b9p-6f
    const vf_type exp10_c6=+2.0749177039e-01f;
    // x^7 : +0xd.79773p-8f
    const vf_type exp10_c7=+5.2634667605e-02f;
    // x^ : +0x9.35d8ep-2f
    ...
    // x^ : +0xa.9a926p-1f
    const vf_type log10sqr=+5.3018980026e+00f;
    // EFT
    vf_type ye;
