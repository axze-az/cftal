...
tanh_k(arg_t<vf_type> xc)
{
    ...
    // [3.4694469519536141888238489627838134765625e-18, 0.5493061542510986328125] : | p - f | <= 2^-24.3203125
    // coefficients for tanh generated by sollya
    // x^0 : +0x9.9999ap-3f
    const vf_type tanh_c0=+1.2000000477e+00f;
    // x^2 : -0xb.b497cp-11f
    const vf_type tanh_c2=-5.7155471295e-03f;
    // x^4 : +0x8.983f6p-15f
    const vf_type tanh_c4=+2.6228994830e-04f;
    // x^6 : -0xe.8a981p-19f
    const vf_type tanh_c6=-2.7735486583e-05f;
    vf_type xx= x*x;
