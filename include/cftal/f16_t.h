...
namespace cftal {
    ...
    constexpr
    inline
    mf_f16_t read_bits(const f16_t& v) {
...
inline
cftal::f16_t cftal::asinh(const f16_t& v)
{
    return f16_t(std::asinh(float(v)));
}

inline
cftal::f16_t cftal::acosh(const f16_t& v)
{
    return f16_t(std::acosh(float(v)));
}
