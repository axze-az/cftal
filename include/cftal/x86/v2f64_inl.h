...
inline
cftal::vec<double, 2>
cftal::expand_mask<cftal::vec<double, 2> >::
from(const vec<bit, 2>& s)
{
    return x86::expand_mask_v2f64(s());
}
...
inline
cftal::vec<double, 2>
cftal::permute(const vec<double, 2>& s, const vec<int64_t, 2>& idx)
{
    return x86::permute_v2f64_v2s64(s(), idx());
}

#if 0 // defined (__AVX2__)
inline
cftal::impl::variable_vec_lookup_table<double, int32_t, 2>::
