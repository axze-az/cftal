...
erf_k(arg_t<vf_type> xc)
{
    ...
    // x^1
    const vf_type erf_i0_c1=0x1.20dd750429b6dp0;
    // x^3
    const vf_type erf_i0_c3=-0x1.812746b037985p-2;
    // x^5
    const vf_type erf_i0_c5=0x1.ce2f21a038ad6p-4;
    // x^7
    const vf_type erf_i0_c7=-0x1.b82ce30abaaefp-6;
    // x^9
    const vf_type erf_i0_c9=0x1.565bc99661e2dp-8;
    // x^11
    const vf_type erf_i0_c11=-0x1.c02bbb94d88fp-11;
    // x^13
    const vf_type erf_i0_c13=0x1.f8df4c01486e5p-14;
    // x^15
    const vf_type erf_i0_c15=-0x1.be7a65ace5f66p-17;
    // x^17
    const vf_type erf_i0_c17=-0x1.2c0e11f53ef51p-17;
    // x^19
    const vf_type erf_i0_c19=0x1.b2ceed7b3b355p-15;
    // x^21
    const vf_type erf_i0_c21=-0x1.971340a0428b1p-13;
    // x^23
    const vf_type erf_i0_c23=0x1.227251c62a558p-11;
    // x^25
    const vf_type erf_i0_c25=-0x1.3c738686060f9p-10;
    // x^27
    const vf_type erf_i0_c27=0x1.0512d0dd0259cp-9;
    // x^29
    const vf_type erf_i0_c29=-0x1.406e7c239d12ap-9;
    // x^31
    const vf_type erf_i0_c31=0x1.1b59d19c9bc71p-9;
    // x^33
    const vf_type erf_i0_c33=-0x1.5517690a21884p-10;
    // x^35
    const vf_type erf_i0_c35=0x1.f4312b128665fp-12;
    // x^37
    const vf_type erf_i0_c37=-0x1.51119e59b8069p-14;
    vf_type xx= x*x;
