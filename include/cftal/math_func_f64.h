...
exp_k(arg_t<vf_type> xc, bool exp_m1)
{
    ...
    if (exp_m1 == false) {
        ...
        // x^0
        const vf_type expn_c0=0x1.5555555555555p-3;
        // x^2
        const vf_type expn_c2=-0x1.6c16c16c15e1p-9;
        // x^4
        const vf_type expn_c4=0x1.1566abbae0416p-14;
        // x^6
        const vf_type expn_c6=-0x1.bbd75fd7fec34p-20;
        // x^8
        const vf_type expn_c8=0x1.668d30746a544p-25;
        // x^10
        const vf_type expn_c10=-0x1.166fdd8468b8fp-30;
        vf_type xx= xr*xr;
...
exp2_k(arg_t<vf_type> x)
{
    ...
    // x^1
    const vf_type exp2_c1=0x1.62e42fefa39efp-1;
    // x^2
    const vf_type exp2_c2=0x1.ebfbdff82c58fp-3;
    // x^3
    const vf_type exp2_c3=0x1.c6b08d704a1bfp-5;
    // x^4
    const vf_type exp2_c4=0x1.3b2ab6fba4d83p-7;
    // x^5
    const vf_type exp2_c5=0x1.5d87fe787352p-10;
    // x^6
    const vf_type exp2_c6=0x1.430912f8a7e3dp-13;
    // x^7
    const vf_type exp2_c7=0x1.ffcbfd869f99cp-17;
    // x^8
    const vf_type exp2_c8=0x1.62c02169fe52bp-20;
    // x^9
    const vf_type exp2_c9=0x1.b521b53bbb82ep-24;
    // x^10
    const vf_type exp2_c10=0x1.e4d1e6394b24cp-28;
    // x^11
    const vf_type exp2_c11=0x1.f333621f98aa8p-32;
    // x^12
...
erf_k(arg_t<vf_type> xc)
{
    ...
    const vf_type erf_i0_c0=+3.0000000000000000000000e+00;
     // x^2 : +0xe.6666666666588p-4
    const vf_type erf_i0_c2=+8.9999999999999691357999e-01;
     // x^4 : +0xe.434a9b1054e48p-8
    const vf_type erf_i0_c4=+5.5714285714504159507943e-02;
     // x^6 : -0xc.17cbba5b7efp-11
    const vf_type erf_i0_c6=-5.9047619101302017963206e-03;
     // x^8 : -0x9.120a0a23d868p-17
    const vf_type erf_i0_c8=-6.9202161348594403225687e-05;
     // x^10 : +0xb.ea21ec2160618p-17
    const vf_type erf_i0_c10=+9.0901032367754353437188e-05;
     // x^12 : -0xe.b0a041ae00bd8p-21
    const vf_type erf_i0_c12=-7.0047117810559824158697e-06;
     // x^14 : -0xe.8f9a74c8f9b2p-24
    const vf_type erf_i0_c14=-8.6790028598592545031683e-07;
     // x^16 : +0xd.607a6d9a4b188p-26
    const vf_type erf_i0_c16=+1.9933086790287679112542e-07;
     // x^18 : -0x9.f181811440378p-30
    const vf_type erf_i0_c18=-9.2604964296363817853766e-09;
    ...
    // x^1 : +0xa.2f4cde5dbc8a8p-5
    const vf_type erf_i1_c1=+3.1827395850076928285333e-01;
     // x^2 : -0xb.75367a29741cp-5
    const vf_type erf_i1_c2=-3.5805820331336546402667e-01;
     // x^3 : +0xa.659e7855067p-6
    const vf_type erf_i1_c3=+1.6245233298477668171245e-01;
     // x^4 : +0xe.528418b3d047p-9
    const vf_type erf_i1_c4=+2.7973297133855150320425e-02;
     // x^5 : -0xf.b2e8af8f913e8p-8
    const vf_type erf_i1_c5=-6.1323683606649283250878e-02;
     // x^6 : +0xf.e8e360901cbbp-10
    const vf_type erf_i1_c6=+1.5536835449918778156997e-02;
     // x^7 : +0x9.d663c2db624c8p-10
    const vf_type erf_i1_c7=+9.6068942719702999505360e-03;
     // x^8 : -0xc.5a1e22336944p-11
    const vf_type erf_i1_c8=-6.0312608897460442958227e-03;
     // x^9 : -0xb.cd84d4a4a38b8p-15
    const vf_type erf_i1_c9=-3.6019311781841769964582e-04;
     // x^10 : +0x9.7293c6aa933cp-13
    const vf_type erf_i1_c10=+1.1532675028597377114847e-03;
     // x^11 : -0xb.988dadc7dfa58p-16
    const vf_type erf_i1_c11=-1.7693957286679171786968e-04;
     // x^12 : -0x9.46fcc5f57b268p-16
    const vf_type erf_i1_c12=-1.4156028006155827445901e-04;
     // x^13 : +0xc.eec9720968dp-18
    const vf_type erf_i1_c13=+4.9334569220435596850760e-05;
     // x^14 : +0xb.40fde2a25c4p-20
    const vf_type erf_i1_c14=+1.0732530576786991974303e-05;
     // x^15 : -0xf.28a73dca219p-21
    const vf_type erf_i1_c15=-7.2282800201030176796141e-06;
     // x^16 : -0xe.9749f6061977p-26
    const vf_type erf_i1_c16=-2.1742243030316116286053e-07;
     // x^ h: +0xe.36d69414f631p-4
    const vf_type erf_i1h=+8.8838823170170777565602e-01;
    // x^ l: -0xd.5bb6a65d1e828p-60
    const vf_type erf_i1l=-1.1586439937397689484181e-17;
    
    vf_type x_i1 = x - (0.75+1.5)*0.5;
    ...
    // x^1 : +0xa.94dcf467ccffp-9
    const vf_type erf_i2_c1=+2.0666985354091942095334e-02;
     // x^2 : -0xa.94dcf467cd6ap-8
    const vf_type erf_i2_c2=-4.1333970708185369113963e-02;
     // x^3 : +0xc.58571d23cb9c8p-8
    const vf_type erf_i2_c3=+4.8222965826239812259235e-02;
     // x^4 : -0x8.d162cbababd5p-8
    const vf_type erf_i2_c4=-3.4444975590005214027833e-02;
     // x^5 : +0xd.673a025ab2c08p-10
    const vf_type erf_i2_c5=+1.3089090722746334408133e-02;
     // x^6 : +0xf.0c9af1df45fap-15
    const vf_type erf_i2_c6=+4.5926633515075356191393e-04;
     // x^7 : -0xd.d7055a2b29f88p-12
    const vf_type erf_i2_c7=-3.3788880416047929917955e-03;
     // x^8 : +0xd.08a1b2aa2c34p-13
    const vf_type erf_i2_c8=+1.5910299455917046446141e-03;
     // x^9 : -0xd.236c52bc0ea38p-18
    const vf_type erf_i2_c9=-5.0118910333958039792900e-05;
     // x^10 : -0x8.9c8ec0bdc097p-15
    const vf_type erf_i2_c10=-2.6280374866695626733665e-04;
     // x^11 : +0xd.99f2a28e95628p-17
    const vf_type erf_i2_c11=+1.0377013066179958087915e-04;
     // x^12 : +0xa.fc8636c43a698p-21
    const vf_type erf_i2_c12=+5.2387346945157644897690e-06;
     // x^13 : -0x8.86cb3ddcb58ep-19
    const vf_type erf_i2_c13=-1.6263081972982184274755e-05;
     // x^14 : +0x8.375e06c3320c8p-21
    const vf_type erf_i2_c14=+3.9178268810497466606417e-06;
     // x^15 : +0x8.74b8dab232158p-23
    const vf_type erf_i2_c15=+1.0080272737132867245648e-06;
     // x^16 : -0xa.98a23a5ec215p-24
    const vf_type erf_i2_c16=-6.3158425110340828032799e-07;
     // x^ h: +0xf.ecd70a13caf18p-4
    const vf_type erf_i2h=+9.9532226501895271209008e-01;
    // x^ l: +0xc.b9400c825cd18p-59
    const vf_type erf_i2l=+2.2071985832976500466490e-17;
    vf_type x_i2 = x - (1.5+2.5)*0.5;
    ...
    // x^1 : +0x9.20474dd19d38p-16
    const vf_type erf_i3_c1=+1.3925305194680296858034e-04;
     // x^2 : -0xd.b06af4ba6b018p-15
    const vf_type erf_i3_c2=-4.1775915584038608328529e-04;
     // x^3 : +0xc.edba58e826f5p-14
    const vf_type erf_i3_c3=+7.8910062768716465915475e-04;
     // x^4 : -0x8.8e42d8f3f0068p-13
    const vf_type erf_i3_c4=-1.0443978895846612198889e-03;
     // x^5 : +0x8.53daaa4be28a8p-13
    const vf_type erf_i3_c5=+1.0165472798429654472524e-03;
     // x^6 : -0xc.1791adaedad68p-14
    const vf_type erf_i3_c6=-7.3804117594782547243787e-04;
     // x^7 : +0xc.cc5a3560fdf88p-15
    const vf_type erf_i3_c7=+3.9057163917982558884803e-04;
     // x^8 : -0x8.d52f0439df85p-16
    const vf_type erf_i3_c8=-1.3477704872099537840649e-04;
     // x^9 : +0xe.9528ae4f733f8p-20
    const vf_type erf_i3_c9=+1.3907100669163827185294e-05;
     // x^10 : +0x8.2ff5260889708p-19
    const vf_type erf_i3_c10=+1.5616101112908286225331e-05;
     // x^11 : -0xb.51d414d490528p-20
    const vf_type erf_i3_c11=-1.0795252184739591883055e-05;
     // x^12 : +0xc.b721122573698p-22
    const vf_type erf_i3_c12=+3.0315752915483400760225e-06;
     // x^13 : +0x8.c0dc197afab28p-26
    const vf_type erf_i3_c13=+1.3043520528589510538239e-07;
     // x^14 : -0xf.4b3032c897b6p-25
    const vf_type erf_i3_c14=-4.5578790303502523285635e-07;
     // x^15 : +0xa.0ae108a53be2p-26
    const vf_type erf_i3_c15=+1.4964485530328363190158e-07;
     // x^16 : -0xb.67b9d0203ca98p-32
    const vf_type erf_i3_c16=-2.6554751748331888218524e-09;
     // x^ h: +0xf.ffe8d6209afc8p-4
    const vf_type erf_i3h=+9.9997790950300136092466e-01;
    // x^ l: +0xf.757d0f66b6778p-58
    const vf_type erf_i3l=+5.3633970586362691881093e-17;
    vf_type x_i3 = x - (2.5+3.5)*0.5;
    ...
    // x^1 : +0x8.858a44ccad498p-26
    const vf_type erf_i4_c1=+1.2698234712573177724800e-07;
     // x^2 : -0x8.858a454c50a1p-24
    const vf_type erf_i4_c2=-5.0792939027426093713590e-07;
     // x^3 : +0xb.01d292399714p-23
    const vf_type erf_i4_c3=+1.3121508731114880620889e-06;
     // x^4 : -0xa.4c0703149c82p-22
    const vf_type erf_i4_c4=-2.4549918163147754014740e-06;
     // x^5 : +0xe.d2f8d5255634p-22
    const vf_type erf_i4_c5=+3.5343430958199434897566e-06;
     // x^6 : -0x8.828350ae232f8p-21
    const vf_type erf_i4_c6=-4.0577965785423768021989e-06;
     // x^7 : +0xf.ebe0578c2a628p-22
    const vf_type erf_i4_c7=+3.7959556429359756208176e-06;
     // x^8 : -0xc.462dd7b91c14p-22
    const vf_type erf_i4_c8=-2.9263823040975678422149e-06;
     // x^9 : +0xf.a12f0dd92f8c8p-23
    const vf_type erf_i4_c9=+1.8631964014189022374419e-06;
     // x^10 : -0x8.2456d83a98f08p-23
    const vf_type erf_i4_c10=-9.7059609223674791319474e-07;
     // x^11 : +0xd.7451924f78228p-25
    const vf_type erf_i4_c11=+4.0097146280691273476248e-07;
     // x^12 : -0x8.03ae19929e888p-26
    const vf_type erf_i4_c12=-1.1942349826619704762888e-07;
     // x^13 : +0x8.c2ada8befb0dp-29
    const vf_type erf_i4_c13=+1.6317632661302176146364e-08;
     // x^14 : +0xc.2821afe1d489p-31
    const vf_type erf_i4_c14=+5.6609343846477999417251e-09;
     // x^15 : -0x8.0504a0e3173f8p-31
    const vf_type erf_i4_c15=-3.7344181327024074957649e-09;
     // x^16 : +0xb.e0eecc2ebd16p-34
    const vf_type erf_i4_c16=+6.9142806821191866452000e-10;
     // x^ h: +0xf.fffffbdc88bbp-4
    const vf_type erf_i4h=+9.9999998458274208523733e-01;
    // x^ l: +0x8.59432b0aedap-59
    const vf_type erf_i4l=+1.4482653192002498740509e-17;
    vf_type x_i4 = x - 4.0;
    ...
    y_i4 += erf_i4l;
    y_i4 += erf_i4h;
   // coefficients for erf_i5 generated by sollya
    // x^1 : +0x9.b855c1972d4cp-41
    const vf_type erf_i5_c1=+4.4201708696916187409189e-12;
     // x^2 : -0xc.742de0b641e6p-39
    const vf_type erf_i5_c2=-2.2653375780252378921915e-11;
     // x^3 : +0xa.6f65662439efp-37
    const vf_type erf_i5_c3=+7.5925643437976199914944e-11;
     // x^4 : -0xc.d9e29542cb688p-36
    const vf_type erf_i5_c4=-1.8700831617711836148225e-10;
     // x^5 : +0xc.63c6e33fb8258p-35
    const vf_type erf_i5_c5=+3.6058928629280271170879e-10;
     // x^6 : -0x9.b9e81666577a8p-34
    const vf_type erf_i5_c6=-5.6613921328639681205202e-10;
     // x^7 : +0xc.c464c507bb478p-34
    const vf_type erf_i5_c7=+7.4314667277628409127878e-10;
     // x^8 : -0xe.461b2da1d4b48p-34
    const vf_type erf_i5_c8=-8.3084754920523207183264e-10;
     // x^9 : +0xd.c4ad80a2a35fp-34
    const vf_type erf_i5_c9=+8.0141893342192594230381e-10;
     // x^10 : -0xb.8a3b51c7d6448p-34
    const vf_type erf_i5_c10=-6.7171452351956905452692e-10;
     // x^11 : +0x8.636b6ddd7864p-34
    const vf_type erf_i5_c11=+4.8826669743872683615563e-10;
     // x^12 : -0xa.6355b8ad42dc8p-35
    const vf_type erf_i5_c12=-3.0233136944779726175119e-10;
     // x^13 : +0xa.7fbfdb78e70ap-36
    const vf_type erf_i5_c13=+1.5278086736038602760902e-10;
     // x^14 : -0x8.0323f41792p-37
    const vf_type erf_i5_c14=-5.8296917680406504411151e-11;
     // x^15 : +0x8.0e7360c6b9d48p-39
    const vf_type erf_i5_c15=+1.4654593595073610872443e-11;
     // x^16 : -0xf.ba903d8039368p-43
    const vf_type erf_i5_c16=-1.7881533757830184762747e-12;
     // x^ h: +0xf.fffffffff88dp-4
    const vf_type erf_i5h=+9.9999999999957656093841e-01;
    // x^ l: -0x9.f57e65e3745b8p-59
    const vf_type erf_i5l=-1.7276041587662889294547e-17;
    vf_type x_i5 = x - 5.125;
    vf_type y_i5= impl::poly(x_i5,
                             erf_i5_c16,
                             erf_i5_c15,
                             erf_i5_c14,
                             erf_i5_c13,
    ...
    vf_type y = _T::sel(x > 0.75, y_i1, y_i0);
    y = _T::sel(x > 1.5, y_i2, y);
    y = _T::sel(x > 2.5, y_i3, y);
    y = _T::sel(x > 3.5, y_i4, y);
    y = _T::sel(x > 5.0, y_i5, y);

#else
    const vf_type two_o_sqrt_pih=0x1.20dd750429b6dp0;
    vf_type xx= x*x;
    // coefficients for erf_i1 generated by sollya
    // x^0
    const vf_type erf_i1_c0=0x1.4p3;
    // x^2
    const vf_type erf_i1_c2=0x1.30c30c30c30c3p1;
    // x^4
    const vf_type erf_i1_c4=0x1.a9b2fcb5e3c45p-4;
    // x^6
    const vf_type erf_i1_c6=-0x1.3eb69096b1f96p-7;
    // x^8
    const vf_type erf_i1_c8=0x1.dab7ffbb13afp-13;
    // x^10
    const vf_type erf_i1_c10=0x1.27dec9d9167b5p-14;
    // x^12
    const vf_type erf_i1_c12=-0x1.39f3fde898881p-17;
    // x^14
    const vf_type erf_i1_c14=0x1.12a30272475b7p-23;
    // x^16
    const vf_type erf_i1_c16=0x1.9595505e6142ap-24;
    // x^18
    const vf_type erf_i1_c18=-0x1.6dc9e6e4ae8a1p-27;
    // x^20
    const vf_type erf_i1_c20=-0x1.e43be49fb4a96p-35;
    // x^22
    const vf_type erf_i1_c22=0x1.107dd4882d1a4p-33;
    // x^24
    const vf_type erf_i1_c24=-0x1.79a1a3c7a345ap-37;
    vf_type P= impl::poly(xx,
                          erf_i1_c24,
                          erf_i1_c22,
                          erf_i1_c20,
                          ...
                          erf_i1_c2,
                          erf_i1_c0);
    // vf_type y_i0 = x - 1/3.0 * xx*x + xx*xx*x/P;
    vf_type t = xx*-1.0/3.0 + xx*xx/P;
    vf_type y_i0= x+ x*t;
    y_i0 *=  two_o_sqrt_pih;
    vf_type y= y_i0;
#endif
