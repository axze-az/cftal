...
log_k_poly(arg_t<vf_type> z)
{
   // coefficients for log generated by sollya
    // x^14
    const vf_type log_c14=0x1.2b58abb7e2be1p-3;  // 0x3fc2b58abb7e2be1
    // x^12
    const vf_type log_c12=0x1.39fe5b522676ep-3;  // 0x3fc39fe5b522676e
    // x^10
    const vf_type log_c10=0x1.7462b4ab7bf25p-3;  // 0x3fc7462b4ab7bf25
    // x^8
    const vf_type log_c8=0x1.c71c62e684a98p-3;  // 0x3fcc71c62e684a98
    // x^6
    const vf_type log_c6=0x1.2492492deec37p-2;  // 0x3fd2492492deec37
    // x^4
    const vf_type log_c4=0x1.9999999995323p-2;  // 0x3fd9999999995323
    // x^2
    const vf_type log_c2=0x1.5555555555558p-1;  // 0x3fe5555555555558
