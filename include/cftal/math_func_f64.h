...
erfc_k(arg_t<vf_type> xc)
{
    ...
    auto i1=[x, &expmxx]()->vf_type {
        ...
        // x^0 h: +0x9.1e7e178ee3fp-5
        const vf_type erfc_i1_c0h=+2.8497223473743638066935e-01;
        // x^0 l: +0x9.c92f487d105ep-60
        const vf_type erfc_i1_c0l=+8.4878959188779461643202e-18;
        // x^1 : -0x8.61ea9c2232238p-6
        const vf_type erfc_i1_c1=-1.3097634551448519846240e-01;
        // x^2 : +0xe.46867787c087p-8
        const vf_type erfc_i1_c2=+5.5763630087087276421265e-02;
        // x^3 : -0xb.65a97f244ad18p-9
        const vf_type erfc_i1_c3=-2.2259995241389451264835e-02;
        // x^4 : +0x8.9b24508ffee4p-10
        const vf_type erfc_i1_c4=+8.4043192073285505339086e-03;
        // x^5 : -0xc.5fb8b546bfd98p-12
        const vf_type erfc_i1_c5=-3.0209746513918055675629e-03;
        // x^6 : +0x8.835eae0247c18p-13
        const vf_type erfc_i1_c6=+1.0392045224500718724608e-03;
        // x^7 : -0xb.41c4429acc48p-15
        const vf_type erfc_i1_c7=-3.4353335396131948892284e-04;
        // x^8 : +0xe.5a6343d7db08p-17
        const vf_type erfc_i1_c8=+1.0950528842076250914117e-04;
        // x^9 : -0x8.d948841e70838p-18
        const vf_type erfc_i1_c9=-3.3755351096011582373146e-05;
        // x^10 : +0xa.939f9e962b44p-20
        const vf_type erfc_i1_c10=+1.0086683607062109390741e-05;
        // x^11 : -0xc.47df7c5f17278p-22
        const vf_type erfc_i1_c11=-2.9279598887149952664104e-06;
        // x^12 : +0xd.e0805065d81p-24
        const vf_type erfc_i1_c12=+8.2713114721083550091342e-07;
        // x^13 : -0xf.47acd67cbeeb8p-26
        const vf_type erfc_i1_c13=-2.2768946060772795087221e-07;
        // x^14 : +0x8.3796dd8993768p-27
        const vf_type erfc_i1_c14=+6.1222506858540961590706e-08;
        // x^15 : -0x8.b81919d0ae4e8p-29
        const vf_type erfc_i1_c15=-1.6240650803651635965151e-08;
        // x^16 : +0x8.e048c15bb9098p-31
        const vf_type erfc_i1_c16=+4.1332608823966330352708e-09;
        // x^17 : -0xe.49f72bb26c2b8p-34
        const vf_type erfc_i1_c17=-8.3172506276986080821500e-10;
        // x^18 : +0x8.cf2cd5a967b2p-35
        const vf_type erfc_i1_c18=+2.5638372963151126963274e-10;
        // x^19 : -0xf.11418d75e132p-36
        const vf_type erfc_i1_c19=-2.1925962214285355121194e-10;
        // x^20 : +0x9.09b9dcc2d683p-39
        const vf_type erfc_i1_c20=+1.6440012194584879082794e-11;
        // x^21 : +0xc.f6084194645dp-38
        const vf_type erfc_i1_c21=+4.7152074254571291144067e-11;
        // x^ : +0x8p-3
