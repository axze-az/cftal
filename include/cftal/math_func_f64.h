...
exp_k(arg_t<vf_type> xc, bool exp_m1)
{
    ...
    if (exp_m1 == false) {
        ...
        // x^0 : +0x8p-3
        const vf_type expn_c0=+1.0000000000000000000000e+00;
        // x^1 : +0x8p-3
        const vf_type expn_c1=+1.0000000000000000000000e+00;
        // x^2 : +0x8p-4
        const vf_type expn_c2=+5.0000000000000000000000e-01;
        // x^3 : +0xa.aaaaaaaaaaaa8p-6
        const vf_type expn_c3=+1.6666666666666665741481e-01;
        // x^4 : +0xa.aaaaaaaaaaacp-8
        const vf_type expn_c4=+4.1666666666666685170384e-02;
        // x^5 : +0x8.888888888961p-10
        const vf_type expn_c5=+8.3333333333340843529502e-03;
        // x^6 : +0xb.60b60b60a81p-13
        const vf_type expn_c6=+1.3888888888873365812238e-03;
        // x^7 : +0xd.00d00cfa88cc8p-16
        const vf_type expn_c7=+1.9841269839039331096715e-04;
        // x^8 : +0xd.00d00d6b5b978p-19
        const vf_type expn_c8=+2.4801587348902822885563e-05;
        // x^9 : +0xb.8ef1e87f8178p-22
        const vf_type expn_c9=+2.7557322326013787452785e-06;
        // x^10 : +0x9.3f26623e02258p-25
        const vf_type expn_c10=+2.7557252167692825528943e-07;
        // x^11 : +0xd.72da4d99cea7p-29
        const vf_type expn_c11=+2.5050050656095725290235e-08;
        // x^12 : +0x8.fc5bcb2f9e01p-32
        const vf_type expn_c12=+2.0921639307947645130620e-09;
        // x^13 : +0xb.675e3ad02de48p-36
        const vf_type expn_c13=+1.6594686285988114700473e-10;
...
exp10_k(arg_t<vf_type> x)
{
    ...
    // x^0
    const vf_type exp10_c0=0x1p0;
    // x^1
    const vf_type exp10_c1=0x1.26bb1bbb55516p1;
    // x^2
    const vf_type exp10_c2=0x1.53524c73cea69p1;
    // x^3
    const vf_type exp10_c3=0x1.0470591de2b0dp1;
    // x^4
    const vf_type exp10_c4=0x1.2bd7609fd96d6p0;
    // x^5
    const vf_type exp10_c5=0x1.1429ffd244385p-1;
    // x^6
    const vf_type exp10_c6=0x1.a7ed70852b69cp-3;
    // x^7
    const vf_type exp10_c7=0x1.16e4de00fa537p-4;
    // x^8
    const vf_type exp10_c8=0x1.4116aea32227dp-6;
    // x^9
    const vf_type exp10_c9=0x1.489efa725a3a8p-8;
    // x^10
    const vf_type exp10_c10=0x1.2ea936b264e4p-10;
    // x^11
    const vf_type exp10_c11=0x1.dda80a85ab60ep-13;
    // x^12
    const vf_type exp10_c12=0x1.7e3ab5adee13dp-15;
    // x^13
    const vf_type exp10_c13=0x1.828fb96427a4ap-13;
#if 1
    // enough to reach faithful rounding:
    using d_ops=cftal::impl::d_real_ops<vf_type, d_real_traits<vf_type>::fma>;
    vf_type y=impl::poly(xr,
    ...
    vf_type o_i;
    y = d_ops::two_prod(y, xr, p_i);
    y = d_ops::two_sum(y, exp10_c0, o_i);
    ye= (p_i + o_i);
    y += ye;
#else
    vf_type y=impl::poly(xr,
...
erf_k(arg_t<vf_type> xc)
{
    ...
    auto i0 = [x]() -> vf_type {
        ...
        */
        ...
        // coefficients for erf_i0 generated by sollya
        // x^0 : +0xcp-2
        const vf_type erf_i0_c0=+3.0000000000000000000000e+00;
        // x^2 : +0xe.6666666666598p-4
        const vf_type erf_i0_c2=+8.9999999999999713562460e-01;
        // x^4 : +0xe.434a9b10516dp-8
        const vf_type erf_i0_c4=+5.5714285714491842971263e-02;
        // x^6 : -0xc.17cbba596735p-11
        const vf_type erf_i0_c6=-5.9047619098922896757609e-03;
        // x^8 : -0x9.120a0f114eefp-17
        const vf_type erf_i0_c8=-6.9202163589402826372396e-05;
        // x^10 : +0xb.ea2205ea168b8p-17
        const vf_type erf_i0_c10=+9.0901044092973510581633e-05;
        // x^12 : -0xe.b0a52e96ab168p-21
        const vf_type erf_i0_c12=-7.0047476182409154158164e-06;
        // x^14 : -0xe.8f547f4a0d9c8p-24
        const vf_type erf_i0_c14=-8.6783665867525240992364e-07;
        // x^16 : +0xd.5f6f1202f58dp-26
        const vf_type erf_i0_c16=+1.9927007778225141583237e-07;
        // x^18 : -0x9.eadd10a552bp-30
        const vf_type erf_i0_c18=-9.2363317353179575431080e-09;
        // x^ h: +0x9.06eba8214db68p-3
        const vf_type two_o_sqrt_pih=+1.1283791670955125585607e+00;
        // x^ l: +0x8.d71d48a7f6cp-59
        const vf_type two_o_sqrt_pil=+1.5335459613165881222168e-17;
    ...
    auto i1 = [x]()-> vf_type {
        ...
        // x^4 : -0xc.9d4d3ddc0a03p-11
        const vf_type erf_i1_c4=-6.1594042304067338905460e-03;
        // x^5 : -0xc.140e7059bab48p-8
        const vf_type erf_i1_c5=-4.7181036404917282844895e-02;
        // x^6 : +0xa.e8001d7c5f228p-9
        const vf_type erf_i1_c6=+2.1301272963851997782614e-02;
        // x^7 : +0xe.da1e4bc07ea9p-12
        const vf_type erf_i1_c7=+3.6259826120212191105652e-03;
        // x^8 : -0xb.ab3967ada562p-11
        const vf_type erf_i1_c8=-5.6976780667407668501401e-03;
        // x^9 : +0xe.61129d51c3d8p-14
        const vf_type erf_i1_c9=+8.7763612580381809846752e-04;
        // x^10 : +0xd.003a9df5369bp-14
        const vf_type erf_i1_c10=+7.9351162260669102881117e-04;
        // x^11 : -0xa.9d8a97f9bc218p-15
        const vf_type erf_i1_c11=-3.2395617740899415202757e-04;
        // x^12 : -0xd.d341f2cebe8e8p-18
        const vf_type erf_i1_c12=-5.2739048171041568726595e-05;
        // x^13 : +0xe.a254936ae73a8p-18
        const vf_type erf_i1_c13=+5.5824672794549489286773e-05;
        // x^14 : -0xc.9f8ab8b373db8p-22
        const vf_type erf_i1_c14=-3.0096079044168759816346e-06;
        // x^15 : -0xd.6a1a51bd9c568p-21
        const vf_type erf_i1_c15=-6.3965149405665549947890e-06;
        // x^16 : +0xb.36ab79b90b67p-23
        const vf_type erf_i1_c16=+1.3367598066539460145783e-06;
        // x^17 : +0x8.12de290e7d44p-24
        const vf_type erf_i1_c17=+4.8123016347502876665721e-07;
        // x^18 : -0xc.46e85782b444p-26
        const vf_type erf_i1_c18=-1.8294129900781109578664e-07;
        // x^ h: +0xe.c432ecc55f008p-4
        const vf_type erf_i1h=+9.2290012825645828531407e-01;
        // x^ l: -0xf.e76257dcba6c8p-58
        const vf_type erf_i1l=-5.5177544298639197110910e-17;
        // x^ : +0xcp-4
    ...
    auto i2 = [x]()->vf_type {
        ...
        // x^1 : +0x8.348c5b1aab09p-11
        const vf_type erf_i2_c1=+4.0064778616702035468622e-03;
        // x^2 : -0x9.be66ac2faadd8p-10
        const vf_type erf_i2_c2=-9.5153849214665211370123e-03;
        // x^3 : +0xe.0f608171b5c58p-10
        const vf_type erf_i2_c3=+1.3730533505101913047119e-02;
        // x^4 : -0xd.72cb0afc9006p-10
        const vf_type erf_i2_c4=-1.3133213563506294929706e-02;
        // x^5 : +0x8.8ed72399e636p-10
        const vf_type erf_i2_c5=+8.3573928336361999469339e-03;
        // x^6 : -0xc.c1593a4e7897p-12
        const vf_type erf_i2_c6=-3.1140790423746156009854e-03;
        // x^7 : +0x8.141f091a9f0fp-16
        const vf_type erf_i2_c7=+1.2326963142549133547674e-04;
        // x^8 : +0x9.bbe2260328fc8p-14
        const vf_type erf_i2_c8=+5.9411129773195771753419e-04;
        // x^9 : -0xb.0f639833a10fp-15
        const vf_type erf_i2_c9=-3.3752787603894159312173e-04;
        // x^10 : +0xe.5742d0b93cca8p-18
        const vf_type erf_i2_c10=+5.4706051906483445983285e-05;
        // x^11 : +0x8.493f2024ddc78p-18
        const vf_type erf_i2_c11=+3.1609037283489916151085e-05;
        // x^12 : -0xa.e7e573c900ba8p-19
        const vf_type erf_i2_c12=-2.0801248386438529253866e-05;
        // x^13 : +0xd.2d5b90f7387dp-22
        const vf_type erf_i2_c13=+3.1416841603360366657412e-06;
        // x^14 : +0xe.158d426351f18p-23
        const vf_type erf_i2_c14=+1.6789658899651918946161e-06;
        // x^15 : -0xf.6708b8a3fcbfp-24
        const vf_type erf_i2_c15=-9.1805915985991983536572e-07;
        // x^16 : +0x9.c3eef65974a2p-27
        const vf_type erf_i2_c16=+7.2757639179881617101355e-08;
        // x^17 : +0xa.698e96874b1fp-27
        const vf_type erf_i2_c17=+7.7577918546229976703399e-08;
        // x^18 : -0xc.a4ef2d76d73cp-29
        const vf_type erf_i2_c18=-2.3551796675594007349455e-08;
        // x^ h: +0xf.fccb079f59938p-4
        const vf_type erf_i2h=+9.9921706178210889515157e-01;
        // x^ l: -0x8.458e5374bfcp-59
        const vf_type erf_i2l=-1.4349117332555681777916e-17;
        // x^ : +0xep-3
    ...
    auto i3= [x]()->vf_type {
        ...
        // x^1 : +0xe.c9b8f18225988p-24
        const vf_type erf_i3_c1=+8.8143219126516983729275e-07;
        // x^2 : -0xd.dd1d62670c398p-22
        const vf_type erf_i3_c2=-3.3053707170798003678531e-06;
        // x^3 : +0x8.5b53d86836858p-20
        const vf_type erf_i3_c3=+7.9696160586923913245671e-06;
        // x^4 : -0xe.837ac30f9ba68p-20
        const vf_type erf_i3_c4=-1.3841239880376223622877e-05;
        // x^5 : +0x9.a1b5e607fea78p-19
        const vf_type erf_i3_c5=+1.8370975116252960356164e-05;
        // x^6 : -0xa.1abdaa2b30eb8p-19
        const vf_type erf_i3_c6=-1.9272721393544453436430e-05;
        // x^7 : +0x8.886f15db7a8ap-19
        const vf_type erf_i3_c7=+1.6275301033754038565644e-05;
        // x^8 : -0xb.ab3601a930558p-20
        const vf_type erf_i3_c8=-1.1128228019338949256515e-05;
        // x^9 : +0xc.cfb000e084f58p-21
        const vf_type erf_i3_c9=+6.1088940377950619079156e-06;
        // x^10 : -0xa.eb4720eda752p-22
        const vf_type erf_i3_c10=-2.6033053604853415003264e-06;
        // x^11 : +0xd.01d4bd2b771cp-24
        const vf_type erf_i3_c11=+7.7528669766659495660296e-07;
        // x^12 : -0xc.1a0f2492a62dp-27
        const vf_type erf_i3_c12=-9.0165388299134071023295e-08;
        // x^13 : -0xf.58087c775a218p-28
        const vf_type erf_i3_c13=-5.7160405401428313114925e-08;
        // x^14 : +0xb.71b6534b7c56p-28
        const vf_type erf_i3_c14=+4.2632923701294781669447e-08;
        // x^15 : -0xf.90274c6b7c71p-30
        const vf_type erf_i3_c15=-1.4494266032942103315440e-08;
        // x^16 : +0xe.254e94892ba38p-33
        const vf_type erf_i3_c16=+1.6467797440676704374206e-09;
        // x^17 : +0x9.70d1ec34688ap-33
        const vf_type erf_i3_c17=+1.0990424973206246138621e-09;
        // x^18 : -0x8.753575ef185ep-34
        const vf_type erf_i3_c18=-4.9231148995647887244741e-10;
        // x^ h: +0xf.ffffe178b8f18p-4
        const vf_type erf_i3h=+9.9999988627274338792716e-01;
        // x^ l: +0xc.2f6e81cafa3a8p-58
        const vf_type erf_i3l=+4.2276182391829614767387e-17;
        // x^ : +0xcp-2
    ...
    auto i4= [x]()->vf_type {
        ...
        // x^1 : +0x8.9d7a788783bcp-39
        const vf_type erf_i4_c1=+1.5670866571554045833639e-11;
        // x^2 : -0xa.c4d915ee9f308p-37
        const vf_type erf_i4_c2=-7.8354332541367169593427e-11;
        // x^3 : +0x8.cb6d024b2528p-35
        const vf_type erf_i4_c3=+2.5595748141388157782303e-10;
        // x^4 : -0xa.8b69e71842c6p-34
        const vf_type erf_i4_c4=-6.1377561052639335106084e-10;
        // x^5 : +0x9.e28ea15aa351p-33
        const vf_type erf_i4_c5=+1.1507641600326142707998e-09;
        // x^6 : -0xf.11ac3acc9ad78p-33
        const vf_type erf_i4_c6=-1.7542664737471409691400e-09;
        // x^7 : +0x9.9638649df2e58p-32
        const vf_type erf_i4_c7=+2.2321003464579818906119e-09;
        // x^8 : -0xa.5e745cb464958p-32
        const vf_type erf_i4_c8=-2.4142123398276897600168e-09;
        // x^9 : +0x9.a8371db08b088p-32
        const vf_type erf_i4_c9=+2.2484667140612796021211e-09;
        // x^10 : -0xf.a0a7c14ce78a8p-33
        const vf_type erf_i4_c10=-1.8192873964290592580846e-09;
        // x^11 : +0xb.0b9543405085p-33
        const vf_type erf_i4_c11=+1.2858359047742450763565e-09;
        // x^12 : -0xd.aba07fce81cbp-34
        const vf_type erf_i4_c12=-7.9572304234147567096586e-10;
        // x^13 : +0xe.cf649cc45935p-35
        const vf_type erf_i4_c13=+4.3103148267100257913636e-10;
        // x^14 : -0xd.fc8c3862297c8p-36
        const vf_type erf_i4_c14=-2.0353057467122550727188e-10;
        // x^15 : +0xb.4f496ceec0e18p-37
        const vf_type erf_i4_c15=+8.2289000671097277892720e-11;
        // x^16 : -0xe.c8e4d0595478p-39
        const vf_type erf_i4_c16=-2.6893287981640450101686e-11;
        // x^17 : +0xd.9b749160d0678p-41
        const vf_type erf_i4_c17=+6.1878597238073902309437e-12;
        // x^18 : -0xc.b98b3a290009p-44
        const vf_type erf_i4_c18=-7.2332003857668342089301e-13;
        // x^ h: +0xf.ffffffffe4f4p-4
        const vf_type erf_i4h=+9.9999999999846256315550e-01;
        // x^ l: -0xd.3acfbb9c49af8p-59
        const vf_type erf_i4l=-2.2949927118073010783255e-17;
        // x^ : +0x9p-1
    ...
    // x^ : +0x9p-1
    const vf_type erf_i4_left=+4.5000000000000000000000e+00;
    vf_type y= select_branch(x < erf_i4_left, s23, i4);
...
erfc_k(arg_t<vf_type> xc)
{
    vf_type x=abs(xc);
    auto i0=[x]()->vf_type {
        // [0, 0.47705078125] : | p - f | <= 2^-58.84375
        // coefficients for erf_i0 generated by sollya
        // x^0 : +0x8p-3
        const vf_type erf_i0_c0=+1.0000000000000000000000e+00;
        // x^2 : -0xa.aaaaaaaaaaa3p-5
        const vf_type erf_i0_c2=-3.3333333333333248216235e-01;
        // x^4 : +0xc.ccccccccbc118p-7
        const vf_type erf_i0_c4=+9.9999999999881114542966e-02;
        // x^6 : -0xc.30c30c242cd88p-9
        const vf_type erf_i0_c6=-2.3809523803800029112532e-02;
        // x^8 : +0x9.7b425a36fb368p-11
        const vf_type erf_i0_c8=+4.6296294957507257497586e-03;
        // x^10 : -0xc.697ee8d4119b8p-14
        const vf_type erf_i0_c10=-7.5757401947482746595169e-04;
        // x^12 : +0xe.006ebbb48f06p-17
        const vf_type erf_i0_c12=+1.0682441448139223414901e-04;
        // x^14 : -0xd.cf11dd99f5188p-20
        const vf_type erf_i0_c14=-1.3169161184202727874555e-05;
        // x^16 : +0xb.1014ecb0d2138p-23
        const vf_type erf_i0_c16=+1.3187908272322027016351e-06;
        // x^ h: +0x9.06eba8214db68p-3
        const vf_type two_o_sqrt_pih=+1.1283791670955125585607e+00;
        // x^ l: +0x8.d71d48a7f6cp-59
        const vf_type two_o_sqrt_pil=+1.5335459613165881222168e-17;
        ...
        // using d_ops=cftal::impl::d_real_ops<vf_type,
        // d_real_traits<vf_type>::fma>;
        y_i0 = (dvf_type(two_o_sqrt_pih, two_o_sqrt_pil)*y_i0).h();
#endif        
        return 1-y_i0;
    };
    auto i1=[x]()->vf_type {
        // [-0.75, 0.75] : | p - f | <= 2^-55.109375
        // coefficients for erfc_i1 generated by sollya
        // x^0 : +0x9.de6899d507fep-7
        const vf_type erfc_i1_c0=+7.7099871743541770197083e-02;
        // x^1 : -0xf.23297d6e5b57p-6
        const vf_type erfc_i1_c1=-2.3652112244729067702664e-01;
        // x^2 : +0x9.75f9ee64f9128p-5
        const vf_type erfc_i1_c2=+2.9565140305911291607188e-01;
        // x^3 : -0xa.b8e80e2e2c4dp-6
        const vf_type erfc_i1_c3=-1.6753579506684418420903e-01;
        // x^4 : +0xc.9d4d3ddc73c9p-11
        const vf_type erfc_i1_c4=+6.1594042304537067328285e-03;
        // x^5 : +0xc.140e705a26dep-8
        const vf_type erfc_i1_c5=+4.7181036405301551850400e-02;
        // x^6 : -0xa.e8001d7f68868p-9
        const vf_type erfc_i1_c6=-2.1301272965232920936218e-02;
        // x^7 : -0xe.da1e4c0bbeabp-12
        const vf_type erfc_i1_c7=-3.6259826162986881145645e-03;
        // x^8 : +0xb.ab39684896e3p-11
        const vf_type erfc_i1_c8=+5.6976780843557891381712e-03;
        // x^9 : -0xe.61129bb971c4p-14
        const vf_type erfc_i1_c9=-8.7763612000123312345545e-04;
        // x^10 : -0xd.003ab9c215b38p-14
        const vf_type erfc_i1_c10=-7.9351172374351748150384e-04;
        // x^11 : +0xa.9d8b32e2c9e5p-15
        const vf_type erfc_i1_c11=+3.2395645918930889104598e-04;
        // x^12 : +0xd.d343f168149fp-18
        const vf_type erfc_i1_c12=+5.2739164267805939043630e-05;
        // x^13 : -0xe.a2842c2b7941p-18
        const vf_type erfc_i1_c13=-5.5827443286447973555021e-05;
        // x^14 : +0xc.a151b4c60df18p-22
        const vf_type erfc_i1_c14=+3.0112631289632966340197e-06;
        // x^15 : +0xd.7092e1455ee88p-21
        const vf_type erfc_i1_c15=+6.4085680057524835505031e-06;
        // x^16 : -0xb.4ab4149539388p-23
        const vf_type erfc_i1_c16=-1.3460886846623365090564e-06;
        // x^17 : -0x8.832c89ac04a18p-24
        const vf_type erfc_i1_c17=-5.0737847939766446823164e-07;
        // x^18 : +0xd.a54f41ca202b8p-26
        const vf_type erfc_i1_c18=+2.0333738052396321731767e-07;
        // x^19 : +0xc.5991bc33ee3b8p-29
        const vf_type erfc_i1_c19=+2.3003444061015386553985e-08;
        // x^20 : -0x9.120fc8bc0d568p-29
        const vf_type erfc_i1_c20=-1.6895222191790462147275e-08;
        // x^ : +0x8p-4
        const vf_type erfc_i1_left=+5.0000000000000000000000e-01;
        // x^ : +0xap-3
        const vf_type erfc_i1_x0=+1.2500000000000000000000e+00;
        ...
        y_i1 = d_ops::two_sum(y_i1, erfc_i1_c3, o_i);
        ye= (p_i + o_i);
        y_i1 = d_ops::two_prod(y_i1, xx, p_i);
        y_i1 = d_ops::two_sum(y_i1, erfc_i1_c2, o_i);
        ye= ye*xx+(p_i + o_i);
        y_i1 = d_ops::two_prod(y_i1, xx, p_i);
        y_i1 = d_ops::two_sum(y_i1, erfc_i1_c1, o_i);
        ye= ye*xx + (p_i + o_i);
        y_i1 = d_ops::two_prod(y_i1, xx, p_i);
