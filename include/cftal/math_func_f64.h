...
erf_k(arg_t<vf_type> xc)
{
    ...
    auto i0 = [x]() -> vf_type {
        // [3.4694469519536141888238489627838134765625e-18, 0.75] : | p - f | <= 2^-59.921875
    ...
    auto i1 = [x]()-> vf_type {
        // [0.750000059604644775390625, 1.750000059604644775390625] : | p - f | <= 2^-62
        // coefficients for erf_i1 generated by sollya
        // x^0 h: +0xd.95267b6578f3p-4
        const vf_type erf_i1_c0h=+8.4891365243634875348278e-01;
        // x^0 l: +0x9.e0151cf0f7158p-58
        const vf_type erf_i1_c0l=+3.4261906366199614904459e-17;
        // x^1 : +0xc.e1ffe7f134d8p-5
        const vf_type erf_i1_c1=+4.0258784581387896395199e-01;
        // x^2 : -0xd.141e3c2ee7ef8p-5
        const vf_type erf_i1_c2=-4.0870582346474110257972e-01;
        // x^3 : +0x9.1d54c90128fep-6
        const vf_type erf_i1_c3=+1.4241523389195254178929e-01;
        // x^4 : +0x8.2f5e1592b1d88p-7
        const vf_type erf_i1_c4=+6.3945541890815929542136e-02;
        // x^5 : -0x8.cae1fa9843c9p-7
        const vf_type erf_i1_c5=-6.8691489563688784558693e-02;
        // x^6 : +0xc.aee77bcc376ep-11
        const vf_type erf_i1_c6=+6.1929783492151412038762e-03;
        // x^7 : +0xe.e880dc00dc81p-10
        const vf_type erf_i1_c7=+1.4558804920139060273820e-02;
        // x^8 : -0xa.49040dfddc13p-11
        const vf_type erf_i1_c8=-5.0220791597279986623326e-03;
        // x^9 : -0xd.e8c1e51c4543p-13
        const vf_type erf_i1_c9=-1.6979014407147176822510e-03;
        // x^10 : +0xa.2356c54c7e688p-13
        const vf_type erf_i1_c10=+1.2375540485576772779114e-03;
        // x^11 : +0xc.f3e842bf6bfep-18
        const vf_type erf_i1_c11=+4.9410868711616235489023e-05;
        // x^12 : -0xc.d60bc56162dfp-16
        const vf_type erf_i1_c12=-1.9586360338545537448582e-04;
        // x^13 : +0xc.5f47c68d4a4fp-19
        const vf_type erf_i1_c13=+2.3598077695159544095709e-05;
        // x^14 : +0xb.c22a9f34cc8d8p-19
        const vf_type erf_i1_c14=+2.2427488057274584551349e-05;
        // x^15 : -0xc.5570f561f51bp-21
        const vf_type erf_i1_c15=-5.8811926175691912318860e-06;
        // x^16 : -0x8.e933009b3dd08p-22
        const vf_type erf_i1_c16=-2.1245323382347004852199e-06;
        // x^17 : +0xa.836a576513628p-23
        const vf_type erf_i1_c17=+1.2532879579994971525259e-06;
        // x^18 : -0xc.43c4b1df2cd48p-26
        const vf_type erf_i1_c18=-1.8275857082963558282686e-07;
        // x^ : +0xcp-4
        const vf_type erf_i1_left=+7.5000000000000000000000e-01;
        // x^ : +0x8.1f1f68db636e8p-3
        const vf_type erf_i1_x0=+1.0151966278030422063949e+00;
    ...
    auto i2 = [x]()->vf_type {
        // [1.74999998509883880615234375, 3] : | p - f | <= 2^-59.703125
        // coefficients for erf_i2 generated by sollya
        // x^0 h: +0xf.e4a8890e82d98p-4
        const vf_type erf_i2_c0h=+9.9332479036109189163284e-01;
        // x^0 l: +0xa.fb92513d2ef18p-58
        const vf_type erf_i2_c0l=+3.8103899811184046446949e-17;
        // x^1 : +0xe.958886ad4ddfp-9
        const vf_type erf_i2_c1=+2.8484598579463719925098e-02;
        // x^2 : -0xd.fcad6acf0d018p-8
        const vf_type erf_i2_c2=-5.4636801315655979249808e-02;
        // x^3 : +0xf.74846e428daep-8
        const vf_type erf_i2_c3=+6.0371663016261151168962e-02;
        // x^4 : -0xa.28f9173483128p-8
        const vf_type erf_i2_c4=-3.9687698521913263027816e-02;
        // x^5 : +0xc.a28889fd5f638p-10
        const vf_type erf_i2_c5=+1.2338765547013420473266e-02;
        // x^6 : +0xb.0932f0858cd48p-12
        const vf_type erf_i2_c6=+2.6943197084136794212939e-03;
        // x^7 : -0x9.0a67e4e7662a8p-11
        const vf_type erf_i2_c7=-4.4143788081099826284270e-03;
        // x^8 : +0xc.9c80cac7bfcap-13
        const vf_type erf_i2_c8=+1.5394702406794401675083e-03;
        // x^9 : +0xd.3f90a3195eeb8p-16
        const vf_type erf_i2_c9=+2.0215302638380727609339e-04;
        // x^10 : -0xb.825c3443e35ap-15
        const vf_type erf_i2_c10=-3.5123350292485676533982e-04;
        // x^11 : +0xb.b90398c1d6ee8p-17
        const vf_type erf_i2_c11=+8.9437188197364706214627e-05;
        // x^12 : +0xc.d961c4ba7853p-19
        const vf_type erf_i2_c12=+2.4507805020266289588223e-05;
        // x^13 : -0xa.3f649c1414d98p-19
        const vf_type erf_i2_c13=-1.9545801032841511618186e-05;
        // x^14 : +0xd.a1064f320f06p-23
        const vf_type erf_i2_c14=+1.6247037080712924212648e-06;
        // x^15 : +0xa.d5d96d912f24p-22
        const vf_type erf_i2_c15=+2.5833484978523637046969e-06;
        // x^16 : -0xa.bf3a34ee26b88p-23
        const vf_type erf_i2_c16=-1.2811400788612440567344e-06;
        // x^17 : +0x9.1855a3a347f4p-25
        const vf_type erf_i2_c17=+2.7105381341708441943574e-07;
        // x^18 : -0xc.a1a9fc302f6bp-29
        const vf_type erf_i2_c18=-2.3528002234065985652004e-08;
        // x^ : +0xep-3
        const vf_type erf_i2_left=+1.7500000000000000000000e+00;
        // x^ : +0xf.584de2074fbdp-3
        const vf_type erf_i2_x0=+1.9181172998887334735230e+00;
    ...
    auto i3= [x]()->vf_type {
        // [3.000000007450580596923828125, 4.5] : | p - f | <= 2^-59.296875
        // coefficients for erf_i3 generated by sollya
        // x^0 h: +0xf.fff46b098c0a8p-4
        const vf_type erf_i3_c0h=+9.9998895465319270758897e-01;
        // x^0 l: -0xd.774fb3cfab18p-59
        const vf_type erf_i3_c0l=-2.3359890258115898598053e-17;
        // x^1 : +0x9.6d299f5537a5p-17
        const vf_type erf_i3_c1=+7.1917849405908927185385e-05;
        // x^2 : -0xe.a644dde701a4p-16
        const vf_type erf_i3_c2=-2.2353345221051202675044e-04;
        // x^3 : +0xe.6467657b15d4p-15
        const vf_type erf_i3_c3=+4.3921517041017399743397e-04;
        // x^4 : -0x9.f66c4c7141f98p-14
        const vf_type erf_i3_c4=-6.0806823764292109498614e-04;
        // x^5 : +0xa.3a34e2f286ebp-14
        const vf_type erf_i3_c5=+6.2422909449149732545592e-04;
        // x^6 : -0xf.e10233dd9b208p-15
        const vf_type erf_i3_c6=-4.8458678768956506147450e-04;
        // x^7 : +0x9.3b2b1155b1928p-15
        const vf_type erf_i3_c7=+2.8171160617556013265952e-04;
        // x^8 : -0xf.14d24737c3ce8p-17
        const vf_type erf_i3_c8=-1.1506144402020778317198e-04;
        // x^9 : +0xc.f21761a5419f8p-19
        const vf_type erf_i3_c9=+2.4691904587317887743428e-05;
        // x^10 : +0xa.bc0ef5d583e98p-21
        const vf_type erf_i3_c10=+5.1186577205170371215599e-06;
        // x^11 : -0xe.96e0791bbd12p-21
        const vf_type erf_i3_c11=-6.9567502438404100648887e-06;
        // x^12 : +0xb.fc3fe5a835bcp-22
        const vf_type erf_i3_c12=+2.8575301152083898371861e-06;
        // x^13 : -0xd.ae118d51fc408p-25
        const vf_type erf_i3_c13=-4.0769443877809285464646e-07;
        // x^14 : -0xc.ba3003fb39748p-26
        const vf_type erf_i3_c14=-1.8965147672864319343027e-07;
        // x^15 : +0x9.26ea8612b8e48p-26
        const vf_type erf_i3_c15=+1.3637566638025843066447e-07;
        // x^16 : -0xb.1afde14ed8628p-28
        const vf_type erf_i3_c16=-4.1370974492413841060448e-08;
        // x^17 : +0xe.929a7a655e0c8p-31
        const vf_type erf_i3_c17=+6.7859281082096134859997e-09;
        // x^18 : -0x8.74dd7ce8015p-34
        const vf_type erf_i3_c18=-4.9223335444558573001596e-10;
        // x^ : +0xcp-2
        const vf_type erf_i3_left=+3.0000000000000000000000e+00;
        // x^ : +0xc.6ec61f401a1p-2
        const vf_type erf_i3_x0=+3.1081776507258069841555e+00;
    ...
    auto i4= [x]()->vf_type {
        // [4.500000126659870147705078125, 6.00000011920928955078125] : | p - f | <= 2^-68.9375
        // coefficients for erf_i4 generated by sollya
        // x^0 h: +0xf.fffffff93e8cp-4
        const vf_type erf_i4_c0h=+9.9999999990169197161549e-01;
        // x^0 l: -0xa.44e79cde9e4p-61
        const vf_type erf_i4_c0l=-4.4535378555247768751821e-18;
        // x^1 : +0xf.ce4745f4dc1fp-34
        const vf_type erf_i4_c1=+9.2001719422142504609722e-10;
        // x^2 : -0x9.09c9ad2169a4p-31
        const vf_type erf_i4_c2=-4.2087554866376330479445e-09;
        // x^3 : +0xd.73f5406430888p-30
        const vf_type erf_i4_c3=+1.2529046266660823655770e-08;
        // x^4 : -0xe.a1e8b3822d23p-29
        const vf_type erf_i4_c4=-2.7255075031151902073032e-08;
        // x^5 : +0xc.60f25c9d6a198p-28
        const vf_type erf_i4_c5=+4.6114244115469427489421e-08;
        // x^6 : -0x8.766816999ccfp-27
        const vf_type erf_i4_c6=-6.3050730236846134981840e-08;
        // x^7 : +0x9.964e09f51f7b8p-27
        const vf_type erf_i4_c7=+7.1429671936190268170893e-08;
        // x^8 : -0x9.26894a23fe218p-27
        const vf_type erf_i4_c8=-6.8176778951477103508638e-08;
        // x^9 : +0xe.df7f814184d28p-28
        const vf_type erf_i4_c9=+5.5406389089170495084508e-08;
        // x^10 : -0xa.58daf19b0ea68p-28
        const vf_type erf_i4_c10=-3.8545917037267573506172e-08;
        // x^11 : +0xc.52ea0fb85df1p-29
        const vf_type erf_i4_c11=+2.2955022740432199601890e-08;
        // x^12 : -0xc.7bb31f9f9eafp-30
        const vf_type erf_i4_c12=-1.1625887787109771525346e-08;
        // x^13 : +0xa.98154f1b70d5p-31
        const vf_type erf_i4_c13=+4.9332506720564781078724e-09;
        // x^14 : -0xe.ace25441ea2bp-33
        const vf_type erf_i4_c14=-1.7084330912289736439959e-09;
        // x^15 : +0xf.e76433539dc7p-35
        const vf_type erf_i4_c15=+4.6286361432318734663985e-10;
        // x^16 : -0xc.9789018e1cc98p-37
        const vf_type erf_i4_c16=-9.1618380224058203731664e-11;
        // x^17 : +0xc.e248f4ea6c358p-40
        const vf_type erf_i4_c17=+1.1717862190313654817411e-11;
        // x^18 : -0xc.b673392b21f28p-44
        const vf_type erf_i4_c18=-7.2263308472028781083098e-13;
        // x^ : +0x9p-1
        const vf_type erf_i4_left=+4.5000000000000000000000e+00;
        // x^ : +0x9.26385bb3f2ebp-1
        const vf_type erf_i4_x0=+4.5746487290538961900666e+00;
        ...
        vf_type y_i4= impl::poly(x_i4,
                                 ...
                                 erf_i4_c1);
        vf_type ye;
        impl::eft_poly(y_i4, ye, x_i4, y_i4,
                       erf_i4_c0h);
        y_i4 += ye+erf_i4_c0l;
        return y_i4;
    };
...
#endif
    auto s01=[x, i0, i1]()->vf_type {
        // x^ : +0xf.3b645a1cac08p-5
        const vf_type erfc_i1_left=+4.7599999999999997868372e-01;
