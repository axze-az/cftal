...
exp_k(arg_t<vf_type> xc, bool exp_m1)
{
    ...
    if (exp_m1 == false) {
        ...
        // x^2
        const vf_type expn_c2=-0x1.6c16c16c15e11p-9;
        // x^4
        const vf_type expn_c4=0x1.1566abbae0e1cp-14;
        // x^6
        const vf_type expn_c6=-0x1.bbd75fdbe9f7ap-20;
        // x^8
        const vf_type expn_c8=0x1.668d354b2d1fap-25;
        // x^10
...
erf_k(arg_t<vf_type> xc)
{
   ...
   // coefficients for erf_i0 generated by sollya
    ...
    // x^2
    const vf_type erf_i0_c2=0x1.cccccccccccb3p-1;
    // x^4
    const vf_type erf_i0_c4=0x1.c86953620a2dap-5;
    // x^6
    const vf_type erf_i0_c6=-0x1.82f9774b2ce6ap-8;
    // x^8
    const vf_type erf_i0_c8=-0x1.224141e229dc5p-14;
    // x^10
    const vf_type erf_i0_c10=0x1.7d4440bd42b56p-14;
    // x^12
    const vf_type erf_i0_c12=-0x1.d614a5d2ca5aap-18;
    // x^14
    const vf_type erf_i0_c14=-0x1.d1ea8fea40be4p-21;
    // x^16
    const vf_type erf_i0_c16=0x1.abede245cb479p-23;
    // x^18
    const vf_type erf_i0_c18=-0x1.3d5ba241d7327p-27;
    vf_type xx= xc*xc;
    vf_type P= impl::poly(xx,
                          // erf_i0_c24,
                          // erf_i0_c22,
...
#else
    vf_type z = _T::clear_low_word(x);
    vf_type expzz= exp_k(-z*z, false);
    vf_type exprz= exp_k((z-x)*(z+x), false);
    vf_type exp_mxx= expzz*exprz;
    // coefficients for erf_i0 generated by sollya
    // x^0
    const vf_type erf_i0_c0=0x1p0;
    // x^2
    const vf_type erf_i0_c2=0x1.5555555555555p-1;
    // x^4
    const vf_type erf_i0_c4=0x1.11111111111e8p-2;
    // x^6
    const vf_type erf_i0_c6=0x1.38138137fab34p-4;
    // x^8
    const vf_type erf_i0_c8=0x1.1566abd6cae43p-6;
    // x^10
    const vf_type erf_i0_c10=0x1.937dfa260ed67p-9;
    // x^12
    const vf_type erf_i0_c12=0x1.f0a82f4bb99dcp-12;
    // x^14
    const vf_type erf_i0_c14=0x1.06e4a9f81977ap-14;
    // x^16
    const vf_type erf_i0_c16=0x1.39ed28f3398d5p-17;
    vf_type xx=xc*xc;
    vf_type Q_i0= impl::poly(xx,
                             erf_i0_c16,
                             erf_i0_c14,
                             erf_i0_c12,
                             erf_i0_c10,
    ...
    // x^
    const vf_type two_o_sqrt_pih=0x1.20dd750429b6dp0;
    const vf_type two_o_sqrt_pil=0x1.1ae3a914fed8p-56;
    dvf_type t(two_o_sqrt_pih, two_o_sqrt_pil);
    dvf_type dy=t*x;
    dy *= exp_mxx;
    dy *= Q_i0;
    vf_type y_i0= dy.h();
    // i1..i4: erf(x) = P(x)
    // vf_type y_i0= Q_i0*x*two_o_sqrt_pih*exp_mxx;
#endif
    vf_type y= y_i0;
    y = copysign(y, xc);
    return y;
