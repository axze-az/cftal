...
{
    vf_type x=abs(xc);
    // we use piecewise polynomial approximations here
    // i0: erf(x) = P(x^2)*x
    // coefficients for erf_i0 generated by sollya
    // x^0
    const vf_type erf_i0_c0=0x1.20dd750429b6dp0;
    // x^2
    const vf_type erf_i0_c2=-0x1.812746b03799ep-2;
    // x^4
    const vf_type erf_i0_c4=0x1.ce2f21a03d351p-4;
    // x^6
    const vf_type erf_i0_c6=-0x1.b82ce30f743b1p-6;
    // x^8
    const vf_type erf_i0_c8=0x1.565bcc1fb5746p-8;
    // x^10
    const vf_type erf_i0_c10=-0x1.c02d5ec2cc3bdp-11;
    // x^12
    const vf_type erf_i0_c12=0x1.f990ada6af1b6p-14;
    // x^14
    const vf_type erf_i0_c14=-0x1.f26dcf5355fe5p-17;
    // x^16
    const vf_type erf_i0_c16=0x1.8e0a976f5361dp-20;
