...
erf_k(arg_t<vf_type> xc)
{
    ...
    // x^2
    const vf_type erf_i0_c2=0x1.ccccccccccdc2p-1;
    // x^4
    const vf_type erf_i0_c4=0x1.c8695361c5c9bp-5;
    // x^6
    const vf_type erf_i0_c6=-0x1.82f9771bcb27p-8;
    // x^8
    const vf_type erf_i0_c8=-0x1.2241c109a2f72p-14;
    // x^10
    const vf_type erf_i0_c10=0x1.7d47340ba772dp-14;
    // x^12
    const vf_type erf_i0_c12=-0x1.d6b8092b5244cp-18;
    // x^14
    const vf_type erf_i0_c14=-0x1.c7aaed407c4d1p-21;
    // x^16
    const vf_type erf_i0_c16=0x1.7fb3d3cc5df87p-23;
    vf_type xx= xc*xc;
    vf_type P= impl::poly(xx,
                          // erf_i0_c24,
                          // erf_i0_c22,
