...
erfc_k(arg_t<vf_type> xc)
{
    ...
    auto i0=[x]()->vf_type {
        ...
        // x^0 h: +0x8p-3
        const vf_type erf_i0_c0h=+1.0000000000000000000000e+00;
        // x^0 l: -0x9.ae2f2be7686p-64
        const vf_type erf_i0_c0l=-5.2477593017409855762817e-19;
        // x^1 : -0x9.06eba8214db68p-3
        const vf_type erf_i0_c1=-1.1283791670955125585607e+00;
        // x^3 : +0xc.093a3581bceb8p-5
        const vf_type erf_i0_c3=+3.7612638903183664984553e-01;
        // x^5 : -0xe.71790d0212d2p-7
        const vf_type erf_i0_c5=-1.1283791670952908470227e-01;
        // x^7 : +0xd.c16718939f64p-9
        const vf_type erf_i0_c7=+2.6866170644835901670788e-02;
        // x^9 : -0xa.b2de685e962ap-11
        const vf_type erf_i0_c9=-5.2239776230847585758443e-03;
        // x^11 : +0xe.016d9ca815b6p-14
        const vf_type erf_i0_c11=+8.5483269015305734725430e-04;
        // x^13 : -0xf.cd18d99c748fp-17
        const vf_type erf_i0_c13=-1.2055328698404698252282e-04;
        // x^15 : +0xf.a68ba9d049b4p-20
        const vf_type erf_i0_c15=+1.4925545304642163298332e-05;
        // x^17 : -0xd.ced23900fd048p-23
        const vf_type erf_i0_c17=-1.6460293821570867710144e-06;
        // x^19 : +0xa.f7cec730cce9p-26
        const vf_type erf_i0_c19=+1.6343592007806034236504e-07;
        // x^21 : -0xf.b25a0ee9b7638p-30
        const vf_type erf_i0_c21=-1.4618678651654145542770e-08;
        // x^23 : +0x9.a4d268953f3d8p-33
        const vf_type erf_i0_c23=+1.1226902226143824173085e-09;
        // x^25 : -0xf.bf03bd7c4f51p-38
        const vf_type erf_i0_c25=-5.7284162978569612144041e-11;
        vf_type xx=x*x;
        vf_type y_i0= impl::poly(xx,
                                 erf_i0_c25,
                                 erf_i0_c23,
        ...
        yh = d_ops::two_prod(y_i0, x, yl);
        dvf_type yhl(yh, yl);
        yhl += dvf_type(erf_i0_c0h, erf_i0_c0l);
        y_i0 = yhl.h();
        return y_i0;
    };
