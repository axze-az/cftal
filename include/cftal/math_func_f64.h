...
tanh_k(arg_t<vf_type> xc)
{
    ...
    // [3.4694469519536141888238489627838134765625e-18, 0.5493061542510986328125] : | p - f | <= 2^-54.3125
    // coefficients for tanh generated by sollya
    // x^0 : +0x9.9999999999998p-3
    const vf_type tanh_c0=+1.1999999999999999555911e+00;
    // x^2 : -0xb.b3ee721a4a928p-11
    const vf_type tanh_c2=-5.7142857142811519580161e-03;
    // x^4 : +0x8.5270ac162457p-15
    const vf_type tanh_c4=+2.5396825383084797433247e-04;
    // x^6 : -0xc.cbe5a5269cc8p-20
    const vf_type tanh_c6=-1.2203667503787857641709e-05;
    // x^8 : +0xa.0ba0780146a38p-24
    const vf_type tanh_c8=+5.9875353032973105837938e-07;
    // x^10 : -0xf.d8d481cc71fa8p-29
    const vf_type tanh_c10=-2.9517323896068223168807e-08;
    // x^12 : +0xb.c6d362c81d7d8p-33
    const vf_type tanh_c12=+1.3709840123006521527391e-09;
    vf_type xx= x*x;
