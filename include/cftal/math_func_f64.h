...
#if 0
    vf_type xm1=x-1;
    vf_type sqrtxm1=sqrt(xm1);
    // coefficients for acosh generated by sollya
    // x^1
    const vf_type acosh_c1=0x1.6a09e667f3bcdp0;
    // x^2
    const vf_type acosh_c2=-0x1.e2b7dddfefe93p-4;
    // x^3
    const vf_type acosh_c3=0x1.b27247b02082bp-6;
    // x^4
    const vf_type acosh_c4=-0x1.02995b7689cabp-7;
    // x^5
    const vf_type acosh_c5=0x1.5ffb6885eb4a2p-9;
    // x^6
    const vf_type acosh_c6=-0x1.032fe4b4af135p-10;
    // x^7
    const vf_type acosh_c7=0x1.9213d1ee4413dp-12;
    // x^8
    const vf_type acosh_c8=-0x1.439ad93f7fd33p-13;
    // x^9
    const vf_type acosh_c9=0x1.0bc4a5639dad4p-14;
    // x^10
    const vf_type acosh_c10=-0x1.c46dec20c4e3fp-16;
    // x^11
    const vf_type acosh_c11=0x1.81ad70209082ap-17;
    // x^12
    const vf_type acosh_c12=-0x1.413e70e4e47fep-18;
    // x^13
    const vf_type acosh_c13=0x1.e76d6c3a374c8p-20;
    // x^14
    const vf_type acosh_c14=-0x1.2c667a00e877fp-21;
    // x^15
    const vf_type acosh_c15=0x1.fc0d703df59dfp-24;
    // x^16
    const vf_type acosh_c16=-0x1.a94221376da95p-27;

    vf_type ys=xm1*impl::poly(xm1,
                              acosh_c16,
                              acosh_c15,
                              acosh_c14,
                              acosh_c13,
