...
erf_k(arg_t<vf_type> xc)
{
    ...
    // x^4
    const vf_type erf_i0_c4=0x1.c869536202be3p-5;
    // x^6
    const vf_type erf_i0_c6=-0x1.82f9774538df9p-8;
    // x^8
    const vf_type erf_i0_c8=-0x1.224154fd3acafp-14;
    // x^10
    const vf_type erf_i0_c10=0x1.7d44cf9b47935p-14;
    // x^12
    const vf_type erf_i0_c12=-0x1.d63e4dc6364e6p-18;
    // x^14
    const vf_type erf_i0_c14=-0x1.ce1a1b5ad0b78p-21;
    // x^16
    const vf_type erf_i0_c16=0x1.91e246ea9544p-23;
    vf_type xx= xc*xc;
    vf_type P= impl::poly(xx,
                          // erf_i0_c18,
                          erf_i0_c16,
