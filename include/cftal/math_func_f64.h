...
exp2_k(arg_t<vf_type> x)
{
    ...
    // x^10
    const vf_type exp2_p_c10=-0x1.a6710d121b8b4p-31;  // 0xbe0a6710d121b8b4
    // x^9
    const vf_type exp2_p_c9=0x1.6300b84b2499ap-27;  // 0x3e46300b84b2499a
    // x^8
    const vf_type exp2_p_c8=0x1.a5364fc753ecep-24;  // 0x3e7a5364fc753ece
    // x^7
    const vf_type exp2_p_c7=0x1.6360abc13fce1p-20;  // 0x3eb6360abc13fce1
    // x^6
    const vf_type exp2_p_c6=0x1.ffc442b414424p-17;  // 0x3eeffc442b414424
    // x^5
    const vf_type exp2_p_c5=0x1.430930f5189cdp-13;  // 0x3f2430930f5189cd
    // x^4
    const vf_type exp2_p_c4=0x1.5d87fde6f8cafp-10;  // 0x3f55d87fde6f8caf
    // x^3
    const vf_type exp2_p_c3=0x1.3b2ab6fd4da1cp-7;  // 0x3f83b2ab6fd4da1c
    // x^2
    const vf_type exp2_p_c2=0x1.c6b08d7044bd1p-5;  // 0x3fac6b08d7044bd1
    // x^1
    const vf_type exp2_p_c1=0x1.ebfbdff82c60bp-3;  // 0x3fcebfbdff82c60b
    // x^0
    const vf_type exp2_p_c0=0x1.62e42fefa39efp-1;  // 0x3fe62e42fefa39ef

    // coefficients for exp2 generated by sollya
    // x^10
    const vf_type exp2_n_c10=-0x1.87691a2daa93fp-31;  // 0xbe087691a2daa93f
    // x^9
    const vf_type exp2_n_c9=0x1.19ee78e33558bp-28;  // 0x3e319ee78e33558b
    // x^8
    const vf_type exp2_n_c8=0x1.a6f70db1186c7p-24;  // 0x3e7a6f70db1186c7
    // x^7
    const vf_type exp2_n_c7=0x1.62314810be5ddp-20;  // 0x3eb62314810be5dd
    // x^6
    const vf_type exp2_n_c6=0x1.ffc512c9c8c02p-17;  // 0x3eeffc512c9c8c02
    // x^5
    const vf_type exp2_n_c5=0x1.4308f7e30251ap-13;  // 0x3f24308f7e30251a
    // x^4
    const vf_type exp2_n_c4=0x1.5d87fdf36982p-10;  // 0x3f55d87fdf369820
    // x^3
    const vf_type exp2_n_c3=0x1.3b2ab6fa1a419p-7;  // 0x3f83b2ab6fa1a419
    // x^2
    const vf_type exp2_n_c2=0x1.c6b08d7045048p-5;  // 0x3fac6b08d7045048
    // x^1
    const vf_type exp2_n_c1=0x1.ebfbdff82c516p-3;  // 0x3fcebfbdff82c516
    // x^0
    const vf_type exp2_n_c0=0x1.62e42fefa39efp-1;  // 0x3fe62e42fefa39ef

    vf_type yp=impl::poly(xr,
                          exp2_p_c10,
                          exp2_p_c9,
                          exp2_p_c8,
                          exp2_p_c7,
...
asinh_k(arg_t<vf_type> xc)
{
    ...
    // x^17
    const vf_type asinh_i0_c17=0x1.079ab9d373456p-8;  // 0x3f7079ab9d373456
    // x^16
    const vf_type asinh_i0_c16=-0x1.693a922ed70f8p-6;  // 0xbf9693a922ed70f8
    // x^15
    const vf_type asinh_i0_c15=0x1.9f0d1a3b5f908p-5;  // 0x3fa9f0d1a3b5f908
    // x^14
    const vf_type asinh_i0_c14=-0x1.de0cc1fa0015ap-5;  // 0xbfade0cc1fa0015a
    // x^13
    const vf_type asinh_i0_c13=0x1.b5bd7ef906c51p-6;  // 0x3f9b5bd7ef906c51
    // x^12
    const vf_type asinh_i0_c12=0x1.6f48e8b48777p-8;  // 0x3f76f48e8b487770
    // x^11
    const vf_type asinh_i0_c11=0x1.fc7a1f2d14052p-9;  // 0x3f6fc7a1f2d14052
    // x^10
    const vf_type asinh_i0_c10=-0x1.7e7b321b7348cp-6;  // 0xbf97e7b321b7348c
    // x^9
    const vf_type asinh_i0_c9=0x1.849ff8eb1c9efp-13;  // 0x3f2849ff8eb1c9ef
    // x^8
    const vf_type asinh_i0_c8=0x1.f1576a11c2cd1p-6;  // 0x3f9f1576a11c2cd1
    // x^7
    const vf_type asinh_i0_c7=0x1.7d7944963b16bp-19;  // 0x3ec7d7944963b16b
    // x^6
    const vf_type asinh_i0_c6=-0x1.6db75162fdf9fp-5;  // 0xbfa6db75162fdf9f
    // x^5
    const vf_type asinh_i0_c5=0x1.9702b53b5752p-27;  // 0x3e49702b53b57520
    // x^4
    const vf_type asinh_i0_c4=0x1.333333164cd9bp-4;  // 0x3fb333333164cd9b
    // x^3
    const vf_type asinh_i0_c3=0x1.3bb38a1f06727p-37;  // 0x3da3bb38a1f06727
    // x^2
    const vf_type asinh_i0_c2=-0x1.555555555631ap-3;  // 0xbfc555555555631a
    // x^1
    const vf_type asinh_i0_c1=0x1.b36d10f609c43p-52;  // 0x3cbb36d10f609c43
    // x^0
    const vf_type asinh_i0_c0=0x1p0;  // 0x3ff0000000000000

    // coefficients for asinh generated by sollya
    // x^17
    const vf_type asinh_i1_c17=0x1.ebd32b124946dp-14;  // 0x3f1ebd32b124946d
    // x^16
    const vf_type asinh_i1_c16=-0x1.c4b38b1bd73b2p-10;  // 0xbf5c4b38b1bd73b2
    // x^15
    const vf_type asinh_i1_c15=0x1.81a88fd011a4ap-7;  // 0x3f881a88fd011a4a
    // x^14
    const vf_type asinh_i1_c14=-0x1.91009377f4a1dp-5;  // 0xbfa91009377f4a1d
    // x^13
    const vf_type asinh_i1_c13=0x1.19da32c1efa0cp-3;  // 0x3fc19da32c1efa0c
    // x^12
    const vf_type asinh_i1_c12=-0x1.172219c9e6c8cp-2;  // 0xbfd172219c9e6c8c
    // x^11
    const vf_type asinh_i1_c11=0x1.86d7fb6ba1ea4p-2;  // 0x3fd86d7fb6ba1ea4
    // x^10
    const vf_type asinh_i1_c10=-0x1.73f5ea15912b3p-2;  // 0xbfd73f5ea15912b3
    // x^9
    const vf_type asinh_i1_c9=0x1.a83559777ad23p-3;  // 0x3fca83559777ad23
    // x^8
    const vf_type asinh_i1_c8=-0x1.719cbff9c8289p-5;  // 0xbfa719cbff9c8289
    // x^7
    const vf_type asinh_i1_c7=0x1.85b4f16a23334p-9;  // 0x3f685b4f16a23334
    // x^6
    const vf_type asinh_i1_c6=-0x1.d8d28578fee2ep-6;  // 0xbf9d8d28578fee2e
    // x^5
    const vf_type asinh_i1_c5=-0x1.7219fea387af4p-7;  // 0xbf87219fea387af4
    // x^4
    const vf_type asinh_i1_c4=0x1.45c27dfddd9dap-4;  // 0x3fb45c27dfddd9da
    // x^3
    const vf_type asinh_i1_c3=-0x1.38861d8a3b91dp-10;  // 0xbf538861d8a3b91d
    // x^2
    const vf_type asinh_i1_c2=-0x1.54e9a7ad56d21p-3;  // 0xbfc54e9a7ad56d21
    // x^1
    const vf_type asinh_i1_c1=-0x1.63e56b20ab56cp-16;  // 0xbef63e56b20ab56c
    // x^0
    const vf_type asinh_i1_c0=0x1.000010d0afee4p0;  // 0x3ff000010d0afee
    // coefficients for asinh generated by sollya
    // x^17
    const vf_type asinh_i2_c17=0x1.2ce20a2c88f08p-22;  // 0x3e92ce20a2c88f08
    // x^16
    const vf_type asinh_i2_c16=-0x1.157616d543105p-17;  // 0xbee157616d543105
    // x^15
    const vf_type asinh_i2_c15=0x1.e2a9fc0b34ee1p-14;  // 0x3f1e2a9fc0b34ee1
    // x^14
    const vf_type asinh_i2_c14=-0x1.06e577594c145p-10;  // 0xbf506e577594c145
    // x^13
    const vf_type asinh_i2_c13=0x1.918750328c4efp-8;  // 0x3f7918750328c4ef
    // x^12
    const vf_type asinh_i2_c12=-0x1.c7cc84ccde60fp-6;  // 0xbf9c7cc84ccde60f
    // x^11
    const vf_type asinh_i2_c11=0x1.8d852e94a327dp-4;  // 0x3fb8d852e94a327d
    // x^10
    const vf_type asinh_i2_c10=-0x1.0f413275e7c8ap-2;  // 0xbfd0f413275e7c8a
    // x^9
    const vf_type asinh_i2_c9=0x1.23b417b71aa07p-1;  // 0x3fe23b417b71aa07
    // x^8
    const vf_type asinh_i2_c8=-0x1.eca8654614525p-1;  // 0xbfeeca8654614525
    // x^7
    const vf_type asinh_i2_c7=0x1.41543ada4f347p0;  // 0x3ff41543ada4f347
    // x^6
    const vf_type asinh_i2_c6=-0x1.382621af75e64p0;  // 0xbff382621af75e64
    // x^5
    const vf_type asinh_i2_c5=0x1.a53c68f216c65p-1;  // 0x3fea53c68f216c65
    // x^4
    const vf_type asinh_i2_c4=-0x1.6abdb5219ab6bp-2;  // 0xbfd6abdb5219ab6b
    // x^3
    const vf_type asinh_i2_c3=0x1.4da1ef1d109e7p-3;  // 0x3fc4da1ef1d109e7
    // x^2
    const vf_type asinh_i2_c2=-0x1.acc65bca77bacp-3;  // 0xbfcacc65bca77bac
    // x^1
    const vf_type asinh_i2_c1=0x1.c66bbcf390c2cp-8;  // 0x3f7c66bbcf390c2c
    // x^0
    const vf_type asinh_i2_c0=0x1.ffbae90a41cddp-1;  // 0x3feffbae90a41cdd

    vf_type ysi0= x* impl::poly(x,
                                asinh_i0_c17,
                                asinh_i0_c16,
                                asinh_i0_c15,
                                asinh_i0_c14,
    ...
    vf_type ysi2= x* impl::poly(x,
                                ...
                                asinh_i2_c1,
                                asinh_i2_c0);
    vf_type ys= _T::sel(x > 0.525, ysi1, ysi0);
    ys = _T::sel(x > 1.15, ysi2, ys);
#else
