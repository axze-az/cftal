...
erfc_k(arg_t<vf_type> xc)
{
    ...
    // x^0 h: +0x9.de6899d507fep-7
    const vf_type erfc_i1_c0h=+7.7099871743541770197083e-02;
    // x^0 l: -0xb.13176b864608p-65
    const vf_type erfc_i1_c0l=-3.0017698697549566298631e-19;
    // x^1 : -0xf.23297d6e5b59p-6
    const vf_type erfc_i1_c1=-2.3652112244729078804895e-01;
    // x^2 : +0x9.75f9ee64f9178p-5
    const vf_type erfc_i1_c2=+2.9565140305911347118339e-01;
    // x^3 : -0xa.b8e80e2e2b5cp-6
    const vf_type erfc_i1_c3=-1.6753579506683080602158e-01;
    // x^4 : +0xc.9d4d3ddbf9078p-11
    const vf_type erfc_i1_c4=+6.1594042303991921802342e-03;
    // x^5 : +0xc.140e7059a4aep-8
    const vf_type erfc_i1_c5=+4.7181036404839032938341e-02;
    // x^6 : -0xa.e8001d7b93ab8p-9
    const vf_type erfc_i1_c6=-2.1301272963490571615841e-02;
    // x^7 : -0xe.da1e4b8cfab58p-12
    const vf_type erfc_i1_c7=-3.6259826090929057028356e-03;
    // x^8 : +0xb.ab3967611b0e8p-11
    const vf_type erfc_i1_c8=+5.6976780580391380229277e-03;
    // x^9 : -0xe.6112ac94efb7p-14
    const vf_type erfc_i1_c9=-8.7763618132806280568159e-04;
    // x^10 : -0xd.003a7ccf46b88p-14
    const vf_type erfc_i1_c10=-7.9351150201427249081948e-04;
    // x^11 : +0xa.9d8be19e3c0b8p-15
    const vf_type erfc_i1_c11=+3.2395677702534833369494e-04;
    // x^12 : +0xd.d33062f71e7ep-18
    const vf_type erfc_i1_c12=+5.2738025934856756033950e-05;
    // x^13 : -0xe.a296ae389fdb8p-18
    const vf_type erfc_i1_c13=-5.5828520594602475894241e-05;
    // x^14 : +0xc.a5543f2d3f218p-22
    const vf_type erfc_i1_c14=+3.0149976620456378450760e-06;
    // x^15 : +0xd.71e63d0215948p-21
    const vf_type erfc_i1_c15=+6.4110371627106640590927e-06;
    // x^16 : -0xb.5bb83794b0d78p-23
    const vf_type erfc_i1_c16=-1.3540124511793535452565e-06;
    // x^17 : -0x8.92b9801518p-24
    const vf_type erfc_i1_c17=-5.1099914373650343057953e-07;
    // x^18 : +0xe.5661f0e8c2248p-26
    const vf_type erfc_i1_c18=+2.1364438476930692147674e-07;
    // x^19 : +0xd.ba844183a24ep-29
    const vf_type erfc_i1_c19=+2.5571473995422180690620e-08;
    // x^20 : -0xc.838828dd9e85p-29
    const vf_type erfc_i1_c20=-2.3308762127716161193195e-08;
    // x^ : +0x8p-3
