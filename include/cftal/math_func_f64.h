...
native_exp2_k(arg_t<vf_type> x)
{
    ...
    vi_type k = _T::cvt_f_to_i(kf);
    vi2_type k2= _T::vi_to_vi2(k);
    // [-0.5, 0.5] : | p - f | <= 2^-57.421875
    // coefficients for native_exp2 generated by sollya
    // x^0 : +0x8p-3
    const vf_type native_exp2_c0=+1.0000000000000000000000e+00;
    // x^1 : +0xb.17217f7d1cf78p-4
    const vf_type native_exp2_c1=+6.9314718055994528622676e-01;
    // x^2 : +0xf.5fdeffc162d28p-6
    const vf_type native_exp2_c2=+2.4022650695910133245015e-01;
    // x^3 : +0xe.35846b825092p-8
    const vf_type native_exp2_c3=+5.5504108664822277008355e-02;
    // x^4 : +0x9.d955b7dcffd78p-10
    const vf_type native_exp2_c4=+9.6181291075934909756695e-03;
    // x^5 : +0xa.ec3ff3c5047e8p-13
    const vf_type native_exp2_c5=+1.3333558146376150044948e-03;
    // x^6 : +0xa.18489878a653p-16
    const vf_type native_exp2_c6=+1.5403530457778097676955e-04;
    // x^7 : +0xf.fe5fe2e0c2b08p-20
    const vf_type native_exp2_c7=+1.5252733810369291251046e-05;
    // x^8 : +0xb.15fe38d99cc2p-23
    const vf_type native_exp2_c8=+1.3215434993444445722932e-06;
    // x^9 : +0xd.a929cada050a8p-27
    const vf_type native_exp2_c9=+1.0178084635176861451903e-07;
    // x^10 : +0xf.30e0b608212e8p-31
    const vf_type native_exp2_c10=+7.0738274691105693563210e-09;
    // x^11 : +0xf.4a8373cd7995p-35
    const vf_type native_exp2_c11=+4.4502865941444751900323e-10;
    vf_type xx=xr*xr;
    vf_type i=impl::poly(xx,
                         native_exp2_c11,
                         native_exp2_c9,
