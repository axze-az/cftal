...
erfc_k(arg_t<vf_type> xc)
{
    ...
    auto i0=[x]()->vf_type {
        // [0, 0.75] : | p - f | <= 2^-60.90625
        // coefficients for erfc_i0 generated by sollya
        // x^0 h: +0x8p-3
        const vf_type erfc_i0_c0h=+1.0000000000000000000000e+00;
        // x^0 l: -0x8.771836a04c6p-64
        const vf_type erfc_i0_c0l=-4.5890012801637843735179e-19;
        // x^1 : -0x9.06eba8214db68p-3
        const vf_type erfc_i0_c1=-1.1283791670955125585607e+00;
        // x^3 : +0xc.093a3581bce88p-5
        const vf_type erfc_i0_c3=+3.7612638903183631677862e-01;
        // x^5 : -0xe.71790d020fd58p-7
        const vf_type erfc_i0_c5=-1.1283791670950786556471e-01;
        // x^7 : +0xd.c1671892730c8p-9
        const vf_type erfc_i0_c7=+2.6866170644302387465752e-02;
        // x^9 : -0xa.b2de681f8d4ap-11
        const vf_type erfc_i0_c9=-5.2239776159185465076451e-03;
        // x^11 : +0xe.016d8c9069c4p-14
        const vf_type erfc_i0_c11=+8.5483263160900189309155e-04;
        // x^13 : -0xf.cd162d8524b08p-17
        const vf_type erfc_i0_c13=-1.2055297589544856538216e-04;
        // x^15 : +0xf.a63f3d209c1fp-20
        const vf_type erfc_i0_c15=+1.4924433180987206176140e-05;
        // x^17 : -0xd.c904cdaca816p-23
        const vf_type erfc_i0_c17=-1.6433274202714172521999e-06;
        // x^19 : +0xa.ac1e43c47ff38p-26
        const vf_type erfc_i0_c19=+1.5903021101555603772754e-07;
        // x^21 : -0xa.bcb6245c43ap-30
        const vf_type erfc_i0_c21=-9.9997541558542388579118e-09;
        // x^23 : -0xe.89ef803ad9738p-33
        const vf_type erfc_i0_c23=-1.6925403317066860351058e-09;
        // x^25 : +0xc.0c203bec12308p-34
        const vf_type erfc_i0_c25=+7.0124904467308759116599e-10;
        vf_type xx=x*x;
        vf_type y_i0= impl::poly(xx,
                                 erfc_i0_c25,
                                 erfc_i0_c23,
        ...
        yh = d_ops::two_prod(y_i0, x, yl);
        dvf_type yhl(yh, yl);
        yhl += dvf_type(erfc_i0_c0h, erfc_i0_c0l);
        y_i0 = yhl.h();
        return y_i0;
    };
    auto i1=[x, &expmxx]()->vf_type {
        ...
        // x^0 h: +0xf.f55ca93a0ee4p-5
        const vf_type erfc_i1_c0h=+4.9870141079051366617136e-01;
        // x^0 l: +0x8.9c553c6e8dbfp-59
        const vf_type erfc_i1_c0l=+1.4937141105760844047138e-17;
        // x^1 : +0xe.46867787c0868p-8
        const vf_type erfc_i1_c1=+5.5763630087087269482371e-02;
        // x^2 : -0x8.8c3f1f5b37a38p-8
        const vf_type erfc_i1_c2=-3.3389992862082489011311e-02;
        // x^3 : +0x8.9b24508fff31p-9
        const vf_type erfc_i1_c3=+1.6808638414657635362648e-02;
        // x^4 : -0xf.77a6e2992bbe8p-11
        const vf_type erfc_i1_c4=-7.5524366285629725495387e-03;
        // x^5 : +0xc.c50e05032eb2p-12
        const vf_type erfc_i1_c5=+3.1176135673366845574295e-03;
        // x^6 : -0x9.d98bba0ae35ep-13
        const vf_type erfc_i1_c6=-1.2023667371433973891093e-03;
        // x^7 : +0xe.5a6343ee8d1ap-15
        const vf_type erfc_i1_c7=+4.3802115384431188245540e-04;
        // x^8 : -0x9.f471a9425715p-16
        const vf_type erfc_i1_c8=-1.5189909869072040814533e-04;
        // x^9 : +0xd.388781b567508p-18
        const vf_type erfc_i1_c9=+5.0433417006526657007121e-05;
        // x^10 : -0x8.716583555aa28p-19
        const vf_type erfc_i1_c10=-1.6103659087709073306815e-05;
        // x^11 : +0xa.6860ba5aa11p-21
        const vf_type erfc_i1_c11=+4.9627904659820421418709e-06;
        // x^12 : -0xc.6b42b7bcaef3p-23
        const vf_type erfc_i1_c12=-1.4804585911821598161393e-06;
        // x^13 : +0xe.613b20e9c88ap-25
        const vf_type erfc_i1_c13=+4.2855168820426611598414e-07;
        // x^14 : -0x8.184201d510198p-26
        const vf_type erfc_i1_c14=-1.2062128170267253194886e-07;
        // x^15 : +0x8.e03bf0ab4e258p-28
        const vf_type erfc_i1_c15=+3.3065358599851084769007e-08;
        // x^16 : -0x9.82b6f993a903p-30
        const vf_type erfc_i1_c16=-8.8574406463147550375435e-09;
        // x^17 : +0x9.fdb7e723fc2bp-32
        const vf_type erfc_i1_c17=+2.3262313067563340474513e-09;
        // x^18 : -0x9.f5c0072115958p-34
        const vf_type erfc_i1_c18=-5.7974605369588565010020e-10;
        // x^19 : +0x9.67de37ad2cbd8p-36
        const vf_type erfc_i1_c19=+1.3687145139189276967553e-10;
        // x^20 : -0xc.39c4d98cdc3cp-38
        const vf_type erfc_i1_c20=-4.4476691763195989073277e-11;
        // x^21 : +0xe.9aa67f520ec18p-40
        const vf_type erfc_i1_c21=+1.3282354346192546136216e-11;
        // x^22 : +0x9.ec14739abf6bp-45
        const vf_type erfc_i1_c22=+2.8200551771378206697762e-13;
        // x^ : +0x8p-3
        const vf_type erfc_i1_left=+1.0000000000000000000000e+00;
        // x^ : +0xep-3
        const vf_type erfc_i1_x0=+1.7500000000000000000000e+00;
        ...
        d_real_traits<vf_type>::fma>;
        vf_type yh, yl;
        yh = d_ops::two_prod(y_i1, xx, yl);
        dvf_type yd(yh, yl);
        yd += dvf_type(erfc_i1_c0h, erfc_i1_c0l);
        yd /= x;
        if (expmxx.first == false) {
            expmxx.first =true;
            expmxx.second =expxx_k(x, -1.0);
