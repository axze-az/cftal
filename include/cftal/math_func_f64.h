...
exp2_k(arg_t<vf_type> x)
{
    ...
    const vf_type exp2_coeff_1m= 2.31856934466889224533764694635057426630853191686781888947166407888289541006088257e-17;
    const vf_type exp2_coeff_2h= 2.40226506959100721827482516346208285540342330932617187500000000000000000000000000e-01;
    const vf_type exp2_coeff_2m= -9.62125863869370872916081878451716877574988594115472373413666673513944260776042938e-18;
    const vf_type exp2_coeff_3h= 5.55041086648215831189645541599020361900329589843750000000000000000000000000000000e-02;
    const vf_type exp2_coeff_3m= -2.62287435152261980523334974653194916540656059000856739626961200428922893479466438e-18;
    const vf_type exp2_coeff_4h= 9.61812910762848728707385959069142700172960758209228515625000000000000000000000000e-03;
    const vf_type exp2_coeff_5h= 1.33335581464282698117840286755608758539892733097076416015625000000000000000000000e-03;
    const vf_type exp2_coeff_6h= 1.54035303933549590866755596429982233530608937144279479980468750000000000000000000e-04;
    const vf_type exp2_coeff_7h= 1.52527338042944895379502898147272560436249477788805961608886718750000000000000000e-05;
    const vf_type exp2_coeff_8h= 1.32154868222680382683505671825852090250918990932404994964599609375000000000000000e-06;
    const vf_type exp2_coeff_9h= 1.01780858582584302377696343876178897147610769025050103664398193359375000000000000e-07;
    const vf_type exp2_coeff_10h= 7.05489209877843835816586736341647634329632410299382172524929046630859375000000000e-09;
    const vf_type exp2_coeff_11h= 4.44558260296560500429771738175308871954261036307798349298536777496337890625000000e-10;
    const vf_type exp2_coeff_12h= 2.57366738795459712352562988739381084901669538567148265428841114044189453125000000e-11;
    const vf_type exp2_coeff_13h= 1.36524559807336988146079540625330408024074024808669491903856396675109863281250000e-12;
    ...
    vf_type exp2_t_8_0h;
    vf_type exp2_t_9_0h;
    vf_type exp2_t_10_0h;
    vf_type exp2_t_11_0h;
    vf_type exp2_t_12_0h;
    vf_type exp2_t_13_0h;
    vf_type exp2_t_14_0h;
    vf_type exp2_t_15_0h;
    vf_type exp2_t_16_0h;
    vf_type exp2_t_17_0h;
    vf_type exp2_t_18_0h;
    vf_type exp2_t_19_0h;
    vf_type exp2_t_20_0h;
    vf_type exp2_t_21_0h, exp2_t_21_0m;
    vf_type exp2_t_22_0h, exp2_t_22_0m;
    vf_type exp2_t_23_0h, exp2_t_23_0m;
    vf_type exp2_t_24_0h, exp2_t_24_0m;
    vf_type exp2_t_25_0h, exp2_t_25_0m;
 

    exp2_t_1_0h = exp2_coeff_13h;
    exp2_t_2_0h = exp2_t_1_0h * xr;
    exp2_t_3_0h = exp2_coeff_12h + exp2_t_2_0h;
    exp2_t_4_0h = exp2_t_3_0h * xr;
    exp2_t_5_0h = exp2_coeff_11h + exp2_t_4_0h;
    exp2_t_6_0h = exp2_t_5_0h * xr;
    exp2_t_7_0h = exp2_coeff_10h + exp2_t_6_0h;
    exp2_t_8_0h = exp2_t_7_0h * xr;
    exp2_t_9_0h = exp2_coeff_9h + exp2_t_8_0h;
    exp2_t_10_0h = exp2_t_9_0h * xr;
    exp2_t_11_0h = exp2_coeff_8h + exp2_t_10_0h;
    exp2_t_12_0h = exp2_t_11_0h * xr;
    exp2_t_13_0h = exp2_coeff_7h + exp2_t_12_0h;
    exp2_t_14_0h = exp2_t_13_0h * xr;
    exp2_t_15_0h = exp2_coeff_6h + exp2_t_14_0h;
    exp2_t_16_0h = exp2_t_15_0h * xr;
    exp2_t_17_0h = exp2_coeff_5h + exp2_t_16_0h;
    exp2_t_18_0h = exp2_t_17_0h * xr;
    exp2_t_19_0h = exp2_coeff_4h + exp2_t_18_0h;
    exp2_t_20_0h = exp2_t_19_0h * xr;
    d_ops::add212(exp2_t_21_0h, exp2_t_21_0m,
                  exp2_coeff_3h, exp2_coeff_3m, exp2_t_20_0h);
    d_ops::muladd212(exp2_t_22_0h, exp2_t_22_0m,
                     exp2_coeff_2h, exp2_coeff_2m, xr,
                     exp2_t_21_0h, exp2_t_21_0m);
    d_ops::muladd212(exp2_t_23_0h, exp2_t_23_0m,
                     exp2_coeff_1h, exp2_coeff_1m, xr,
                     exp2_t_22_0h, exp2_t_22_0m);
    d_ops::mul122(exp2_t_24_0h, exp2_t_24_0m, xr,
                  exp2_t_23_0h, exp2_t_23_0m);
    d_ops::add122(exp2_t_25_0h, exp2_t_25_0m,
                  exp2_coeff_0h, exp2_t_24_0h, exp2_t_24_0m);
    // *exp2_resh = exp2_t_25_0h; *exp2_resm = exp2_t_25_0m;
    vf_type y= exp2_t_25_0h + exp2_t_25_0m;
#else
