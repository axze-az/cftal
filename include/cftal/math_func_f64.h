...
exp_k(arg_t<vf_type> xc, bool exp_m1)
{
    ...
    if (exp_m1 == false) {
        ...
        // x^2 : -0xb.60b60b60af08p-12
        const vf_type expn_c2=-2.7777777777762205357881e-03;
        // x^4 : +0x8.ab355dd7020bp-17
        const vf_type expn_c4=+6.6137566063787254838288e-05;
        // x^6 : -0xd.debafebff61ap-23
        const vf_type expn_c6=-1.6534377120780800526499e-06;
        // x^8 : +0xb.346983a352a2p-28
        const vf_type expn_c8=+4.1740890663439695153065e-08;
        // x^10 : -0x8.b37eec2345c78p-33
        const vf_type expn_c10=-1.0129478099209464179438e-09;
#if 0
        // x^0
