...
erfc_k(arg_t<vf_type> xc)
{
    ...
    auto i1=[x, &ef]()->vf_type {
        // [0.476000010967254638671875, 1.5] : | p - f | <= 2^-59.25
        // coefficients for erfc_i1 generated by sollya
        // x^0 h: +0x9.3e368a62f1a08p-5
        const vf_type erfc_i1_c0h=+2.8884436634648485986432e-01;
        // x^0 l: +0xa.2cf85a25353dp-60
        const vf_type erfc_i1_c0l=+8.8259820916764364493229e-18;
        // x^1 : -0xa.497216bc69628p-4
        const vf_type erfc_i1_c1=-6.4293106919520737196905e-01;
        // x^2 : +0xf.6e2b221a9e13p-5
        const vf_type erfc_i1_c2=+4.8219830189640544571006e-01;
        // x^3 : -0xd.b742c8fb32b28p-9
        const vf_type erfc_i1_c3=-2.6788794549792344784622e-02;
        // x^4 : -0x9.a4daf550a3528p-6
        const vf_type erfc_i1_c4=-1.5068696934263417497313e-01;
        // x^5 : +0xd.a150c485e5638p-8
        const vf_type erfc_i1_c5=+5.3242729167228435016579e-02;
        // x^6 : +0xd.c23bcb3833f2p-9
        const vf_type erfc_i1_c6=+2.6872509533951829951981e-02;
        // x^7 : -0x9.7057d83f60acp-9
        const vf_type erfc_i1_c7=-1.8435235164078050962289e-02;
        // x^8 : -0x9.6d999b73b8038p-12
        const vf_type erfc_i1_c8=-2.3017883570286587317788e-03;
        // x^9 : +0x8.2082e16f0d2c8p-11
        const vf_type erfc_i1_c9=+3.9682602927145422047617e-03;
        // x^10 : -0xc.311608e4aec28p-16
        const vf_type erfc_i1_c10=-1.8603122670655613765146e-04;
        // x^11 : -0xa.392da2b3ab6ep-14
        const vf_type erfc_i1_c11=-6.2398392293047276122020e-04;
        // x^12 : +0xd.eaaef413ef7bp-17
        const vf_type erfc_i1_c12=+1.0617623960473471559328e-04;
        // x^13 : +0x9.ee323b2851e1p-17
        const vf_type erfc_i1_c13=+7.5763351177328956036552e-05;
        // x^14 : -0xb.9735603863388p-19
        const vf_type erfc_i1_c14=-2.2107426073064742442923e-05;
        // x^15 : -0xf.3874adfb23e4p-21
        const vf_type erfc_i1_c15=-7.2577144573249483265782e-06;
        // x^16 : +0xe.3af12f7ec1ccp-22
        const vf_type erfc_i1_c16=+3.3927542445886815249394e-06;
        // x^17 : +0xe.9eb84eb7ca85p-25
        const vf_type erfc_i1_c17=+4.3570994762009354560984e-07;
        // x^18 : -0xe.a04c39c315a88p-25
        const vf_type erfc_i1_c18=-4.3589362832472252043373e-07;
        // x^19 : +0x8.e53ab18593b5p-27
        const vf_type erfc_i1_c19=+6.6276094622079764399244e-08;
        // x^ : +0xf.3b645a1cac08p-5
        const vf_type erfc_i1_left=+4.7599999999999997868372e-01;
        // x^ : +0xcp-4
        const vf_type erfc_i1_x0=+7.5000000000000000000000e-01;
