 ...
 */
    ...
    // x^20
    const vf_type atan_c20=0x1.200d90b84d32fp-6;  // 0x3f9200d90b84d32f
    // x^18
    const vf_type atan_c18=-0x1.362358fd66f12p-5;  // 0xbfa362358fd66f12
    // x^16
    const vf_type atan_c16=0x1.9c7ec3386482ap-5;  // 0x3fa9c7ec3386482a
    // x^14
    const vf_type atan_c14=-0x1.df1282dfb5b28p-5;  // 0xbfadf1282dfb5b28
    // x^12
    const vf_type atan_c12=0x1.10ed9d11ca4e7p-4;  // 0x3fb10ed9d11ca4e7
    // x^10
    const vf_type atan_c10=-0x1.3b116ccfc6cb5p-4;  // 0xbfb3b116ccfc6cb5
    // x^8
    const vf_type atan_c8=0x1.745d00015b54dp-4;  // 0x3fb745d00015b54d
    // x^6
    const vf_type atan_c6=-0x1.c71c713b8a83bp-4;  // 0xbfbc71c713b8a83b
    // x^4
    const vf_type atan_c4=0x1.24924923bc2acp-3;  // 0x3fc24924923bc2ac
    // x^2
    const vf_type atan_c2=-0x1.99999999989d6p-3;  // 0xbfc99999999989d6
    // x^0
    const vf_type atan_c0=0x1.5555555555554p-2;  // 0x3fd5555555555554
    vf_type t2=t*t;
