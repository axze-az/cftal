...
exp2_k(arg_t<vf_type> x)
{
    ...
    // x^2
    const vf_type exp2_c2=0x1.ebfbdff82c58ep-3;
    // x^3
    const vf_type exp2_c3=0x1.c6b08d704a1c3p-5;
    // x^4
    const vf_type exp2_c4=0x1.3b2ab6fba521bp-7;
    // x^5
    const vf_type exp2_c5=0x1.5d87fe7871e01p-10;
    // x^6
    const vf_type exp2_c6=0x1.430912f6da038p-13;
    // x^7
    const vf_type exp2_c7=0x1.ffcbfd9246437p-17;
    // x^8
    const vf_type exp2_c8=0x1.62c02bf6e346bp-20;
    // x^9
    const vf_type exp2_c9=0x1.b5218a9fc8dd2p-24;
    // x^10
    const vf_type exp2_c10=0x1.e49320a04bc67p-28;
    // x^11
    const vf_type exp2_c11=0x1.f3c43aa4721f9p-32;
    // x^12
    const vf_type exp2_c12=0x1.3cb5c9d9b7faap-35;
    // x^13
    const vf_type exp2_c13=-0x1.673c438f5023cp-37;
    // x^14
    const vf_type exp2_c14=-0x1.a872091a5e9e1p-37;
