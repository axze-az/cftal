...
erf_k(arg_t<vf_type> xc)
{
    ...
    // vf_type e= exp_k(-xx, false);
    vf_type e= expxx_k(x, vf_type(-1.0));
    // coefficients for erfc_i1 generated by sollya
    // x^0
    const vf_type erfc_i1_c0=0x1.23feff878533ap-2;
    // x^1
    const vf_type erfc_i1_c1=0x1.1b5a1b60513dbp-1;
    // x^2
    const vf_type erfc_i1_c2=0x1.5bb84d8a291b1p-4;
    // x^3
    const vf_type erfc_i1_c3=-0x1.835a072689b6bp-4;
    // x^4
    const vf_type erfc_i1_c4=0x1.2e2d59d456f39p-4;
    // x^5
    const vf_type erfc_i1_c5=-0x1.85e09e67472ap-5;
    // x^6
    const vf_type erfc_i1_c6=0x1.ba1411afced5cp-6;
    // x^7
    const vf_type erfc_i1_c7=-0x1.c6689dbc2ad57p-7;
    // x^8
    const vf_type erfc_i1_c8=0x1.af6da44c2ad8dp-8;
    // x^9
    const vf_type erfc_i1_c9=-0x1.7f1f60139daefp-9;
    // x^10
    const vf_type erfc_i1_c10=0x1.411b0f0cf1264p-10;
    // x^11
    const vf_type erfc_i1_c11=-0x1.ff779b1569489p-12;
    // x^12
    const vf_type erfc_i1_c12=0x1.851bc5c38d6f7p-13;
    // x^13
    const vf_type erfc_i1_c13=-0x1.1be81725e1968p-14;
    // x^14
    const vf_type erfc_i1_c14=0x1.8e5c081c9afffp-16;
    // x^15
    const vf_type erfc_i1_c15=-0x1.0ccffc1d7af8ep-17;
    // x^16
    const vf_type erfc_i1_c16=0x1.5bcab8b273329p-19;
    // x^17
    const vf_type erfc_i1_c17=-0x1.abc374b627755p-21;
    // x^18
    const vf_type erfc_i1_c18=0x1.ed236c60111cap-23;
    // x^19
    const vf_type erfc_i1_c19=-0x1.05654cac82fc4p-24;
    // x^20
    const vf_type erfc_i1_c20=0x1.f2626bbdc6d6bp-27;
    // x^21
    const vf_type erfc_i1_c21=-0x1.a105bd2d85d51p-29;
    // x^22
    const vf_type erfc_i1_c22=0x1.2a8240620187fp-31;
    // x^23
    const vf_type erfc_i1_c23=-0x1.63679d5c2602ap-34;
    // x^24
    const vf_type erfc_i1_c24=0x1.54482f5de288cp-37;
    // x^25
    const vf_type erfc_i1_c25=-0x1.f53c5fdec1c36p-41;
    // x^26
    const vf_type erfc_i1_c26=0x1.09a2b88bdb08ep-44;
    // x^27
    const vf_type erfc_i1_c27=-0x1.67be885ccf2cbp-49;
    // x^28
    const vf_type erfc_i1_c28=0x1.d2a7571ac6c79p-55;
    vf_type x_s = x-0.75;
    vf_type y_i1= impl::poly(x_s,
                             erfc_i1_c28,
                             erfc_i1_c27,
                             erfc_i1_c26,
                             erfc_i1_c25,
