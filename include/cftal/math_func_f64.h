...
erf_k(arg_t<vf_type> xc)
{
    ...
    // x^0
    const vf_type erf_i0_c0=0x1.8p1;
    // x^2
    const vf_type erf_i0_c2=0x1.ccccccccccccdp-1;
    // x^4
    const vf_type erf_i0_c4=0x1.c869536202e11p-5;
    // x^6
    const vf_type erf_i0_c6=-0x1.82f9774580846p-8;
    // x^8
    const vf_type erf_i0_c8=-0x1.2241533a3908cp-14;
    // x^10
    const vf_type erf_i0_c10=0x1.7d44b90f5749ap-14;
    // x^12
    const vf_type erf_i0_c12=-0x1.d6344a545c53cp-18;
    // x^14
    const vf_type erf_i0_c14=-0x1.cf556ef41502ep-21;
    // x^16
    const vf_type erf_i0_c16=0x1.9b6db67cf397cp-23;
    // x^18
    const vf_type erf_i0_c18=-0x1.2f89964fe6debp-29;
    // x^20
    const vf_type erf_i0_c20=-0x1.a82d17a715ddp-29;
    // x^22
    const vf_type erf_i0_c22=0x1.7faa83df7d0dap-32;
#if 0
    // coefficients for erf_i0 generated by sollya
    // x^0
    const vf_type erf_i0_c0=0x1.8p1;
    // x^2
    const vf_type erf_i0_c2=0x1.cccccccccccb1p-1;
    // x^4
    const vf_type erf_i0_c4=0x1.c86953620a9c9p-5;
    // x^6
    const vf_type erf_i0_c6=-0x1.82f9774b6fdep-8;
    // x^8
    const vf_type erf_i0_c8=-0x1.224141447b0dp-14;
    // x^10
    const vf_type erf_i0_c10=0x1.7d443d842c0c3p-14;
    // x^12
    const vf_type erf_i0_c12=-0x1.d6140835c017bp-18;
    // x^14
    const vf_type erf_i0_c14=-0x1.d1f34e991f364p-21;
    // x^16
    const vf_type erf_i0_c16=0x1.ac0f4db349631p-23;
    // x^18
    const vf_type erf_i0_c18=-0x1.3e3030228806fp-27;
#endif
    vf_type xx= xc*xc;
    vf_type P= impl::poly(xx,
                          // erf_i0_c26,
    ...
    y_i0 *= two_o_sqrt_pih;
    // coefficients for erf_exp_i1 generated by sollya
    // x^1
    const vf_type erfc_exp_i1_c1=-0x1.0cce17de03971p0;
    // x^2
    const vf_type erfc_exp_i1_c2=-0x1.8c906f513ad9p-1;
    // x^3
    const vf_type erfc_exp_i1_c3=-0x1.678c4574504eap-6;

    vf_type exp_arg= impl::poly(x,
                                // erfc_exp_i1_c10,
                                // erfc_exp_i1_c9,
                                // erfc_exp_i1_c8,
                                // erfc_exp_i1_c7,
                                ...
                                erfc_exp_i1_c2,
                                erfc_exp_i1_c1) * x;
    vf_type e= exp_k(exp_arg, false);
    // coefficients for erf_i1 generated by sollya
    // x^0
    const vf_type erfc_i1_c0=0x1.fffffffdaad46p-1;
    // x^1
    const vf_type erfc_i1_c1=-0x1.40f5d15975c46p-4;
    // x^2
    const vf_type erfc_i1_c2=0x1.20bf3c41b25d7p-3;
    // x^3
    const vf_type erfc_i1_c3=-0x1.77aa12873e3e1p-4;
    // x^4
    const vf_type erfc_i1_c4=0x1.21fa3a423e3acp-5;
    // x^5
    const vf_type erfc_i1_c5=-0x1.b870c6ae7005p-7;
    // x^6
    const vf_type erfc_i1_c6=0x1.6ec171cca28b9p-8;
    // x^7
    const vf_type erfc_i1_c7=-0x1.127a510d757f4p-9;
    // x^8
    const vf_type erfc_i1_c8=0x1.6eda5281c12ecp-11;
    // x^9
    const vf_type erfc_i1_c9=-0x1.d4df892b8c805p-13;
    // x^10
    const vf_type erfc_i1_c10=0x1.225444cdadd61p-14;
    // x^11
    const vf_type erfc_i1_c11=-0x1.51f5bdf9b9f3ap-16;
    // x^12
    const vf_type erfc_i1_c12=0x1.6b2373c0ac598p-18;
    // x^13
    const vf_type erfc_i1_c13=-0x1.668aafe3078a8p-20;
    // x^14
    const vf_type erfc_i1_c14=0x1.41cd74f982e18p-22;
    // x^15
    const vf_type erfc_i1_c15=-0x1.00be7e6da155fp-24;
    // x^16
    const vf_type erfc_i1_c16=0x1.6289875701b6bp-27;
    // x^17
    const vf_type erfc_i1_c17=-0x1.9cee9982e1cb5p-30;
    // x^18
    const vf_type erfc_i1_c18=0x1.8b89a7b675626p-33;
    // x^19
    const vf_type erfc_i1_c19=-0x1.2e98fb08118aep-36;
    // x^20
    const vf_type erfc_i1_c20=0x1.6324354e6d40ap-40;
    // x^21
    const vf_type erfc_i1_c21=-0x1.2bf90dd95dadcp-44;
    // x^22
    const vf_type erfc_i1_c22=0x1.44623b220a2ep-49;
    // x^23
    const vf_type erfc_i1_c23=-0x1.50e8eb2d638dap-55;

    vf_type y_i1= impl::poly(x,
                             erfc_i1_c23,
                             erfc_i1_c22,
                             erfc_i1_c21,
                             erfc_i1_c20,
    ...
    y_i1 *= e;
    y_i1 = 1- y_i1;
    vf_type y = _T::sel(x > 0.8, y_i1, y_i0);
#else
    const vf_type two_o_sqrt_pih=0x1.20dd750429b6dp0;
    vf_type xx= x*x;
    // coefficients for erf_i1 generated by sollya
