...
erf_k(arg_t<vf_type> xc)
{
    ...
    auto i1 = [x]()-> vf_type {
        // [0.7499999701976776123046875, 1.875] : | p - f | <= 2^-63.203125
        // coefficients for erf_i1 generated by sollya
        // x^0 h: +0xd.a00ad92477728p-4
        const vf_type erf_i1_c0h=+8.5157284566181756790826e-01;
        // x^0 l: -0x9.c7d05e23c75ep-59
        const vf_type erf_i1_c0l=-1.6966503183800393821349e-17;
        // x^1 : +0xc.b59ff1c5a53e8p-5
        const vf_type erf_i1_c1=+3.9717099400619543247970e-01;
        // x^2 : -0xc.fcb4a5149d598p-5
        const vf_type erf_i1_c2=-4.0584785692491748276822e-01;
        // x^3 : +0x9.38b3e164ed448p-6
        const vf_type erf_i1_c3=+1.4408585559040812396070e-01;
        // x^4 : +0xf.c9545540af058p-8
        const vf_type erf_i1_c4=+6.1665793241157805526509e-02;
        // x^5 : -0x8.c2586be8c153p-7
        const vf_type erf_i1_c5=-6.8430950822867403493532e-02;
        // x^6 : +0xe.0ef0d8fc39988p-11
        const vf_type erf_i1_c6=+6.8644348353046761093688e-03;
        // x^7 : +0xe.a1c47f051b31p-10
        const vf_type erf_i1_c7=+1.4288969280893574348434e-02;
        // x^8 : -0xa.7d006c49c27ep-11
        const vf_type erf_i1_c8=-5.1212342307007628627868e-03;
        // x^9 : -0xd.3bf0cd5b8ed2p-13
        const vf_type erf_i1_c9=-1.6154959838433425103887e-03;
        // x^10 : +0xa.29b9ba4e70e18p-13
        const vf_type erf_i1_c10=+1.2405993933964777186513e-03;
        // x^11 : +0x8.e07a965a5cfdp-18
        const vf_type erf_i1_c11=+3.3862573753363310190452e-05;
        // x^12 : -0xc.b25970a1c0e8p-16
        const vf_type erf_i1_c12=-1.9373591988537533850612e-04;
        // x^13 : +0xd.76a469f4e74p-19
        const vf_type erf_i1_c13=+2.5679485811071298823061e-05;
        // x^14 : +0xb.6db049f724dc8p-19
        const vf_type erf_i1_c14=+2.1798078929055715119651e-05;
        // x^15 : -0xc.e0361e60019f8p-21
        const vf_type erf_i1_c15=-6.1396721768865281128997e-06;
        // x^16 : -0xe.e3e75548f9cep-23
        const vf_type erf_i1_c16=-1.7750559584688241232683e-06;
        // x^17 : +0xf.0c16fe64b123p-24
        const vf_type erf_i1_c17=+8.9688455202480061184158e-07;
        // x^18 : +0xd.8abef928a3b98p-27
        const vf_type erf_i1_c18=+1.0089558751091775658128e-07;
        // x^19 : -0x8.d5c8e2cccec08p-26
        const vf_type erf_i1_c19=-1.3165319749933049603729e-07;
        // x^20 : +0xf.c9259694375bp-29
        const vf_type erf_i1_c20=+2.9403213039788062823766e-08;
        // x^21 : -0x8.8dc130dd08118p-32
        const vf_type erf_i1_c21=-1.9915702540369057320894e-09;
        // x^ : +0xcp-4
    ...
    auto i2 = [x]()->vf_type {
        // [1.8749999701976776123046875, 3.5] : | p - f | <= 2^-60.921875
        // coefficients for erf_i2 generated by sollya
        // x^0 h: +0xf.ef9818008972p-4
        const vf_type erf_i2_c0h=+9.9599465728587377455483e-01;
        // x^0 l: +0xb.7b269ee421c1p-58
        const vf_type erf_i2_c0l=+3.9832921872853585764164e-17;
        // x^1 : +0x9.3155b4dde94dp-9
        const vf_type erf_i2_c1=+1.7954519585105722934149e-02;
        // x^2 : -0x9.5a5d7781ea4d8p-8
        const vf_type erf_i2_c2=-3.6535112072592933196713e-02;
        // x^3 : +0xb.27ecdcaf65a48p-8
        const vf_type erf_i2_c3=+4.3577960851868775826734e-02;
        // x^4 : -0x8.3b98b4600c8ep-8
        const vf_type erf_i2_c4=-3.2159370457565311651749e-02;
        // x^5 : +0xd.6ac90a7b776a8p-10
        const vf_type erf_i2_c5=+1.3102666153705847321143e-02;
        // x^6 : -0xa.35ae4087076d8p-15
        const vf_type erf_i2_c6=-3.1157501603494363413491e-04;
        // x^7 : -0xc.094716a888acp-12
        const vf_type erf_i2_c7=-2.9385353941810236910737e-03;
        // x^8 : +0xc.cb04c67260e88p-13
        const vf_type erf_i2_c8=+1.5616505875862727540510e-03;
        // x^9 : -0x8.d557da5e35aap-16
        const vf_type erf_i2_c9=-1.3478655670770090056060e-04;
        // x^10 : -0xe.9984bc85ac6ap-16
        const vf_type erf_i2_c10=-2.2277346263050465478145e-04;
        // x^11 : +0xd.b21e6ed7b4e08p-17
        const vf_type erf_i2_c11=+1.0449048515629497763894e-04;
        // x^12 : -0xe.8b735b92f7d9p-23
        const vf_type erf_i2_c12=-1.7338668071011963086388e-06;
        // x^13 : -0xe.c34005727196p-20
        const vf_type erf_i2_c13=-1.4078803670090888082358e-05;
        // x^14 : +0x8.ae8b925c07558p-21
        const vf_type erf_i2_c14=+4.1398130394863672938915e-06;
        // x^15 : +0xd.e4e54282c73fp-24
        const vf_type erf_i2_c15=+8.2815427941388276919120e-07;
        // x^16 : -0xe.8d8e5834cd15p-24
        const vf_type erf_i2_c16=-8.6742360922988234312695e-07;
        // x^17 : +0xe.be8ef81078a78p-26
        const vf_type erf_i2_c17=+2.1970821967473334132270e-07;
        // x^18 : -0x8.6b38ae855dfdp-37
        const vf_type erf_i2_c18=-6.1255076757862468131927e-11;
        // x^19 : -0xe.0b4d540c2a9cp-30
        const vf_type erf_i2_c19=-1.3079632712882658799614e-08;
        // x^20 : +0xd.32c15a17c29d8p-32
        const vf_type erf_i2_c20=+3.0729600266179066649041e-09;
        // x^21 : -0x8.971f8a759043p-35
        const vf_type erf_i2_c21=-2.5001136310382010066768e-10;
        // x^ : +0xfp-3
    ...
    auto i3= [x]()->vf_type {
        // [3.49999989569187164306640625, 6] : | p - f | <= 2^-58.109375
        // coefficients for erf_i3 generated by sollya
        // x^0 h: +0xf.ffff9c4355978p-4
        const vf_type erf_i3_c0h=+9.9999962845081380446999e-01;
        // x^0 l: +0xd.4a49639bba4ap-60
        const vf_type erf_i3_c0l=+1.1527395642820977999871e-17;
        // x^1 : +0xb.9b85c5cfbda18p-22
        const vf_type erf_i3_c1=+2.7674460314342367053505e-06;
        // x^2 : -0xa.6e1242971342p-20
        const vf_type erf_i3_c2=-9.9467908165785047969361e-06;
        // x^3 : +0xc.031f273adcaf8p-19
        const vf_type erf_i3_c3=+2.2911442014211603942489e-05;
        // x^4 : -0x9.eca79f84d438p-18
        const vf_type erf_i3_c4=-3.7858706382135824501656e-05;
        // x^5 : +0xc.7764cd5eeb3ep-18
        const vf_type erf_i3_c5=+4.7555472831567615439249e-05;
        // x^6 : -0xc.4a01a7ce1cb7p-18
        const vf_type erf_i3_c6=-4.6879149477973818135011e-05;
        // x^7 : +0x9.a6d01e6dc9428p-18
        const vf_type erf_i3_c7=+3.6817982260993683282877e-05;
        // x^8 : -0xc.13cd65ab3aef8p-19
        const vf_type erf_i3_c8=-2.3035722468747284787929e-05;
        // x^9 : +0xb.c7c1580339458p-20
        const vf_type erf_i3_c9=+1.1234563772438414360941e-05;
        // x^10 : -0x8.529e6de13bc38p-21
        const vf_type erf_i3_c10=-3.9685868921372437871111e-06;
        // x^11 : +0xc.547eccbddaedp-24
        const vf_type erf_i3_c11=+7.3492883509239629914744e-07;
        // x^12 : +0xc.85eb3685035e8p-26
        const vf_type erf_i3_c12=+1.8660903446450896848152e-07;
        // x^13 : -0xf.8fd09fd789f38p-26
        const vf_type erf_i3_c13=-2.3188854911100228924476e-07;
        // x^14 : +0xf.3ed1811f8d2ep-27
        const vf_type erf_i3_c14=+1.1358696433349989843696e-07;
        // x^15 : -0x9.f61f848ee11b8p-28
        const vf_type erf_i3_c15=-3.7109175412136067665879e-08;
        // x^16 : +0x9.50a940da0e89p-30
        const vf_type erf_i3_c16=+8.6753467105507180924922e-09;
        // x^17 : -0xc.4cc55fc52dcep-33
        const vf_type erf_i3_c17=-1.4318952674274172264290e-09;
        // x^18 : +0xa.9fa74171576f8p-36
        const vf_type erf_i3_c18=+1.5459439409408853389188e-10;
        // x^19 : -0x9.8b003cec4f1e8p-40
        const vf_type erf_i3_c19=-8.6792828199565309341397e-12;
        // x^20 : -0xf.83588a702a738p-50
        const vf_type erf_i3_c20=-1.3778373797452055002072e-14;
        // x^21 : +0xc.1aeccb60fb9e8p-49
        const vf_type erf_i3_c21=+2.1503111640694476616765e-14;
        // x^ : +0xep-2
...
erfc_k(arg_t<vf_type> xc)
{
    ...
    auto i0=[x]()->vf_type {
        ...
        const vf_type erf_i0_c3=+3.7612638903183531757790e-01;
        // x^5 : -0xe.71790d020896p-7
        const vf_type erf_i0_c5=-1.1283791670945636509416e-01;
        // x^7 : +0xd.c167189014758p-9
        const vf_type erf_i0_c7=+2.6866170643224867448096e-02;
        // x^9 : -0xa.b2de67b63691p-11
        const vf_type erf_i0_c9=-5.2239776039429159509853e-03;
        // x^11 : +0xe.016d76ef4a11p-14
        const vf_type erf_i0_c11=+8.5483255292173967489211e-04;
        // x^13 : -0xf.cd1371bbf2558p-17
        const vf_type erf_i0_c13=-1.2055265766965315976916e-04;
        // x^15 : +0xf.a609a2cfb581p-20
        const vf_type erf_i0_c15=+1.4923653157630001249998e-05;
        // x^17 : -0xd.c6d41ecbe4bf8p-23
        const vf_type erf_i0_c17=-1.6423075436226438355598e-06;
        // x^19 : +0xa.a8395922ecd18p-26
        const vf_type erf_i0_c19=+1.5880353844048938806551e-07;
        // x^21 : -0xc.1a4926aa7611p-30
        const vf_type erf_i0_c21=-1.1271497883150963258877e-08;
        vf_type xx= x*x;
        vf_type y_i0=impl::poly(xx,
                                erf_i0_c21,
                                erf_i0_c19,
    ...
    auto s01=[x, i0, i1]()->vf_type {
        ...
        vf_type r=select_branch(x < 0.75, i0, i1);
        return r;
    };
#endif
    vf_type y=i0();
