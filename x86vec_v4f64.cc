...
#if 0
x86vec::v4f64
x86vec::impl::fma(arg<v4f64>::type x, arg<v4f64>::type y, arg<v4f64>::type z)
{
        ...
        v4f64 h= x*y;
        v4f64 l= xh * yh - h + xl * yh + xh * yl + xl * yl;

        v4f64 h2 = h + z;
        v4f64 v = h2 - h;
        v4f64 l2 = (h - (h2 - v)) + (z - v) + l;
        return h2 + l2;
}
#endif
...
x86vec::v4s32 x86vec::ilogbp1(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
...
x86vec::v4s32 x86vec::ilogb(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
	return func_t::ilogb(d);
...
x86vec::v4f64 x86vec::exp(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
	return func_t::exp(d);
...
x86vec::v4f64 x86vec::expm1(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
...
x86vec::v4f64 x86vec::log(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
	return func_t::log(d);
...
x86vec::v4f64 x86vec::pow(arg<v4f64>::type b, arg<v4f64>::type e)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
...
x86vec::v4f64 x86vec::sinh(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
...
x86vec::v4f64 x86vec::cosh(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
...
void x86vec::sincos(arg<v4f64>::type d, v4f64* psin, v4f64* pcos)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
...
x86vec::v4f64 x86vec::cos(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
	return func_t::cos(d);
...
x86vec::v4f64 x86vec::tan(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
	return func_t::tan(d);
...
x86vec::v4f64 x86vec::cot(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
	return func_t::cot(d);
...
void x86vec::native_sincos(arg<v4f64>::type d, 
			   v4f64* psin, v4f64* pcos)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
...
x86vec::v4f64 x86vec::native_cos(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
...
x86vec::v4f64 x86vec::native_tan(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
...
x86vec::v4f64 x86vec::native_cot(arg<v4f64>::type d)
{
	using traits_t=cftal::math::func_traits<v4f64, v4s32>;
	using func_t=cftal::math::func<double, int32_t, traits_t>;
...
namespace math {
	...
	template <typename _T>
	dd<_T> operator+(const dd<_T>& a, const dd<_T>& b);
	template <typename _T>
	dd<_T> operator-(const dd<_T>& a, const dd<_T>& b);
	template <typename _T>
	dd<_T> operator*(const dd<_T>& a, const dd<_T>& b);
...
namespace x86vec {
	...
	std::pair<v4f64, v4f64>
        sincos(arg<v4f64>::type d);
        v4f64 tan(arg<v4f64>::type d);
	v4f64 log(arg<v4f64>::type d);
	v4f64 exp(arg<v4f64>::type d);
	v4f64 pow(arg<v4f64>::type y, arg<v4f64>::type x);
        v4f64 cbrt(arg<v4f64>::type d);
	...
	v4f64 upper(const v4f64& v) {
        ...
        namespace impl {
                ...
                template <>
                struct vec_func_traits<v4f64, v4s32> :
                        public math::func_traits<typename v4f64::element_type,
                ...
                v4f64 pow2i(const v2s64& e);

                v2u64 extract_exp_with_bias(const v4f64& v);
                v4f64 insert_exp(const v4f64& v, v2u64& e);
        }
}


x86vec::v4f64 x86vec::atan2(arg<v4f64>::type x, arg<v4f64>::type y)
{
        return math::func<double, int32_t,
		impl::vec_func_traits<v4f64, v4s32> >::
                atan2(x, y);
}

x86vec::v4f64 x86vec::asin(arg<v4f64>::type d)
{
        return math::func<double, int32_t,
		impl::vec_func_traits<v4f64, v4s32> >::
                asin(d);
...
x86vec::v4f64 x86vec::acos(arg<v4f64>::type d)
{
        return math::func<double, int32_t,
		impl::vec_func_traits<v4f64, v4s32> >::
                acos(d);
...
x86vec::v4f64 x86vec::atan(arg<v4f64>::type d)
{
        return math::func<double, int32_t,
		impl::vec_func_traits<v4f64, v4s32> >::
                atan(d);
...
std::pair<x86vec::v4f64, x86vec::v4f64>
x86vec::sincos(arg<v4f64>::type d)
{
        return math::func<double, int32_t,
		impl::vec_func_traits<v4f64, v4s32> >::
                sincos(d);
...
x86vec::v4f64 x86vec::native_exp(arg<v4f64>::type d)
{
        return math::func<double, int32_t,
		impl::vec_func_traits<v4f64, v4s32> >::
                native_exp(d);
...
#if 0
x86vec::v4f64 x86vec::pow(arg<v4f64>::type x, arg<v4f64>::type y)
{
        return math::func<double, int32_t,
		impl::vec_func_traits<v4f64, v4s32> >::
                pow(x, y);
...
x86vec::v4f64 test_f(x86vec::v4f64 f)
{
        return isnan(f);
}

inline
x86vec::v2u64 x86vec::impl::extract_exp_with_bias(const v4f64& v)
{
        v2u64 r(as<v2u64>(v));
        r &= v_exp_f64_msk::iv();
...
inline
x86vec::v4f64 x86vec::impl::insert_exp(const v4f64& v, v2u64& e)
{
        v2u64 em( e << const_u32<exp_shift_f64>());
        v2u64 e_msk_i= v_exp_f64_msk::iv();
        v4f64 e_msk_f= v_exp_f64_msk::dv();
        em &= e_msk_i;
        v4f64 r(andnot(e_msk_f, v));
        r |= as<v4f64>(em);
        return r;
}

x86vec::v4f64 x86vec::frexp(arg<v4f64>::type v, v2s64* ex)
{
        v4f64 vabs(abs(v));
        const v2s64 zero_int(impl::make_zero_int::v());
        const v4f64 zero_f64(as<v4f64>(zero_int));
        v4f64 is_zero(v == zero_f64);
        v4f64 is_nan(v != v);
        const v2s64 exp_msk_int(v_exp_f64_msk::iv());
        const v4f64 exp_msk_f64(as<v4f64>(exp_msk_int));
        v4f64 is_inf(vabs == exp_msk_f64);
        v4f64 is_inf_nan_zero( is_zero | is_nan | is_inf);

        v2s64 is_inf_nan_zero_int(as<v2s64>(is_inf_nan_zero));
        const v4f64& r_inf_nan_zero=v;
        const v2s64& e_inf_nan_zero=zero_int;

        // denormal handling
        const v4f64 _2_54 = impl::double_power_of_two<54>::dv();
        v4f64 r_denom(v* _2_54);
        ...
        v4f64 r(select(is_inf_nan_zero, r_inf_nan_zero, r_finite));
