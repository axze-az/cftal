...
int main(int argc, char** argv)
{
    ...
    rc &= check_func_1<float, 1, check_sin<float> >(v, ulp, 0, false);
    rc &= check_func_1<float, 2, check_sin<float> >(v, ulp, 0, false);
    rc &= check_func_1<float, 4, check_sin<float> >(v, ulp, 0, false);
    rc &= check_func_1<float, 8, check_sin<float> >(v, ulp, 0, false);
#endif
