...
int main(int argc, char** argv)
{
    ...
    bool rc= check_func_1<double, 1, check_exp<double> >(v, 1, 0, false);
    rc &= check_func_1<double, 2, check_exp<double> >(v, 1, 0, false);
    ...
    rc &= of_fp_func_up_to<
        double, 8, check_exp<double> >::v(d, cmp_ulp<double>(1, us),
                                          0x80000);
    std::cout << "ulps: "
