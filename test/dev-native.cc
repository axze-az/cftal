...
native_log_k(arg_t<vf_type> xc)
{
    ...
    vf_type xmh=xr-1.0;
   // [-0.292893230915069580078125, 0.4142135679721832275390625] : | p - f | <= 2^-63.34375
    ...
    // x^6 : -0xa.aaaaaaaa5817p-6
    const double log_c6=-1.6666666666549317943335e-01;
    // x^7 : +0x9.24924927ac598p-6
    const double log_c7=+1.4285714286842718379056e-01;
    // x^8 : -0x8.00000027e712p-6
    const double log_c8=-1.2500000014516488011651e-01;
    // x^9 : +0xe.38e38cbfa2b7p-7
    const double log_c9=+1.1111111042489138500677e-01;
    // x^10 : -0xc.ccccb8d185ec8p-7
    const double log_c10=-9.9999990695365595372301e-02;
    // x^11 : +0xb.a2e8e446e31ep-7
    const double log_c11=+9.0909110511142310340205e-02;
    // x^12 : -0xa.aaad94243adc8p-7
    const double log_c12=-8.3333680472114660120475e-02;
    // x^13 : +0x9.d89c43f1e4e38p-7
    const double log_c13=+7.6922925163478969579067e-02;
    // x^14 : -0x9.24504f92469c8p-7
    const double log_c14=-7.1420706608979936391712e-02;
    // x^15 : +0x8.88565d530022p-7
    const double log_c15=+6.6660686081378150991128e-02;
    // x^16 : -0x8.0381a1302a408p-7
    const double log_c16=-6.2607005791806016881118e-02;
    // x^17 : +0xf.1b60e76436adp-8
    const double log_c17=+5.9011513225608339117123e-02;
    // x^18 : -0xe.04b50c47b23fp-8
    const double log_c18=-5.4759326456129450710897e-02;
    // x^19 : +0xc.e2834a681701p-8
    const double log_c19=+5.0331311860727381835012e-02;
    // x^20 : -0xd.5601034e8f23p-8
    const double log_c20=-5.2093566233960816869164e-02;
    // x^21 : +0xf.7e25bf7e64f6p-8
    const double log_c21=+6.0518607379339645069294e-02;
    // x^22 : -0xd.b9e9ee93196d8p-8
    const double log_c22=-5.3618069406274414256952e-02;
    // x^23 : +0xb.5083897ed6cbp-9
    const double log_c23=+2.2098646673311593546796e-02;
...
int main_native_log(int argc, char** argv)
{
    ...
    if ((argc > 1) && (std::string(argv[1]) == "--speed")) {
        ...
        mpfr_cache::use(mpfr_log, "log", 0.0);
        std::string test_data_dir = dirname(argv[0]);
        std::string test_data_file=
