...
native_log2_k(arg_t<vf_type> xc)
{
    ...
    vf_type xmh=xr-1.0;
   // [-0.292893230915069580078125, 0.4142135679721832275390625] : | p - f | <= 2^-61.40625
    // coefficients for log generated by sollya
    // x^1 : +0xb.8aa3b295c17fp-3
    const double log_c1=+1.4426950408889633870047e+00;
    // x^2 : -0xb.8aa3b295c17fp-4
    const double log_c2=-7.2134752044448169350233e-01;
    // x^3 : +0xf.6384ee1d027f8p-5
    const double log_c3=+4.8089834696300209904152e-01;
    // x^4 : -0xb.8aa3b295c1dc8p-5
    const double log_c4=-3.6067376022225122733644e-01;
    // x^5 : +0x9.3bb628776587p-5
    const double log_c5=+2.8853900817482347473941e-01;
    // x^6 : -0xf.6384ee1c173cp-6
    const double log_c6=-2.4044917347815775165998e-01;
    // x^7 : +0xd.30bb158b695bp-6
    const double log_c7=+2.0609929183924230455816e-01;
    // x^8 : -0xb.8aa3b310f477p-6
    const double log_c8=-1.8033688055931612614913e-01;
    // x^9 : +0xa.42588ec5ac72p-6
    const double log_c9=+1.6029943411439895317727e-01;
    // x^10 : -0x9.3bb6075cf59cp-6
    const double log_c10=-1.4426947325758887608060e-01;
    // x^11 : +0x8.64d615fb5af18p-6
    const double log_c11=+1.3115455767312686474746e-01;
    // x^12 : -0xf.638f1c88d3908p-7
    const double log_c12=-1.2022580045018262107082e-01;
    // x^13 : +0xe.343182679415p-7
    const double log_c13=+1.1096781604206343296859e-01;
    // x^14 : -0xd.2fc92bed7aee8p-7
    const double log_c14=-1.0302080769448403174682e-01;
    // x^15 : +0xc.52b7493f90b1p-7
    const double log_c15=+9.6274290815136193133483e-02;
    // x^16 : -0xb.985052d4147d8p-7
    const double log_c16=-9.0585747188160967158232e-02;
    // x^17 : +0xa.cdeccf2f9242p-7
    const double log_c17=+8.4409333386377183305882e-02;
    // x^18 : -0x9.ceec25af71618p-7
    const double log_c18=-7.6627272034680379841909e-02;
    // x^19 : +0x9.96dd47334921p-7
    const double log_c19=+7.4916515126980193217676e-02;
    // x^20 : -0xb.221604134895p-7
    const double log_c20=-8.6977722158341791436342e-02;
    // x^21 : +0xb.5ea3c10b5a278p-7
    const double log_c21=+8.8825673351224695983852e-02;
    // x^22 : -0xd.6879a682c632p-8
    const double log_c22=-5.2375414993343111236257e-02;
    // x^23 : +0xb.1650c5f7fc1c8p-10
    const double log_c23=+1.0827314456033675441060e-02;
#if 1
...
#endif
    vf_type lxl;
    horner_comp_quick(lxh, lxl, xmh, lxh, log_c1);
    d_ops::mul122(lxh, lxl, xmh, lxh, lxl);
    vf_type kf= _T::cvt_i_to_f(_T::vi2_odd_to_vi(k));
    // using ctbl=impl::d_real_constants<d_real<double>, double>;
    // d_ops::mul22(lxh, lxl, lxh, lxl, ctbl::m_1_ln2.h(), ctbl::m_1_ln2.l());
