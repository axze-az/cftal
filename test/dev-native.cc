...
{
#if 1
   // [-0.3465735912322998046875, 0.3465735912322998046875] : | p - f | <= 2^-69.25
    // coefficients for native_exp generated by sollya
    // x^0 : +0xcp-1
    const double native_exp_c0=+6.0000000000000000000000e+00;
    // x^1 : -0xcp-3
    const double native_exp_c1=-1.5000000000000000000000e+00;
    // x^2 : +0x9.9999999999988p-7
    const double native_exp_c2=+7.4999999999999969468867e-02;
    // x^3 : +0xc.ccccccccd1fdp-11
    const double native_exp_c3=+6.2500000000023040597208e-03;
    // x^4 : +0xb.b3ee721d4b8bp-18
    const double native_exp_c4=+4.4642857145489402734100e-05;
    // x^5 : -0xe.a0ea0f4dd6ad8p-18
    const double native_exp_c5=-5.5803571582159059349861e-05;
    // x^6 : -0xb.d538374e2976p-21
    const double native_exp_c6=-5.6423611825187021992078e-06;
    // x^7 : +0xe.9063316813ca8p-27
    const double native_exp_c7=+1.0851035688055432035026e-07;
    // x^8 : +0xa.11a70deb9c53p-27
    const double native_exp_c8=+7.5019562970781303103636e-08;
    // x^9 : +0xb.f24010542c048p-31
    const double native_exp_c9=+5.5629247966092658356133e-09;
    // x^10 : -0xc.d88a3c519c3b8p-35
    const double native_exp_c10=-3.7386371137605416062700e-10;
    ...
    vf_type o= horner(xx,
                      ...
                      native_exp_c3,
                      native_exp_c1);
    vf_type p= horner(xrh, e, o, native_exp_c0);
    const double c1 = 1.0;
    const double c2 = 0.5;
    vf_type c3=1.0/p;
    vf_type t= horner(xrh,
                      c3,
                      c2);
    vf_type y, ye;
    horner_comp_quick(y, ye, xrh, t, c1);
    vf_type yee= xrl + xrl * xrh* (y+ye);
    horner_comp_quick_si(y, ye, xrh, y, ye, 1.0);
    ye += yee;
    if (_EXP_M1 == false) {
        y += ye;
    ...
    vf_type P= horner(xx,
                      ...
                      expn_c0);
    vf_type br= xrh- xx*P;
    vf_type t = (xrh*br)/(2.0-br);
    vf_type y, ye;
    d_ops::add12cond(y, ye, xrh, t);
    d_ops::add122cond(y, ye, vf_type(1.0), y, ye);
