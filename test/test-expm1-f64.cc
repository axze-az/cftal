...
int main(int argc, char** argv)
{
    ...
    bool rc= check_func_1<double, 2, check_expm1<double> >(v, 1, 0);
    rc &= check_func_1<double, 4, check_expm1<double> >(v, 1, 0);
    rc &= check_func_1<double, 8, check_expm1<double> >(v, 1, 0);
