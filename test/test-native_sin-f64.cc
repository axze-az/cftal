...
int main(int argc, char** argv)
{
    ...
    if ((argc > 1) && (std::string(argv[1]) == "--speed")) {
        ...
        rc &= check_func_1<double, 1, check_native_sin<double> >(v, ulp,
                                                                 0, false);
        rc &= check_func_1<double, 2, check_native_sin<double> >(v, ulp,
                                                                 0, false);
        rc &= check_func_1<double, 4, check_native_sin<double> >(v, ulp,
                                                                 0, false);
        rc &= check_func_1<double, 8, check_native_sin<double> >(v, ulp,
                                                                 0, false);
    }
    exec_stats st(_N);
    ...
    rc &= of_fp_func_up_to<
        double, _N, check_native_sin<double> >::v(st, dp, speed_only,
    ...
    rc &= of_fp_func_up_to<
        double, _N, check_native_sin<double> >::v(st2, dp2, speed_only,
