...
__half_exp_k(arg_t<vf_type> xrh,
             arg_t<vi_type> k)
{
   // [-0.3465735912322998046875, 0.3465735912322998046875] : | p - f | <= 2^-13.20703125
    // coefficients for exp generated by sollya
    // x^0 : +0xf.ffb49p-4f
    const vf_type exp_f16_c0=+9.9992805719e-01f;
    // x^1 : +0x8.00561p-3f
    const vf_type exp_f16_c1=+1.0001641512e+00f;
    // x^2 : +0x8.14549p-4f
    const vf_type exp_f16_c2=+5.0496345758e-01f;
    // x^3 : +0xa.9a517p-6f
    const vf_type exp_f16_c3=+1.6566883028e-01f;
