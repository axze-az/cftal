                                           ...
                                           arg_t<vf_type> xl)
{
    ...
    dvf_type xr = x - d_ops::mul(kf,ctbl::m_ln2.h()) -
        d_ops::mul(kf, ctbl::m_ln2.l());
    ...
    impl::eft_poly(y, ye, xr.h(), y,
                   exp_c5, exp_c4, exp_c3, exp_c2, exp_c1, exp_c0);
#else
    // vf_type cr = xr.l();
    // vf_type yee= cr + cr*xr.h() + 0.5*cr*xr.h()*xr.h();
    vf_type yee=0.0;
    vf_type y, ye;
    // y = impl::poly(xr.h(), exp_c13, exp_c12, exp_c11, exp_c10, exp_c9,
    //               exp_c8, exp_c7, exp_c6);
    impl::eft_poly(y, ye, xr.h(), exp_c13, exp_c12, exp_c11, exp_c10, exp_c9,
                   exp_c8, exp_c7, exp_c6,
                   exp_c5, exp_c4, exp_c3, exp_c2, exp_c1, exp_c0);
#endif
