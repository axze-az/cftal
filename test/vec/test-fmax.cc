...
int main(int argc, char** argv)
{
    ...
    std::cout << "testing fmax vXf64" << std::endl;
    exec_stats<_N64> d_st;
    bool rd= of_fp_func_2_up_to<
        double, _N64, check_fmax<double> >::v(d_st, d, d,
					      ags._speed_only,
					      ags._mt,
					      cmp_t<double>(),
					      ags._cnt);
    ...
    std::cout << "testing fmax vXf32" << std::endl;
    rc &= rd;
    ...
    bool rf= of_fp_func_2_up_to<
        float, _N32, check_fmax<float> >::v(f_st, f, f,
					    ags._speed_only,
					    ags._mt,
					    cmp_t<float>(),
					    ags._cnt);
    ...
    bool rh= of_fp_func_2_up_to<
        f16_t, _N16, check_fmax<f16_t> >::v(h_st, h, h,
					    ags._speed_only,
					    ags._mt,
					    cmp_t<f16_t>(),
					    ags._cnt);
