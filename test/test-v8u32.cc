...
bool cftal::test::spec_v8u32()
{
    ...
    r &= perm1_v8<uint32_t,  0, 0, 0, 0, 0, 0, 0, 0>();
    r &= perm1_v8<uint32_t,  0, 1, 0, 1, 4, 5, 4, 5>();
    r &= perm1_v8<uint32_t,  2, 3, 2, 3, 6, 7, 6, 7>();
    r &= perm1_v8<uint32_t,  0, -1, 1, -1, 2, -1, 3, -1>();
    ...
    r &= perm2_v8<uint32_t, 0, 1, 2, 3, 8, 9, 10, 11>();
    r &= perm2_v8<uint32_t, 0, 1, 2, 3, 12, 13, 14, 15>();
    r &= perm2_v8<uint32_t, 4, 5, 6, 7, 8, 9, 10, 11>();
    r &= perm2_v8<uint32_t, 4, 5, 6, 7, 12, 13, 14, 15 >();
