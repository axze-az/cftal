...
public class FastMath {
    ...
    */
	...
	d = ddadd2_d2_d2_d2(d, dddiv_d2_d2_d2(new double2(-1, 0), d));
	y = (d.x + d.y) * 0.5;
    ...
    */
	...
	d = ddnormalize_d2_d2(d);
	e = ilogbp1(d.x * 0.7071);
	m = ddscale_d2_d2_d(d, ldexp(1, -e));
    ...
    */
	...
	t = dfadd_f2_f_f2(1, t);
	return df(ldexpf(t.x, q), ldexpf(t.y, q));
    }
	...
	m = dfscale_f2_f2_f(d, ldexpf(1, -e));
