...
double xtan_u1(double d) {
  ...
  if ((q & 1) != 0) x = ddrec_d2_d2(ddnormalize_d2_d2(x));
...
double xexp_u1(double d) { return xexp(d); }
...
double xsinh(double x) {
  ...
  d = ddadd_d2_d2_d2(d, dddiv_d2_d2_d2(dd(-1, 0), d));
  y = (d.x + d.y) * 0.5;
...
double xcosh(double x) {
  ...
  d = ddadd2_d2_d2_d2(d, dddiv_d2_d2_d2(dd(1, 0), d));
...
double xtanh(double x) {
  double y = xfabs(x);
  double2 d = expk2(dd(y, 0));
  double2 e = dddiv_d2_d2_d2(dd(1, 0), d);
  d = dddiv_d2_d2_d2(ddadd_d2_d2_d2(d, ddscale_d2_d2_d(e, -1)), ddadd_d2_d2_d2(d, e));
  y = d.x + d.y;
...
static inline double2 logk2(double2 d) {
  ...
  m = ddscale_d2_d2_d(d, ldexpk(1, -e));
