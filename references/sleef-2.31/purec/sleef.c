...
static inline double2 normalize_d(double2 t) {
  double2 s;
...
static inline double2 scale_d(double2 d, double s) {
  double2 r;
...
static inline double2 add2_ss(double x, double y) {
  double2 r;
...
static inline double2 add_ds(double2 x, double y) {
  // |x| >= |y|
...
static inline double2 add2_ds(double2 x, double y) {
  // |x| >= |y|
...
static inline double2 add_sd(double x, double2 y) {
  // |x| >= |y|
...
static inline double2 add_dd(double2 x, double2 y) {
  // |x| >= |y|
...
static inline double2 add2_dd(double2 x, double2 y) {
  double2 r;
...
static inline double2 div_dd(double2 n, double2 d) {
  double t = 1.0 / d.x;
...
static inline double2 mul_ss(double x, double y) {
...
static inline double2 mul_ds(double2 x, double y) {
...
static inline double2 mul_dd(double2 x, double2 y) {
  double xh = upper(x.x), xl = x.x - xh;
...
static inline double2 squ_d(double2 x) {
  double xh = upper(x.x), xl = x.x - xh;
  double2 r;
...
static inline double2 rec_s(double d) {
  double t = 1.0 / d;
...
static inline double2 sqrt_d(double2 d) {
