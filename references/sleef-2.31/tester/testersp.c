...
boolean cmpDenorm(float x, float y) {
  ...
  if (!xisnanf(x) && !xisnanf(y) && !isinff(x) && !isinff(y)) return signf(x) == signf(y);
  return false;
}
...
void do_test() {
  ...
  fprintf(stderr, "Denormal test atan2f(y, x)\n\n");
  ...
  {
    fprintf(stderr, "sinf denormal test ... ");
  ...
  {
    fprintf(stderr, "sin in sincosf denormal test ... ");
  ...
  {
    fprintf(stderr, "cosf denormal test ... ");
  ...
  {
    fprintf(stderr, "cos in sincosf denormal test ... ");
  ...
  {
    fprintf(stderr, "tanf denormal test ... ");
  ...
  {
    fprintf(stderr, "asinf denormal test ... ");

    float xa[] = { NANf, POSITIVE_INFINITYf, NEGATIVE_INFINITYf, 2, -2 };
  ...
  {
    fprintf(stderr, "acosf denormal test ... ");
  ...
  {
    fprintf(stderr, "atanf denormal test ... ");
  ...
  {
    fprintf(stderr, "logf denormal test ... ");
  ...
  {
    fprintf(stderr, "expf denormal test ... ");
...
#if 0
  {
    fprintf(stderr, "sinhf denormal test ... ");
  ...
  {
    fprintf(stderr, "coshf denormal test ... ");
  ...
  {
    fprintf(stderr, "tanhf denormal test ... ");
  ...
  {
    fprintf(stderr, "asinhf denormal test ... ");
  ...
  {
    fprintf(stderr, "acoshf denormal test ... ");
  ...
  {
    fprintf(stderr, "atanhf denormal test ... ");
  ...
  {
    fprintf(stderr, "sqrtf denormal test ... ");
  ...
  {
    fprintf(stderr, "cbrtf denormal test ... ");
...
#if 0
  {
    fprintf(stderr, "exp2f denormal test ... ");
  ...
  {
    fprintf(stderr, "exp10f denormal test ... ");
  ...
  {
    fprintf(stderr, "expm1f denormal test ... ");
  ...
  {
    fprintf(stderr, "log10f denormal test ... ");
  ...
  {
    fprintf(stderr, "log1pf denormal test ... ");
