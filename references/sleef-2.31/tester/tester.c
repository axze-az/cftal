...
void do_test() {
  ...
  fprintf(stderr, "Denormal test atan2(y, x)\n\n");
  ...
  fprintf(stderr, "\nend of atan2 denormal test\n");

  //

  fprintf(stderr, "\nDenormal test pow(x, y)\n\n");
  ...
  fprintf(stderr, "\nEnd of pow denormal test\n\n");
	
  //

  {
    fprintf(stderr, "sin denormal test ... ");
  ...
  {
    fprintf(stderr, "sin in sincos denormal test ... ");
  ...
  {
    fprintf(stderr, "cos denormal test ... ");
  ...
  {
    fprintf(stderr, "cos in sincos denormal test ... ");
  ...
  {
    fprintf(stderr, "tan denormal test ... ");
  ...
  {
    fprintf(stderr, "asin denormal test ... ");

    double xa[] = { NAN, POSITIVE_INFINITY, NEGATIVE_INFINITY, 2, -2 };
  ...
  {
    fprintf(stderr, "acos denormal test ... ");
  ...
  {
    fprintf(stderr, "atan denormal test ... ");
  ...
  {
    fprintf(stderr, "log denormal test ... ");
  ...
  {
    fprintf(stderr, "exp denormal test ... ");
  ...
  {
    fprintf(stderr, "sinh denormal test ... ");
  ...
  {
    fprintf(stderr, "cosh denormal test ... ");
  ...
  {
    fprintf(stderr, "tanh denormal test ... ");
  ...
  {
    fprintf(stderr, "asinh denormal test ... ");
  ...
  {
    fprintf(stderr, "acosh denormal test ... ");
  ...
  {
    fprintf(stderr, "atanh denormal test ... ");
  ...
  {
    fprintf(stderr, "sqrt denormal test ... ");
  ...
  {
    fprintf(stderr, "cbrt denormal test ... ");
  ...
  {
    fprintf(stderr, "exp2 denormal test ... ");
  ...
  {
    fprintf(stderr, "exp10 denormal test ... ");
  ...
  {
    fprintf(stderr, "expm1 denormal test ... ");
  ...
  {
    fprintf(stderr, "log10 denormal test ... ");
  ...
  {
    fprintf(stderr, "log1p denormal test ... ");
