...
public class FastMath {
	...
	m = (((m + q) >> 9) - m) << 7;
	q = q - (m << 2);
	double u = Double.longBitsToDouble(((long)(m + 0x3ff)) << 52);
	x = x * u * u * u * u;
    ...
    */
    ...
    static double2 normalize_d(double2 t) {
    ...
    static double2 scale_d(double2 d, double s) {
    ...
    static double2 add2_ss(double x, double y) {
	double2 r = new double2();
    ...
    static double2 add_ds(double2 x, double y) {
	// |x| >= |y|
    ...
    static double2 add2_ds(double2 x, double y) {
	// |x| >= |y|
    ...
    static double2 add_sd(double x, double2 y) {
	// |x| >= |y|
    ...
    static double2 add_dd(double2 x, double2 y) {
	// |x| >= |y|
    ...
    static double2 add2_dd(double2 x, double2 y) {
	double2 r = new double2();
    ...
    static double2 div_dd(double2 n, double2 d) {
	double t = 1.0 / d.x;
    ...
    static double2 mul_ss(double x, double y) {
    ...
    static double2 mul_ds(double2 x, double y) {
    ...
    static double2 mul_dd(double2 x, double2 y) {
	double xh = upper(x.x), xl = x.x - xh;
    ...
    static double2 squ_d(double2 x) {
	double xh = upper(x.x), xl = x.x - xh;
	double2 r = new double2();
    ...
    static double2 sqrt_d(double2 d) {
    ...
    */
	...
	return add2_dd(mul_ds(new double2(0.693147180559945286226764, 2.319046813846299558417771e-17), e),
	...
	double result = expk(mul_ds(logk(fabs(x)), y));
	...
	t = add_sd(1, t);
	return new double2(ldexp(t.x, q), ldexp(t.y, q));
    }
	...
	d = add2_dd(d, div_dd(new double2(-1, 0), d));
	y = (d.x + d.y) * 0.5;
	...
	double2 d = expk2(new double2(x, 0));
	d = add2_dd(d, div_dd(new double2(1, 0), d));
	...
	double y = fabs(x);
	double2 d = expk2(new double2(y, 0));
	double2 e = div_dd(new double2(1, 0), d);
	d = div_dd(add2_dd(d, scale_d(e, -1)), add2_dd(d, e));
	y = d.x + d.y;

	y = isinf(x) || isnan(y) ? 1.0 : y;
	y = mulsign(y, x);
	y = isnan(x) ? Double.NaN : y;
	...
	double u = expk(mul_ds(new double2(0.69314718055994528623, 2.3190468138462995584e-17), a));
	if (ispinf(a)) u = Double.POSITIVE_INFINITY;
	if (isminf(a)) u = 0;
	return u;
    }
	...
	double u = expk(mul_ds(new double2(2.3025850929940459011, -2.1707562233822493508e-16), a));
	if (ispinf(a)) u = Double.POSITIVE_INFINITY;
	if (isminf(a)) u = 0;
	return u;
    }
	...
	double2 d = add2_ds(expk2(new double2(a, 0)), -1.0);
	double x = d.x + d.y;
	...
	double2 d = mul_dd(logk(a), new double2(0.43429448190325176116, 6.6494347733425473126e-17));
	double x = d.x + d.y;
    ...
    private static final float PI4_Bf = 0.00024127960205078125f;
    private static final float PI4_Cf = 6.3329935073852539062e-07f;
    private static final float PI4_Df = 4.9604681473525147339e-10f;
    ...
    static float ldexpkf(float x, int q) {
	float u;
	int m;
	m = q >> 31;
	m = (((m + q) >> 6) - m) << 4;
