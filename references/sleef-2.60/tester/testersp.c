...
double setDenormSP(double x) {
  float f = x;
  if (isinff(f) && x > 0) x = POSITIVE_INFINITYf;
  if (isinff(f) && x < 0) x = NEGATIVE_INFINITYf;
  return x;
}
...
void do_test() {
...

  {
    ...
    for(d = -1;d < 1;d += 0.00002) {
      ...
      double c = setDenormSP(asinlfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
      if (u > 1000) {
	fprintf(stderr, "q = %.20g\nc = %.20g\nd = %.20g\nulp = %g\n", q, (double)c, d, (double)ulp(c));
...

  {
    ...
    for(d = -1;d < 1;d += 0.00002) {
      ...
      double c = setDenormSP(acoslfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
      if (u > 1000) {
	fprintf(stderr, "q = %.20g\nc = %.20g\nd = %.20g\nulp = %g\n", q, (double)c, d, (double)ulp(c));
...

  {
    ...
    for(d = -10;d < 10;d += 0.0002) {
      ...
      double c = setDenormSP(atanlfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
      if (u > 1000) {
...

  {
	...
	double c = setDenormSP(atan2lfr(y, x));
	double u = fabs((q - c) / ulp(c));
	max = fmax(max, u);
	if (u > 1000) {
...

  {
    ...
    for(d = -10000;d < 10000;d += 0.2) {
      ...
      double c = setDenormSP(cbrtlfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
      if (u > 1000) {
	fprintf(stderr, "q = %.20g\nc = %.20g\nd = %.20g\nulp = %g\n", q, (double)c, d, (double)ulp(c));
...

  {
	...
	double c = setDenormSP(powlfr(x, y));
	double u = fabs((q - c) / ulp(c));
	max = fmax(max, u);
	if (u > 1000) {
...

  {
    ...
    for(d = -10;d < 10;d += 0.0002) {
      ...
      double c = setDenormSP(sinhlfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
      if (u > 1000) {
	fprintf(stderr, "q = %.20g\nc = %.20g\nd = %.20g\nulp = %g\n", q, (double)c, d, (double)ulp(c));
...

  {
    ...
    for(d = -10;d < 10;d += 0.0002) {
      ...
      double c = setDenormSP(coshlfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
      if (u > 1000) {
	fprintf(stderr, "q = %.20g\nc = %.20g\nd = %.20g\nulp = %g\n", q, (double)c, d, (double)ulp(c));
...

  {
    ...
    for(d = -10;d < 10;d += 0.0002) {
      ...
      double c = setDenormSP(tanhlfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
      if (u > 1000) {
	fprintf(stderr, "q = %.20g\nc = %.20g\nd = %.20g\nulp = %g\n", q, (double)c, d, (double)ulp(c));
...

  {
    ...
    for(d = -10;d < 10;d += 0.0002) {
      ...
      double c = setDenormSP(asinhlfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
      if (u > 1000) {
	fprintf(stderr, "q = %.20g\nc = %.20g\nd = %.20g\nulp = %g\n", q, (double)c, d, (double)ulp(c));
...

  {
    ...
    for(d = 1;d < 10;d += 0.0002) {
      ...
      double c = setDenormSP(acoshlfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
      if (u > 1000) {
	fprintf(stderr, "q = %.20g\nc = %.20g\nd = %.20g\nulp = %g\n", q, (double)c, d, (double)ulp(c));
...

  {
    ...
    for(d = -10;d < 10;d += 0.0002) {
      ...
      double c = setDenormSP(atanhlfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
      if (u > 1000) {
	fprintf(stderr, "q = %.20g\nc = %.20g\nd = %.20g\nulp = %g\n", q, (double)c, d, (double)ulp(c));
...

  {
    ...
    for(d = 0;d < 20000;d += 0.2) {
      ...
      double c = setDenormSP(sqrtlfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
      if (u > 1000) {
	fprintf(stderr, "q = %.20g\nc = %.20g\nd = %.20g\nulp = %g\n", q, (double)c, d, (double)ulp(c));
...

  {
    ...
    for(d = -10;d < 10;d += 0.0002) {
      ...
      double c = setDenormSP(exp2lfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
    }
...

  {
    ...
    for(d = -10;d < 10;d += 0.0002) {
      ...
      double c = setDenormSP(exp10lfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
    }
...

  {
    ...
    for(d = -10;d < 10;d += 0.0002) {
      ...
      double c = setDenormSP(expm1lfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
    }
    ...
    for(d = 0;d < 300;d += 0.02) {
      ...
      double c = setDenormSP(expm1lfr(d2));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
    }
...

  {
    ...
    for(d = 0.0001;d < 10;d += 0.0001) {
      ...
      double c = setDenormSP(log10lfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
    }
...

  {
    ...
    for(d = 0.0001;d < 10;d += 0.0001) {
      ...
      double c = setDenormSP(log1plfr(d));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
    }
    ...
    for(d = 0;d < 300;d += 0.02) {
      ...
      double c = setDenormSP(log1plfr(d2));
      double u = fabs((q - c) / ulp(c));
      max = fmax(max, u);
    }
